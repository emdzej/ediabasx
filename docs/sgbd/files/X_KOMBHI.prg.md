...
| --- | --- | --- | --- | --- |
| ECU | string | Motorrad Instrumentenkombi Baukasten High |  |  |
| ORIGIN | string | BMW UX-EE-2 Hupens |  |  |
| REVISION | string | 0.014 |  |  |
| AUTHOR | string | Dräxlmaier UX-EE-1 Rätscher, In-Tech UX-EE-1 Tiefholz |  |  |
| COMMENT | string | - |  |  |
| PACKAGE | string | 1.70 |  |  |
