...
| ECU Comment | fuer Bosch-ABS 8M in K15 und R13, aus MRABS erstellt |
...
| --- | --- | --- | --- | --- |
| ECU | string | MRABS2 |  |  |
| ORIGIN | string | BMW UX-ER-4 Anton Mayer |  |  |
| REVISION | string | 1.002 |  |  |
| AUTHOR | string | BMW_AG UX-EE-1 Krimmer |  |  |
| COMMENT | string | fuer Bosch-ABS 8M in K15 und R13, aus MRABS erstellt |  |  |
| PACKAGE | string | 1.50 |  |  |
