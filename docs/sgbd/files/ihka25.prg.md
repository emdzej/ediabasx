...
| ECU Comment | IHKA [137] |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Integrierte Heiz-/Klimaautomatik |  |  |
| ORIGIN | string | BMW EI-511 Schmidt |  |  |
| REVISION | string | 2.006 |  |  |
| AUTHOR | string | BMW EI-511 Schmidt, ContinentalAutomotiveGmbH IIDS5 John, Conti |  |  |
| COMMENT | string | IHKA [137] |  |  |
| PACKAGE | string | 1.25 |  |  |
