...
| ECU Comment | HW*-Nr aus AIF lesen, wenn ZIF-BACKUP ungültig |
...
| REVISION | string | 2.58 |  |  |
| AUTHOR | string | QE Michael Knöbl, BMW EE-21 |  |  |
| COMMENT | string | HW*-Nr aus AIF lesen, wenn ZIF-BACKUP ungültig |  |  |
| PACKAGE | string | 1.15 |  |  |
