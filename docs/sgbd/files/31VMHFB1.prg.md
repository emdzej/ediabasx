...
| ECU Comment | Anpassungen von Hirschmann HCC für Sonderablauf COFDM-Update |
...
| REVISION | string | 2.11 |  |  |
| AUTHOR | string | BMW TI-430 Drexel |  |  |
| COMMENT | string | Anpassungen von Hirschmann HCC für Sonderablauf COFDM-Update |  |  |
| PACKAGE | string | 1.29 |  |  |
