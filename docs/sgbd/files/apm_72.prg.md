...
| ECU Comment | SGBD für APM (Serienstand) |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | APM (Auxiliary Power Module) E72 |  |  |
| ORIGIN | string | BMW EA-423 Lorscheid |  |  |
| REVISION | string | 1.050 |  |  |
| AUTHOR | string | BMW EA-423 Lorscheid |  |  |
| COMMENT | string | SGBD für APM (Serienstand) |  |  |
| PACKAGE | string | 1.12 |  |  |
