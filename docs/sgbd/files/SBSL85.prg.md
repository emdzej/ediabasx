...
| ECU Comment | 5. gemeinsame Version E85/E6x |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Satellit B-Saeule links |  |  |
| ORIGIN | string | BMW EE-53 Christian Marschner |  |  |
| REVISION | string | 4.10 |  |  |
| AUTHOR | string | BMW EE-53 Robert Schmidt, BMW TI-430 Ruediger Gall, BMW EE-53 Thomas Theenhaus, ESG Hans-Ulrich Meyer |  |  |
| COMMENT | string | 5. gemeinsame Version E85/E6x |  |  |
| PACKAGE | string | 1.29 |  |  |
