...
| --- | --- | --- | --- | --- |
| ECU | string | Motorrad Schlüsselloses Zugangssystem |  |  |
| ORIGIN | string | BMW UX-EE-2 Dominik_Hecker |  |  |
| REVISION | string | 2.003 |  |  |
| AUTHOR | string | BMW UX-EE-2 Wolfgang_Rigl, Dräxlmaier UX-EE-1 Werner_Rätscher,  |  |  |
| COMMENT | string | - |  |  |
| PACKAGE | string | 1.70 |  |  |
