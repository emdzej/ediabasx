...
| ECU Comment | Entwicklerversion - Stand I350 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Long Range Radar Sensor  |  |  |
| ORIGIN | string | BMW EF-62 Maier |  |  |
| REVISION | string | 0.352 |  |  |
| AUTHOR | string | BERTRANDT EE Postl |  |  |
| COMMENT | string | Entwicklerversion - Stand I350 |  |  |
| PACKAGE | string | 1.31 |  |  |
