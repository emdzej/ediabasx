...
| ECU Comment | SGBD für N47TÜ (DDE7.21) verwendet in F10 (UDS, MV, FlexRay) |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | SGBD für N47TÜ (DDE7.21) verwendet in F10 (UDS, MV, FlexRay) |  |  |
| ORIGIN | string | BMW ZM-E-34 Fuchs |  |  |
| REVISION | string | 0.421 |  |  |
| AUTHOR | string | BMW ZM-E-34 Fuchs |  |  |
| COMMENT | string | SGBD für N47TÜ (DDE7.21) verwendet in F10 (UDS, MV, FlexRay) |  |  |
| PACKAGE | string | 1.05 |  |  |
