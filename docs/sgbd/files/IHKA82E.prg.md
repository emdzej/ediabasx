...
| ECU Comment | SGBD fuer E82e |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Klimaautomatik |  |  |
| ORIGIN | string | BMW EI-523 Georg Gerstenbrandt |  |  |
| REVISION | string | 1.000 |  |  |
| AUTHOR | string | ContinentalAutomotive IIDCOCCC UDS, ContinentalAutomotive IIDS2 |  |  |
| COMMENT | string | SGBD fuer E82e |  |  |
| PACKAGE | string | 1.52 |  |  |
