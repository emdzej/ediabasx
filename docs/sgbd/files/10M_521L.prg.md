...
| ECU Comment | Datei fuer Kennfeldprogrammierung DME Flash 2. Zylinderbank |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MD521L 2. Zyl. |  |  |
| ORIGIN | string | BMW TP-421 Weber/Mellersh; Softing GmbH |  |  |
| REVISION | string | 1.0 |  |  |
| AUTHOR | string | BMW TP-421 Hirsch; Softing GmbH |  |  |
| COMMENT | string | Kennfeldprogrammierung DME DS2/Flash MD5.2.1 M73 LEV, 2. Zylinderbank |  |  |
