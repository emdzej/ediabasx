...
| ECU Comment | SGBD fuer DDE609 / R56-PSA - Mini |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | DDE 609 fuer R56 / PSA (Mini) EU4  |  |  |
| ORIGIN | string | BMW ZM-E-34 Langeder Erwin |  |  |
| REVISION | string | 1.000 |  |  |
| AUTHOR | string | BMW ZM-E-34 Langeder Erwin |  |  |
| COMMENT | string | SGBD fuer DDE609 / R56-PSA - Mini  |  |  |
| PACKAGE | string | 1.29 |  |  |
