...
| ECU Comment | Dummy SGBD fuer Beifahrerairbag-Ausloseeinheiten |
...
| --- | --- | --- | --- | --- |
| ECU | string | DUMMY |  |  |
| ORIGIN | string | BMW TD-462 Forster |  |  |
| REVISION | string | 1.00 |  |  |
| AUTHOR | string | BMW TD-462 Forster |  |  |
| COMMENT | string | Dummy SGBD fuer Beifahrerairbag-Ausloseeinheiten |  |  |
