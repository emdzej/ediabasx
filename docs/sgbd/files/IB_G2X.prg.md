...
| ECU Comment | Version 1 21-11-205 [1] |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Integriertes Bremssystem (Bremsregelsystem) |  |  |
| ORIGIN | string | BMW EF-510 Matthias_Amberger |  |  |
| REVISION | string | 0.004 |  |  |
| AUTHOR | string | BMW EF-510 Terhorst |  |  |
| COMMENT | string | Version 1 21-11-205 [1] |  |  |
