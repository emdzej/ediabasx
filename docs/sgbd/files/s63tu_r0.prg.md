...
| --- | --- | --- | --- | --- |
| ECU | string | MEVD1728 für S63TÜ Master-Steuergerät |  |  |
...
Statistik-Cluster 2 für MDrive. STATUS_MDRIVE2 (0x22 4152)
...
Ansteuern Diagnosefunktion vertauschte Lambdasonden Achtung: vor erneutem ausfuehren muss ein Klemmenwechsel erfolgen SYSTEMCHECK_L_SONDE (0x31 01 F0DF)
...
| 0x58FF | STAT_0X58FF_WERT | - | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| WERT | TEXT |
| --- | --- |
| 0x0001 | Zylinderindividuelle Lambda-Fehler Raw Bank 1 |
| 0x0002 | Gemischadaption Diagnose Bank 1 |
| 0x0003 | Diagnose Kraftstoffversorgungssystem HDR Bank 1 |
| 0x0005 | Diagnose der Wirkungsgradverschlechterung während der Katheizphase (CSERS) Bank 1 |
| 0x0006 | Katalysatordiagnose Bank 1 |
| 0x0007 | UEGO LSU-Plausibilitätsdiagnose Bank 1 |
| 0x0008 | Motortemperatur-Plausibilitätsdiagnose |
| 0x0009 | Diagnose der Wirkungsgradverschlechterung während der Katheizphase (CSERS) Bank 1 |
