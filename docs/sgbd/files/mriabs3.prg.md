...
| ECU Comment | Nur fuer Bosch 9ME (K46) |
...
| --- | --- | --- | --- | --- |
| ECU | string | MRIABS3 |  |  |
| ORIGIN | string | BMW UX-EF-4 Mayer_Anton |  |  |
| REVISION | string | 1.008 |  |  |
| AUTHOR | string | BMW_AG UX-EE-1 Stefan_Krimmer_UX-EE-1 |  |  |
| COMMENT | string | Nur fuer Bosch 9ME (K46) |  |  |
| PACKAGE | string | 1.66 |  |  |
