...
| ECU Comment | DSC-EBC_SP18-BRS für die S15A-20-07-310 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Dynamische Stabilitätskontrolle EBC460 SP2018 |  |  |
| ORIGIN | string | BMW EF-511 Peter_Wanner |  |  |
| REVISION | string | 0.401 |  |  |
| AUTHOR | string | SOKRATEL-KOMMUNIKATIONS EF-512 Stuerzer |  |  |
| COMMENT | string | DSC-EBC_SP18-BRS für die S15A-20-07-310 |  |  |
| PACKAGE | string | 1.991 |  |  |
