...
| ECU Comment | MOST Universale Lade- und Freisprecheinrichtung |
...
| --- | --- | --- | --- | --- |
| ECU | string | ULF_60 |  |  |
| ORIGIN | string | BMW, EE 49336 |  |  |
| REVISION | string | 4.000 |  |  |
| AUTHOR | string | Visteon, Multimedia, M.Hammersen, Visteon, Multimedia Chandrika Shetty |  |  |
| COMMENT | string | MOST Universale Lade- und Freisprecheinrichtung |  |  |
| PACKAGE | string | 1.34 |  |  |
