...
| ECU Comment | SGBD nur für Programmierung Instrumentenkombi K46 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | 10KOMB46FLASH |  |  |
| ORIGIN | string | BMW_AG UX-EE-2 Max_Doll |  |  |
| REVISION | string | 1.000 |  |  |
| AUTHOR | string | Dräxlmaier UX-EE-1 Rätscher |  |  |
| COMMENT | string | SGBD nur für Programmierung Instrumentenkombi K46 |  |  |
| PACKAGE | string | 1.50 |  |  |
