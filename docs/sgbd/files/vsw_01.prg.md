...
| --- | --- | --- | --- | --- |
| ECU | string | Video Switch |  |  |
| ORIGIN | string | BMW EI-41 Pierre_Jacques_Berthele |  |  |
| REVISION | string | 9.004 |  |  |
| AUTHOR | string | DELPHI-FUBA EI-41 StefanLeimbach, Delphi EI-41 ThomasEckerlein |  |  |
| COMMENT | string | VSW [28] |  |  |
| PACKAGE | string | 1.20 |  |  |
