...
| ECU Comment | SGBD nur zum Programmieren der ZFEB und ZFEH |
...
| --- | --- | --- | --- | --- |
| ECU | string | MRZFEH |  |  |
| ORIGIN | string | Bertrandt UX-EE-2 Goetz |  |  |
| REVISION | string | 1.000 |  |  |
| AUTHOR | string | BMW_AG UX-EE-1 Stoffregen, ESG UX-EE-1 Sergl, BMW_AG UX-EE-1 Kr |  |  |
| COMMENT | string | SGBD nur zum Programmieren der ZFEB und ZFEH |  |  |
| PACKAGE | string | 1.71 |  |  |
