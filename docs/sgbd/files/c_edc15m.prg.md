...
| ECU Comment | Tested on ECU |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | C_SGBD Jewel / Oyster EDC 15M |  |  |
| ORIGIN | string | EE-62 D.Gamble |  |  |
| REVISION | string | 1.00 |  |  |
| AUTHOR | string | Rover SSL A.Hoddinott, Rover SSL P.Allnutt, d.gamble EE-62 |  |  |
| COMMENT | string | Tested on ECU |  |  |
