...
| ECU Comment | Steuergeraet Elektronische-Kraftstoff-Pumpe |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | EKPM2-Modul (E60/PL2) |  |  |
| ORIGIN | string | BMW EK-51 Klose, Guido |  |  |
| REVISION | string | 1.001 |  |  |
| AUTHOR | string | HELBAKO ES Gerd Meyering, HELBAKO ES Arnd Langenstein, HELBAKO ES Michael Krause, BMW AG TI-431 Jeannot Majerus |  |  |
| COMMENT | string | Steuergeraet Elektronische-Kraftstoff-Pumpe |  |  |
| PACKAGE | string | 1.31 |  |  |
