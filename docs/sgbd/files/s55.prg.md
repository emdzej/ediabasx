...
| ECU Comment | SGBD für MEVD172G C-Muster zur SW 6MC2EB2B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Motorelektronik ME VD172.6 für 6 Zylinder M-GmbH |  |  |
| ORIGIN | string | BMW EA-360 Markus_Lorch |  |  |
| REVISION | string | 10.000 |  |  |
| AUTHOR | string | P-+-Z-ENGINEERING-GMBH EA-362 Berger |  |  |
| COMMENT | string | SGBD für MEVD172G C-Muster zur SW 6MC2EB2B |  |  |
...
0x224021 STATUS_IDENT_BUE Identifikationsdaten fuer BUE auslesen Aktivierung: Klemme 15 = EIN Activation: LV_IGK = 1
...
### STATUS_BATT_TYP_LESEN

0x224021 STATUS_BATT_TYP_LESEN Identifikationsdaten fuer Lithium Ionen Batterie auslesen Aktivierung: Klemme 15 = EIN Activation: LV_IGK = 1
...
### STATUS_LISB_GES_LADUNG_LESEN

Auslesen der BZE-Diagnoseinformationen fuer die Lithium Ionen Batterie BZE_LISB (0x22 409F)
...
### STATUS_MESSWERTE_BUE

Zustandsgroessen fuer LISB lesen MESSWERTE_BUE (0x22 40A7)

_No arguments._

### STATUS_BZELISB_RESETGRUND

Resetgruende von BZE LISB BZELISB_RESETGRUND (0x22 40B9)

_No arguments._

### STATUS_OPF_DIAG

Otto Partikelfilter Verbaudiagnosestatus auslesen Klammerung: BMW_GAPAFI_SC == 1 OPF_DIAG (0x22 40EF)
...
Identifikation OPF lesen Klammerung mit: BMW_GAPAFI_SC == 1 IDENT_OPF (0x22 4117)

_No arguments._

### STATUS_LADUNGSBILANZ_OPF

Beladungswerte OPF lesen Klammerung mit: BMW_GAPAFI_SC == 1 LADUNGSBILANZ_OPF (0x22 4118)

_No arguments._

### STATUS_NUTZUNG_OPF

Nutzungsverhalten OPF lesen Klammerung mit: BMW_GAPAFI_SC == 1 NUTZUNG_OPF (0x22 4119)

_No arguments._

### STATUS_HIST_REGENERATIONSGRUND_OPF

Regenerationsgruende OPF lesen Klammerung mit: BMW_GAPAFI_SC == 1 HIST_REGENERATIONSGRUND_OPF (0x22 411D)

_No arguments._

### STATUS_HIST_TEMPERATUR_OPF

TemperaturKlassenkennfeld OPF lesen Klammerung mit: BMW_GAPAFI_SC == 1 HIST_TEMPERATUR_OPF (0x22 411E)

_No arguments._

### STATUS_ERWEITERT_GANGSENSOR_ERKENNUNG_SENT

Erweiterte Gangsensorwerte Abfrage. ERWEITERT_GANGSENSOR_ERKENNUNG_SENT (0x22 4150)

_No arguments._

### STATUS_MDRIVE2

Statistik-Cluster 2 fuer MDrive. STATUS_MDRIVE2 (0x22 4152)
...
OPF Tauschereignisse lesen Klammerung mit: BMW_GAPAFI_SC == 1 OPF_TAUSCH_BANK1 (0x22 4195)

_No arguments._

### STATUS_OPF_TAUSCH_BANK2

OPF Tauschereignisse Bank 2 lesen Klammerung mit: BMW_GAPAFI_SC == 1 OPF_TAUSCH_BANK2 (0x22 4196)

_No arguments._

### STATUS_HIST_TEMPERATUR_BANK2_OPF

Temperatur Klassenkennfeld OPF Bank 2 lesen Klammerung mit: BMW_GAPAFI_SC == 1 HIST_TEMPERATUR_BANK2_OPF (0x22 4197)
...
| Name | Type | Description |
| --- | --- | --- |
| SW_TV_LSH3 | real | Tastverhaeltniss Lambdasondenheizung vor Kat 2 Einheit: % Min: 0.0 Max: 99.609375 a2l-Name: resdhlsu2 |
...
| Name | Type | Description |
| --- | --- | --- |
| SW_TV_LSH4 | real | Tastverhaeltniss Lambdasondenheizung hinter Kat 2 Einheit: % Min: 0.0 Max: 99.609375 a2l-Name: resdhshe2 |
...
Ansteuerung elektrische Abgasklappe EL_AGK (0x2F 03 60FD)
...
Ansteuerung eWG2 (zweites elektrisches Wastegate) beenden. EWG2 (0x2F 00 60FE)

_No arguments._

### STEUERN_EWG2

Bauteilansteuerung fuer zweites elektr. Wastegate (eWG2) (Sollwertvorgabe der Position des eWG2). Beim Ausfuehren dieses Testerjobs muss das Bit B_ewg_tester_2 gesetzt werden / (Sollpositionsvorgabe fuer das zweite elektrische Wastegate ueber Tester aktiv). Ansteuerbedingungen: B_kl15 == True und nmot_w == 0 und B_ewg==TRUE und (SY_WGPS>0) und (LAYER_ANZ_WG_SY==2) EWG2 (0x2F 03 60FE)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_EWG2 | real | Normierte Sollpositionsvorgabe des zweiten elektrischen Wastegates vom Tester vorgeben (0%: eWG2 geschlossen, 100% eWG2 offen). (A2L-Name: Ewgposs_norm_tester_2) Einheit: % Min: 0.0 Max: 99.609375 a2l-Name: BasSvrAppl_nrmDesPosEwg2Tstr |
| SW_TO_EWG2 | unsigned long | Timeout fuer die Ansteuerung des EWG2 Einheit: s Min: 0.0 Max: 510.0 |

### STEUERN_ENDE_EWP_ATL

Elektrische Wasserpumpe fuer Abgasturbolader steuern beenden. EWP_ATL (0x2F 00 6104)

_No arguments._

### STEUERN_EWP_ATL

Elektrische Wasserpumpe fuer Abgasturbolader steuern. Pumpennomenklatur: 20 EWP_ATL (0x2F 03 6104)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_EWP_ATL | real | Tastverhaeltnis elektrische Wasserpumpe Abgasturbolader Einheit: % Min: 0.0 Max: 95.00732421875 |

### STEUERN_ENDE_EWP_LLK

Elektrische Wasserpumpe fuer Ladeluftkuehler steuern beenden. EWP_LLK (0x2F 00 6106)

_No arguments._

### STEUERN_EWP_LLK

Elektrische Wasserpumpe fuer Ladeluftkuehler steuern. Pumpennomenklatur: 22 EWP_LLK (0x2F 03 6106)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_EWP_LLK | real | Tastverhaeltniss Wasserpumpe Ladeluftkuehler. Einheit: % Min: 0.0 Max: 95.00732421875 |
...
| Name | Type | Description |
| --- | --- | --- |
| LL | int | Drehzahlerhoeung Bereich 0 bis 4000 1/min Einheit: 1/min Min: -32768.0 Max: 32767.0 a2l-Name: nsolfa_w |
...
Ansteuern Diagnosefunktion VVT-Anschlag lernen Nur bei Nmot = 0! SYSTEMCHECK_VVT_ANSCHLAG (0x31 01 F027)
...
Ansteuern Nullgang lernen Nur bei laufenden Motor aufuehren. NULLGANG_LERNEN (0x31 01 F02E)
...
| Name | Type | Description |
| --- | --- | --- |
| ADAV2_AUSWAHLBYTE_1 | unsigned char | ADAV2_AUSWAHLBYTE_1_BIT_7 -- > Kleinstmengenadaption ADAV2_AUSWAHLBYTE_1_BIT_6 --> Variante Abgasklappe loeschen (DAKRE_StRstFlpTyp), BasSvrAppl_stVarEgFlapClr ADAV2_AUSWAHLBYTE_1_BIT_5 --> Zaehler VVT Notlauf loeschen (anznlvvtaust) ADAV2_AUSWAHLBYTE_1_BIT_4 --> Neustart der Hinterachslernfunktion (B_hal_reset_adaptionen (Bit 0 von St_hal_diag_adaptionen)). ADAV2_AUSWAHLBYTE_1_BIT_3 --> Adaption elektrische Kraftstoffpumpe ADAV2_AUSWAHLBYTE_1_BIT_2 --> Adaption Langzeit fuer Injektoralterung Bank 2(NOT USED) ADAV2_AUSWAHLBYTE_1_BIT_1 --> Adaption Langzeit fuer Injektoralterung Bank 1(NOT USED) ADAV2_AUSWAHLBYTE_1_BIT_0 --> Adaption Nullgangsensor(NOT USED) Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: - Bit 0x02: - Bit 0x04: - Bit 0x08: - Bit 0x10: BasSvrAppl_flgRstRrAxlAdpn Bit 0x20: - Bit 0x40: BasSvrAppl_stVarEgFlapClr Bit 0x80: bedinjadclr |
| ADAV2_AUSWAHLBYTE_2 | unsigned char | ADAV2_AUSWAHLBYTE_2_BIT_7 --> NOT USED ADAV2_AUSWAHLBYTE_2_BIT_6 --> Verlustmomentadaption Reset ADAV2_AUSWAHLBYTE_2_BIT_5 --> Adaption NOx-Katalysator (NOT USED) ADAV2_AUSWAHLBYTE_2_BIT_4 --> Bereichserkennung Benzin im Oel (B_clradbo) ADAV2_AUSWAHLBYTE_2_BIT_3 --> Reset Startabbrueche (B_stabbr_zrreset) ADAV2_AUSWAHLBYTE_2_BIT_2 --> Reset WMM Sollwertzaehler ADAV2_AUSWAHLBYTE_2_BIT_1 --> Kraftstoffqualitaetserfassung Reset (B_clradfuel) ADAV2_AUSWAHLBYTE_2_BIT_0 --> Infospeicher Superklopffunktion loeschen (BasSvrAppl_stTstrTrg1_RC_B_SKRKO) Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: BasSvrAppl_stTstrTrg1_RC_B_SKRKO Bit 0x02: B_clradfuel Bit 0x04: - Bit 0x08: - Bit 0x10: B_clradbbo Bit 0x20: - Bit 0x40: - Bit 0x80: - |
| ADAV2_AUSWAHLBYTE_3 | unsigned char | ADAV2_AUSWAHLBYTE_3_BIT_7 --> Zuruecksetzen der Hubkorrekturstatistik per Tester (Bit-Name = B_vbr_stat_reset_ext und Basisvariable = St_vbr_stat) ADAV2_AUSWAHLBYTE_3_BIT_6 --> Anforderung Nockenwellen Referenzadaption durch Tester (Kurbelwelle-Nockenwellenzuordnung). Der Neustart der Adaptation sollte immer nach Arbeit in der Umgebung der Nocken- oder Kurbelwelle ausgefuehrt werden. ADAV2_AUSWAHLBYTE_3_BIT_5 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_4 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_3 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_2 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_1 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_0 --> NOT USED Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: - Bit 0x02: - Bit 0x04: - Bit 0x08: - Bit 0x10: - Bit 0x20: - Bit 0x40: B_fanwrad Bit 0x80: B_vbrstatresetext |
...
### STATUS_SYSTEM_WASSEREINSPRITZUNG

Funktionsgrößen fuer das Wassereinspritzsystem - Starten / Stoppen / Auslesen SYSTEM_WASSEREINSPRITZUNG (0x31 03 F06E)

_No arguments._

### STOP_SYSTEM_WASSEREINSPRITZUNG

Beenden der Vorgabe der Teilfunktion fuer das Wassereinspritzsystem. SYSTEM_WASSEREINSPRITZUNG (0x31 02 F06E)

_No arguments._

### START_SYSTEM_WASSEREINSPRITZUNG

Vorgabe der Teilfunktion fuer das Wassereinspritzsystem. SYSTEM_WASSEREINSPRITZUNG (0x31 01 F06E) Drehzahl > 0

| Name | Type | Description |
| --- | --- | --- |
| SW_SYS_WASSER_FUNKT | string | Vorgabe der Teilfunktion fuer den Systemverbund Wassereinspritzung. 0 == Grundzustand keine Ansteuerung 1 == Pumpenlauf 2 == Umschaltventil 3 == System entleeren 4 == Druckaufbaupruefung 5 == Druckhaltepruefung 6 == Injektortest Zugelassene Werte siehe Tabelle T_2BYTE_WASSER_AKTIV |

### START_SYSTEMCHECK_OPF

OPF Systemtest SYSTEMCHECK_OPF (0x31 01 F07B)

_No arguments._

### STOP_SYSTEMCHECK_OPF

OPF Systemtest SYSTEMCHECK_OPF (0x31 02 F07B)

_No arguments._

### STATUS_SYSTEMCHECK_OPF

OPF Systemtest Der STATUS ist aktuell noch nicht genauer Definiert. Hierzu muss noch eine weitere CP folgen welche die Details anfordert. Abgestimmt mit EA-363. SYSTEMCHECK_OPF (0x31 03 F07B)

_No arguments._

### STATUS_VORKONFIG_OPF

Vorkonditionierung Otto Partikelfilter stopen VORKONFIG_OPF (0x31 03 F082)

_No arguments._

### START_VORKONFIG_OPF

Vorkonditionierung Otto Partikelfilter starten Gültigkeit: bis Klemme15 Wechsel oder Zeitzähler> Schwellwert (in Sekunden 2Byte) bedatbar. Startvorraussetzungen: Freigabe über Applikationsschalter, Geschwindigkeit < Schwellwert bedatbar, GWS N oder P (AT), Neutral (MT), Gaspedal < Schwellwert bedatbar Bei Ausführung wird gesetzt: BMWeng_b_PfTstrSootPcg VORKONFIG_OPF (0x31 01 F082)

_No arguments._

### STOP_VORKONFIG_OPF

Vorkonditionierung Otto Partikelfilter stopen Bei Ausführung wird rueckgesetzt: BMWeng_b_PfTstrSootPcg VORKONFIG_OPF (0x31 02 F082)
...
### STATUS_SYSTEMCHECK_EWG2

Diagnosefunktion des zweiten elektrischen Wastegates (eWG2) Ausgaben lesen. Startbedingungen: B_ewg==TRUE und (SY_WGPS>0) und (LAYER_ANZ_WG_SY==2) SYSTEMCHECK_EWG2 (0x31 03 F0FD)

_No arguments._

### START_SYSTEMCHECK_EWG2

Diagnosefunktion fuer zweites elektrisches Wastegate starten. Beim Ausfuehren des Jobs wird B_ewgsvc_if_2 = TRUE gesetzt. Ansteuerbedingungen: B_kl15 == True und nmot_w == 0 und B_ewg==TRUE und (SY_WGPS>0) und (LAYER_ANZ_WG_SY==2) SYSTEMCHECK_EWG2 (0x31 01 F0FD)

_No arguments._

### STOP_SYSTEMCHECK_EWG2

Diagnosefunktion fuer zweites elektrisches Wastegate beenden. Beim Ausfuehren des Jobs wird B_ewgsvc_if_2 = FALSE gesetzt. Startbedingungen: B_ewg==TRUE und (SY_WGPS>0) und (LAYER_ANZ_WG_SY==2) SYSTEMCHECK_EWG2 (0x31 02 F0FD)

_No arguments._

### START_RESET_ADAPTION_OPF

Adaptionswerte des Otto Partikel Filter ruecksetzen. Bei Ausfuehrung des Jobs wird BMWeng_b_PclFilExch_bo für 5 Sekunden gesetzt. Klammerung mit: BMW_GAPAFI_SC == 1 RESET_ADAPTION_OPF (0x31 01 F32A)

| Name | Type | Description |
| --- | --- | --- |
| SW_FUNKT_SICH | string | Wert fuer das gewollte Loeschen dieser Adaption Werttabelle 165 = 165 |

### START_RESET_ADAPTION_DRUCKSENSOR_OPF

Adaptionswerte des OPF Drucksensors ruecksetzen. Bei Ausfuehrung des Jobs wird BMWeng_b_PclFilExchSnsr_bo für 5 Sekunden gesetzt. Klammerung mit: BMW_GAPAFI_SC == 1 RESET_ADAPTION_DRUCKSENSOR_OPF (0x31 01 F32B)

| Name | Type | Description |
| --- | --- | --- |
| SW_FUNKT_SICH | string | Wert fuer das gewollte Loeschen dieser Adaption Werttabelle 165 = 165 |

### START_RESET_ADAPTION_OPF_BANK2

Adaptionswerte des Otto Partikel Filter Bank 2 ruecksetzen. Bei Ausfuehrung des Jobs wird BMWeng_b_PclFilExch_bo für 5 Sekunden gesetzt. Klammerung mit: BMW_GAPAFI_SC == 1 RESET_ADAPTION_OPF_BANK2 (0x31 01 F33A)

| Name | Type | Description |
| --- | --- | --- |
| SW_FUNKT_SICH | string | Wert fuer das gewollte Loeschen dieser Adaption Werttabelle 165 = 165 |

### START_RESET_ADAPTION_DRUCKSENSOR_OPF_BANK2

Adaptionswerte des OPF Drucksensors Bank 2 ruecksetzen. Bei Ausfuehrung des Jobs wird BMWeng_b_PclFilExchSnsr_bo für 5 Sekunden gesetzt. Klammerung mit: BMW_GAPAFI_SC == 1 RESET_ADAPTION_DRUCKSENSOR_OPF_BANK2 (0x31 01 F33B)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_MIL | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | MIL |
| STAT_UNUSED_1 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3300_BYTE_11

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HFM_KENNLINIE | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | HFM-Kennlinie |
| STAT_UNUSED_11 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3300_BYTE_2

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_KAT | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | KAT |
| STAT_UNUSED_2 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3300_BYTE_4

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_VARIANTEN_CONFIG | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | Varianten-Config |
| STAT_UNUSED_4 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3300_BYTE_8

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ANTRIEBSVARIANTE | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | Antriebsvariante |
| STAT_UNUSED_8 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3320_BYTE_13

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_AGK_CONFIG | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | AGK-Config |
| STAT_UNUSED_13 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |

### BF_3320_BYTE_28

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_UNUSED_28 | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | Unused |
| STAT_BCU150 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | BCU150 |

### BF_3320_BYTE_29

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_DMDZMS | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | DMDZMS |
| STAT_APHF | 0/1 | high | unsigned char | 0x10 | - | - | - | - | APHF |
| STAT_UNUSED_29 | 0-n | high | unsigned char | 0xe0 | BF_DISC_3BIT | - | - | - | Unused |

### BF_3320_BYTE_3

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_IGR | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | IGR |
| STAT_BUDS | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | BUDS |

### BF_3320_BYTE_4

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_SPA | 0-n | high | unsigned char | 0x0f | BF_DISC_NIBBLE | - | - | - | SPA |
| STAT_UNUSED_4 | 0-n | high | unsigned char | 0xf0 | BF_DISC_NIBBLE | - | - | - | Unused |
...
| 0x102E11 | Luftmassenmesser: elektrischer Fehler oder Luftmasse unplausibel | 0 | - |
...
| 0x119201 | Kraftstoffniederdrucksensor: Kurzschluss nach Plus | 0 | - |
| 0x119202 | Kraftstoffniederdrucksensor: Kurzschluss nach Masse | 0 | - |
...
| 0x123402 | Elektrisches Wastegate 2, Anschlag-Lernen, Kaltstart: Fehlfunktion | 0 | - |
...
| 0x123413 | Elektrisches Wastegate 2, Anschlag-Lernen: Anschlagposition (Wastegate offen) nicht gefunden | 0 | - |
| 0x123414 | Elektrisches Wastegate 2, Anschlag-Lernen: Anschlagposition (Wastegate geschlossen) nicht gefunden | 0 | - |
...
| 0x123423 | Elektrisches Wastegate 2, Anschlag-Lernen: Startposition (Wastegate offen) nicht gefunden | 0 | - |
| 0x123424 | Elektrisches Wastegate 2, Anschlag-Lernen: Startposition (Wastegate geschlossen) nicht gefunden | 0 | - |
| 0x123425 | Elektrisches Wastegate 2, Positionssensor, Versorgungsspannung, Plausibilität: Spannung zu niedrig | 0 | - |
| 0x123426 | Elektrisches Wastegate 2, Ansteuerung: Leitungsunterbrechung | 0 | - |
| 0x123427 | Elektrisches Wastegate 2, Wastegate-Klappe, Kaltstart: schwergängig | 0 | - |
...
| 0x123434 | Elektrisches Wastegate 2, Anschlag-Lernen: Anschlagposition (Wastegate offen) außerhalb Toleranz | 0 | - |
| 0x123435 | Elektrisches Wastegate 2, Anschlag-Lernen: Verstellbereich außerhalb Toleranz | 0 | - |
| 0x123436 | Elektrisches Wastegate 2, Anschlag-Lernen: Anschlagposition (Wastegate geschlossen) außerhalb Toleranz | 0 | - |
...
| 0x123518 | Elektrisches Wastegate 2, Wastegate-Klappe: schwergängig | 0 | - |
| 0x123601 | Elektrisches Wastegate, Ansteuerung: Kurzschluss | 0 | - |
| 0x123602 | Elektrisches Wastegate, Endstufe: Temperatur zu hoch | 0 | - |
| 0x123603 | Elektrisches Wastegate 2, Ansteuerung: Kurzschluss | 0 | - |
| 0x123605 | Elektrisches Wastegate 2, Endstufe: Temperatur zu hoch | 0 | - |
| 0x123606 | DME, interner Fehler, Elektrisches Wastegate 2: SPI-Kommunikation fehlerhaft | 0 | - |
...
| 0x123703 | Elektrisches Wastegate 2, Positionssensor, elektrisch: Kurzschluss nach Plus | 0 | - |
| 0x123704 | Elektrisches Wastegate 2, Positionssensor, elektrisch: Kurzschluss nach Masse | 0 | - |
| 0x124004 | Wassereinspritzsystem, Wasserpumpe, Relais, Ansteuerleitung: Leitungsunterbrechung | 0 | - |
| 0x124005 | Wassereinspritzsystem, Wasserpumpe, Relais, Ansteuerleitung: Kurzschluss nach Plus | 0 | - |
| 0x124006 | Wassereinspritzsystem, Wasserpumpe, Relais, Ansteuerleitung: Kurzschluss nach Masse | 0 | - |
| 0x124007 | Wassereinspritzsystem, Rückspülventil, Relais, Ansteuerleitung: Leitungsunterbrechung | 0 | - |
| 0x124008 | Wassereinspritzsystem, Rückspülventil, Relais, Ansteuerleitung: Kurzschluss nach Plus | 0 | - |
| 0x124009 | Wassereinspritzsystem, Rückspülventil, Relais, Ansteuerleitung: Kurzschluss nach Masse | 0 | - |
| 0x12400A | Wassereinspritzsystem, Wassereinspritzventil 1, Ansteuerleitung: Leitungsunterbrechung | 0 | - |
| 0x12400B | Wassereinspritzsystem, Wassereinspritzventil 1, Ansteuerleitung: Kurzschluss nach Plus | 0 | - |
| 0x12400C | Wassereinspritzsystem, Wassereinspritzventil 1, Ansteuerleitung: Kurzschluss nach Masse | 0 | - |
| 0x12400D | Wassereinspritzsystem, Wassereinspritzventil 2, Ansteuerleitung: Leitungsunterbrechung | 0 | - |
| 0x12400E | Wassereinspritzsystem, Wassereinspritzventil 2 Ansteuerleitung: Kurzschluss nach Plus | 0 | - |
| 0x12400F | Wassereinspritzsystem, Wassereinspritzventil 2, Ansteuerleitung: Kurzschluss nach Masse | 0 | - |
| 0x124010 | Wassereinspritzsystem, Wassereinspritzventil 3, Ansteuerleitung: Leitungsunterbrechung | 0 | - |
| 0x124011 | Wassereinspritzsystem, Wassereinspritzventil 3, Ansteuerleitung: Kurzschluss nach Plus | 0 | - |
| 0x124012 | Wassereinspritzsystem, Wassereinspritzventil 3, Ansteuerleitung: Kurzschluss nach Masse | 0 | - |
| 0x124013 | Wassereinspritzsystem, Rückspülventil, Plausibilität: kein Druckabbau | 0 | - |
| 0x124014 | Check-Control-Meldung (ID 969): Wassereinspritzung. Wassertank Reserve | 0 | - |
| 0x124015 | Wassereinspritzsystem, Arbeitsbereich: Druck zu niedrig | 0 | - |
| 0x124016 | Wassereinspritzsystem, Arbeitsbereich: Druck zu hoch | 0 | - |
| 0x124017 | Wassereinspritzsystem, Drucksensor, Plausibilität: Druck unplausibel | 0 | - |
| 0x124018 | Wassereinspritzsystem, Wasserleitung: Durchfluss gestört | 0 | - |
| 0x124019 | Wassereinspritzsystem: falsches Medium erkannt | 0 | - |
| 0x12401A | Wassereinspritzsystem, Druckhalteprüfung: Druckabfall zu hoch | 0 | - |
| 0x12401B | Wassereinspritzsystem, Injektor 1: kein Durchfluss | 0 | - |
| 0x12401C | Wassereinspritzsystem, Injektor 2: kein Durchfluss | 0 | - |
| 0x12401D | Wassereinspritzsystem, Injektor 3: kein Durchfluss | 0 | - |
| 0x12401E | Wassereinspritzsystem: Sammelfehler | 0 | - |
| 0x12401F | Wassereinspritzsystem, Drucksensor: Kurzschluss nach Plus | 0 | - |
| 0x124020 | Wassereinspritzsystem, Drucksensor: Kurzschluss nach Masse | 0 | - |
| 0x124021 | Wassereinspritzsystem, Temperatursensor: Kurzschluss nach Plus | 0 | - |
| 0x124022 | Wassereinspritzsystem, Temperatursensor: Kurzschluss nach Masse | 0 | - |
...
| 0x138A01 | Abgasklappensteller 2, Signalleitung: Kurzschluss nach Plus | 0 | - |
| 0x138A02 | Abgasklappensteller 2, Signalleitung: Kurzschluss nach Masse | 0 | - |
| 0x138A04 | Abgasklappensteller 2, Signalleitung: offen | 0 | - |
| 0x138A11 | Abgasklappe, Plausibilität: Verstellzeit unplausibel | 0 | - |
| 0x138A12 | Abgasklappe: keine Rückmeldung | 0 | - |
| 0x138A13 | Abgasklappe 2, Plausibilität: Verstellzeit unplausibel | 0 | - |
| 0x138A14 | Abgasklappe 2: keine Rückmeldung | 0 | - |
...
| 0x190F03 | Tankentlüftungssystem: gesperrt nach Umprogrammierung | 0 | - |
...
| 0x1A2801 | Otto Partikelfilter Drucksensor, elektrisch: Kurzschluss nach Plus | 0 | - |
| 0x1A2802 | Otto Partikelfilter Drucksensor, elektrisch: Kurzschluss nach Masse | 0 | - |
| 0x1A2803 | Otto Partikelfilter Drucksensor, Plausibilität: Druck unplausibel im Nachlauf | 0 | - |
| 0x1A2804 | Elektrolüfter, Betriebsbereitschaft: eingeschränkt | 0 | - |
| 0x1A2807 | Otto Partikelfilter Drucksensor 2, elektrisch: Kurzschluss nach Plus | 0 | - |
| 0x1A2808 | Otto Partikelfilter Drucksensor 2, elektrisch: Kurzschluss nach Masse | 0 | - |
| 0x1A2809 | Otto Partikelfilter Drucksensor 2, Plausibilität: Druck unplausibel im Nachlauf | 0 | - |
| 0x1A280A | Otto Partikelfilter, Drucksensor, Schlauchleitung: Undicht | 0 | - |
| 0x1A280C | Otto Partikelfilter, Drucksensor, Leistungsbegrenzung: Abgasgegendruck zu hoch | 0 | - |
| 0x1A280E | Otto Partikelfilter, Drucksensor: Abgasgegendruck zu hoch | 0 | - |
| 0x1A2810 | Otto Partikelfilter: Totalausfall | 0 | - |
| 0x1A2811 | Otto Partikelfilter: Aschewert größer Schwelle | 0 | - |
| 0x1A2812 | Otto Partikelfilter, Drucksensor, kurzzeitige Leistungsbegrenzung: Abgasgegendruck zu hoch | 0 | - |
| 0x1A2814 | Otto Partikelfilter, Drucksensor 2, Schlauchleitung: Undicht | 0 | - |
| 0x1A2817 | Otto Partikelfilter, Bank 2: Totalausfall | 0 | - |
| 0x1A2818 | Otto Partikelfilter: Regeneration ständig unterbrochen | 0 | - |
| 0x1A2829 | Abgastemperatursensor vor Otto Partikelfilter, Plausibilität: Signal festliegend | 0 | - |
| 0x1A2830 | Abgastemperatursensor vor Otto Partikelfilter, Plausibilität: Wert im Kaltstart zu hoch | 0 | - |
| 0x1A2831 | Abgastemperatursensor vor Otto Partikelfilter, Plausibilität: Wert im Kaltstart zu niedrig | 0 | - |
| 0x1A2832 | Abgastemperatursensor vor Otto Partikelfilter 2, Plausibilität: Signal festliegend | 0 | - |
| 0x1A2833 | Abgastemperatursensor vor Otto Partikelfilter 2, Plausibilität: Wert im Kaltstart zu hoch | 0 | - |
| 0x1A2834 | Abgastemperatursensor vor Otto Partikelfilter 2, Plausibilität: Wert im Kaltstart zu niedrig | 0 | - |
| 0x1A2835 | Abgastemperatursensor nach Otto Partikelfilter, Plausibilität: Signal festliegend | 0 | - |
| 0x1A2836 | Abgastemperatursensor nach Otto Partikelfilter, Plausibilität: Wert im Kaltstart zu hoch | 0 | - |
| 0x1A2837 | Abgastemperatursensor nach Otto Partikelfilter, Plausibilität: Wert im Kaltstart zu niedrig | 0 | - |
| 0x1A2838 | Abgastemperatursensor nach Otto Partikelfilter 2, Plausibilität: Signal festliegend | 0 | - |
| 0x1A2839 | Abgastemperatursensor nach Otto Partikelfilter 2, Plausibilität: Wert im Kaltstart zu hoch | 0 | - |
| 0x1A2840 | Abgastemperatursensor nach Otto Partikelfilter 2, Plausibilität: Wert im Kaltstart zu niedrig | 0 | - |
| 0x1A2841 | Otto Partikelfilter: Totalausfall mittels Temperatur erkannt | 0 | - |
| 0x1A2842 | Otto Partikelfilter 2: Totalausfall mittels Temperatur erkannt | 0 | - |
...
| 0x1BC114 | Nullgangsensor, Plausibilität: Periodendauer außerhalb gültigem Bereich | 0 | - |
...
| 0x1D2102 | Kennfeldthermostat, Ansteuerung: Kurzschluss nach Masse | 0 | - |
...
| 0x1E5001 | Kundenanzeige: Volle Antriebsleistung in Kürze verfügbar wurde aktiviert. | 0 | - |
...
| 0x20A012 | Ladeluftkühlpumpe, Ansteuerung: Kurzschluss nach Plus | 0 | - |
| 0x20A013 | Ladeluftkühlpumpe, Ansteuerung: Kurzschluss nach Masse | 0 | - |
| 0x20A014 | Ladeluftkühlpumpe, Ansteuerung: Leitungsunterbrechung | 0 | - |
| 0x20A015 | DME, interner Fehler, Ladeluftkühlpumpe: Übertemperatur erkannt | 0 | - |
| 0x20A016 | Ladeluftkühlpumpe, Masseabtastung: Trockenlauf | 0 | - |
| 0x20A017 | Ladeluftkühlpumpe, Masseabtastung: Pumpe blockiert | 0 | - |
| 0x20A018 | Ladeluftkühlpumpe, Masseabtastung: Pumpe überhitzt | 0 | - |
| 0x20A019 | Ladeluftkühlpumpe, Masseabtastung: Pumpe Unterschreitung Minimaldrehzahl | 0 | - |
| 0x20A01A | Ladeluftkühlpumpe: Masseabtastung unplausibel | 0 | - |
| 0x20A01B | Zusatzkühlmittelpumpe, Ansteuerung: Kurzschluss nach Plus | 0 | - |
| 0x20A01C | Zusatzkühlmittelpumpe, Ansteuerung: Kurzschluss nach Masse | 0 | - |
| 0x20A01D | Zusatzkühlmittelpumpe, Ansteuerung: Leitungsunterbrechung | 0 | - |
| 0x20A01E | DME, interner Fehler, Zusatzkühlmittelpumpe: Übertemperatur erkannt | 0 | - |
| 0x20A01F | Zusatzkühlmittelpumpe, Masseabtastung: Trockenlauf | 0 | - |
| 0x20A020 | Zusatzkühlmittelpumpe, Masseabtastung: Pumpe blockiert | 0 | - |
| 0x20A021 | Zusatzkühlmittelpumpe, Masseabtastung: Pumpe überhitzt | 0 | - |
| 0x20A022 | Zusatzkühlmittelpumpe, Masseabtastung: Pumpe Unterschreitung Minimaldrehzahl | 0 | - |
| 0x20A023 | Zusatzkühlmittelpumpe: Masseabtastung unplausibel | 0 | - |
...
| 0x20A105 | Ladeluft-Kühlmittelpumpe, Ansteuerung: Leitungsunterbrechung | 0 | - |
| 0x20A106 | DME: interner Fehler [Endstufe, Ladeluft-Kühlmittelpumpe: Temperatur zu hoch] | 0 | - |
| 0x20A107 | Ladeluft-Kühlmittelpumpe, Ansteuerung: Kurzschluss nach Masse | 0 | - |
| 0x20A109 | Ladeluft-Kühlmittelpumpe, Ansteuerung: Kurzschluss nach Plus | 0 | - |
| 0x20A10B | Ladeluft-Kühlsystem: Drehzahl Kühlmittelpumpe zu niedrig | 0 | - |
| 0x20A201 | Ladeluft-Kühlsystem: Schutzfunktion Kühlmittelpumpe wegen Trockenlauf aktiv | 1 | - |
| 0x20A203 | Ladeluft-Kühlsystem: Signal unplausibel | 0 | - |
...
| 0x20A503 | Turbolader-Kühlmittelpumpe: Signal unplausibel | 0 | - |
| 0x20A504 | Turbolader-Kühlmittelpumpe, Ansteuerung: Leitungsunterbrechung | 0 | - |
| 0x20A506 | DME: interner Fehler, Endstufe [Turbolader-Kühlmittelpumpe: Temperatur zu hoch] | 0 | - |
| 0x20A507 | Motor-Kühlsystem: Abschaltung Turboladerkühlmittelpumpe wegen Übertemperatur | 0 | - |
| 0x20A508 | Motor-Kühlsystem: Abschaltung Turboladerkühlmittelpumpe wegen Blockierung | 0 | - |
| 0x20A509 | Motor-Kühlsystem: Drehzahl Turboladerkühlmtitelpumpe zu niedrig | 0 | - |
| 0x20A50A | Motor-Kühlsystem: Schutzfunktion Turboladerkühlmittelpumpe wegen Trockenlauf aktiv | 0 | - |
...
| 0x215109 | Batterie, Batterieelektronik: Defekt | 0 | - |
| 0x21510A | Batterie, Batteriesensor, Arbeitsbereich: Entladestrom zu hoch | 0 | - |
| 0x21510B | Batterie, Batteriesensor, Arbeitsbereich: Aufladestrom zu hoch | 0 | - |
| 0x21510C | Batterie, Batteriesensor: Trennschalter offen | 0 | - |
| 0x21510D | Batterie, Batteriesensor, Arbeitsbereich: Spannung zu hoch | 0 | - |
| 0x21510E | Batterie, Batteriesensor, Arbeitsbereich: Temperatur zu hoch | 0 | - |
| 0x21510F | Batterie, Batteriesensor, Arbeitsbereich: Spannung zu niedrig | 0 | - |
| 0x215110 | Batterie, Batteriesensor, Plausibilität: Temperatur oder Zellspannung zu hoch | 0 | - |
| 0x215203 | Batterie, Batteriesensor, Arbeitsbereich: Temperatur zu niedrig | 0 | - |
...
| 0x216112 | Ritzelstarter, Bauteilschutzfunktion: Kritische Schwelle erreicht | 0 | - |
| 0x216113 | Ritzelstarter, Bauteilschutzfunktion: Warnschwelle erreicht | 0 | - |
| 0x216114 | Ritzelstarter: Startfähigkeit gefährdet, grenzwertige Bordnetzspannung | 0 | - |
| 0x216115 | Ritzelstarter: Startversuch mit blockiertem Starter erkannt | 0 | - |
| 0x216116 | Ritzelstarter: Startversuch bei Fehler im Verbrennersystem erkannt | 0 | - |
| 0x216117 | Ritzelstarter: Startversuch bei Fehler im Kraftstoffsystem erkannt | 0 | - |
| 0x216118 | RitzelStarter: Startversuch bei Eigentumsschutz erkannt EWS Freigabe während Startversuch fehlerhaft oder verzögert bzw. nicht  vorhanden | 0 | - |
| 0x216119 | Ritzelstarter: Leitungsunterbrechung Starteransteuerung (KL50 / KL30) | 0 | - |
| 0x21611A | Ritzelstarter: Startfähigkeitsgrenze VM nicht erreicht, Startdrehmoment konnte nicht aufgebaut werden. Hohes Gegendrehmoment und/Oder Unterspannung. | 0 | - |
| 0x21611B | Ritzelstarter: Startversuch bei Überspannung erkannt. Vorbedingung: Ein Fremdstart mit einem NKW/LKW. | 0 | - |
| 0x21611C | Ritzelstarter: Bordnetzspannnung bei Startversuch nicht ausreichend | 0 | - |
...
| 0x240001 | Radarsensor: Sensor defekt | 0 | - |
| 0x240002 | Kamera: verschmutzt oder Lichtverhältnisse unpassend | 0 | - |
| 0x240003 | Radarsensor: Sensor verschmutzt oder verdeckt | 0 | - |
| 0x240004 | Ventilhubkorrektur im Leerlauf nicht erfolgreich | 0 | - |
| 0x240005 | eSUV: offen bzw. geschlossen klemmendes eSUV (Master) Bank1 | 0 | - |
| 0x240006 | eSUV: offen bzw. geschlossen klemmendes eSUV (Slave) Bank1 | 0 | - |
| 0x240007 | eSUV: offen bzw. geschlossen klemmendes eSUV (Master) Bank2 | 0 | - |
| 0x240008 | eSUV: offen bzw. geschlossen klemmendes eSUV (Slave) Bank2 | 0 | - |
| 0x240009 | Elektrolüfter, Eigendiagnose Stufe 1: leichter Lüfterfehler | 0 | - |
| 0x24000A | Elektrolüfter, Kommunikationsfehler | 0 | - |
| 0x32B400 | Botschaft (ST_AKKS_2_LIN, 0x2C, LIN), Timeout: Botschaft (Status_AKKS_2_LIN) von AKKS_2 ausgefallen | 0 | - |
| 0x32B700 | Botschaft (ST_DIAG_OBD_20_PT_LIN_AKKS_2, 0x2B, LIN), Alivecounter: Botschaft (Status_Diagnose_OBD_20_Antriebsstrang_LIN_AKKS_2) von AKKS_2 nicht aktuell | 0 | - |
| 0x32B800 | Botschaft (ST_DIAG_OBD_20_PT_LIN_AKKS_2, 0x2B, LIN), Timeout: Botschaft (Status_Diagnose_OBD_20_Antriebsstrang_LIN_AKKS_2) von AKKS_2 ausgefallen | 0 | - |
...
| 0xCDA038 | FlexRay, Botschaft (Information Daten Zielobjekt Geschwindigkeitsregelung, 71.7.32): fehlt | 1 | - |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x5400 | normierter Kreuzkorrelationsfaktor des gemessenen und modellierten Differenzdruck über den OPF Bank2 | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5582 | Ascheeinfluss Bank 2 | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5583 | Russmasse Partikelfilter Bank 2 | g | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5584 | Erfasster Differenzdruck nach dem Partikelfilter Bank 2 | hPa | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x5585 | Rohspannungswert Drucksensor OPF Bank 2 | mV | - | signed int | - | 0.2 | 1.0 | 0.0 |
| 0x5586 | gefilterte Wert des Differenzdrucks am OPF Bank 2 | hPa | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x5587 | Aktueller Wert des Differenzdruckoffsets Bank 2 | hPa | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x5588 | angepasste Spannungsrohwert des Differenzdrucks am Partikelfilter Bank 2 | hPa | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x558B | Adaptierte Aschemasse im OPF | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x558C | Adaptierte Gesamtbeladung des OPF | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x558D | normierter Kreuzkorrelationsfaktor des gemessenen und modellierten Differenzdruck über den OPF | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5598 | Adaptierte Aschemasse im Partikelfilter Bank2 | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5599 | Adaptierte Gesamtbeladung des Partikelfilters Bank2 | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x559A | minimum freigabe Kühlmitteltemperatur wurde mindestens einmal im Fahrzyklus überschritten | 0/1 | - | 0x01 | - | - | - | - |
| 0x55C6 | Abbruchzähler der parallelisierten Diagnose Lambdasonden und Katalysator | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x5773 | Ascheeinfluss | - | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5774 | Russmasse im Partikelfilter | g | - | signed int | - | 0.001 | 1.0 | 0.0 |
| 0x5784 | Betriebsdauer seit der letzten erfolgreichen Regeneration OPF | s | - | signed long | - | 1.0 | 1.0 | 0.0 |
| 0x579B | Temperatur im Partikelfilter Bank 1 | - | - | signed int | - | 0.1 | 1.0 | -273.13999023 |
| 0x579E | Temperatur im Partikelfilter Bank 2 | - | - | signed int | - | 0.1 | 1.0 | -273.13999023 |
| 0x57A9 | Druckrohwert Drucksensor Ottopartikelfilter | hPa | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x57C9 | Rohspannungswert Drucksensor Ottopartikelfilter | mV | - | signed int | - | 0.2 | 1.0 | 0.0 |
| 0x57DC | Aktueller Wert des Differenzdruckoffsets für die Offsetkorrektur des Differenzdrucks über den Ottopartikelfilter | hPa | - | signed int | - | - | - | - |
...
| 0x5803 | Zustand Lamdaregelung Bank2 | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5808 | Lamdaintegrator Bank2 | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5809 | Lamdaadaption Summe Bank 2 | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
...
| 0x5810 | Aktualität Minimumwarnung | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x5820 | Status Klemme 15 | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x5824 | Fehlerstatus E-Maschiene | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x5828 | Tastverhältnis Lamdasondenheitzung Bank2 | % | - | unsigned int | - | 0.00305176 | 1.0 | 0.0 |
...
| 0x5839 | Bedingung Sicherheitskraftstoffabschaltung (SKA) | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x5848 | Spannung Lambdasonde von Kat Bank 2 | V | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 |
...
| 0x584B | Spannung Lamdasonde hinter Kat Bank2 | V | - | unsigned int | - | 0.00488281 | 1.0 | -1.0 |
...
| 0x5856 | schneller Mittelwert Lamdaregelfaktor Bank 2 | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
...
| 0x5861 | Innenwiderstand der Nernstzelle der LSU Bank2 | Ohm | - | unsigned char | - | 10.0 | 1.0 | 0.0 |
...
| 0x5864 | Innenwiederstand Lamdasonde hinter Kat Bank 2 Low Byte | Ohm | - | unsigned char | - | 0.0390625 | 1.0 | 0.0 |
...
| 0x5873 | Sollwert Lambda-Sensor Bank2 | - | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 |
...
| 0x588A | Lambda-Istwert Bank2 | - | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 |
...
| 0x588F | Keramiktemperatur der LSU, Bank 2 | °C | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 |
| 0x5890 | Temperatur Kühlerauslasssensor | °C | - | unsigned char | - | 0.75 | 1.0 | -48.0 |
...
| 0x5897 | Abgastemperatur nach Hauptkat aus Modell, Bank2 | °C | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 |
| 0x5898 | phys. Wert Generatorsollspannung (Volt) für Komponententreiber Generator | V | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x5899 | Bedingung Anforderung Motorrelais einschalten | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
| 0x589A | Tastverhältnis Nullgangsensor | % | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x589B | Bedingung unzulössig hoher Motorstrom bei Kurzschluss erkannt | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
| 0x589C | Bedingung Freigabe VVT-Endstufe | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x58BF | Bedingung Powerfail EEPROM | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x58D4 | Startbedingung Kraftschluss erfüllt | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
...
| 0x58FE | Fehler SWT Freischaltung | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5910 | Sollwert E-Pumpe Abgasturbolader | 1/min | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5912 | Sollwert E-Pumpe Ladeluftkühlung | 1/min | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5913 | Status elektrische Pumpe Abgasturbolader | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5915 | Status elektrische Pumpe Ladeluftkühlung | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5928 | Ist Position Elektrische Wastegate Bank2 | % | - | unsigned char | - | 0.390625 | 1.0 | 0.0 |
...
| 0x5945 | Anzahl VVT Notlauf bis Tausch | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5946 | Anzahl VVT Notlauf | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5955 | Spannung hinter Zünd- Einspritzrelais | V | - | unsigned char | - | 0.1 | 1.0 | 0.0 |
| 0x595E | Massenstrom HFM Bank 2 | kg/h | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x595F | Peridendauer für Massenstrom aus HFM Bank 2 | µs | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x5961 | Förderdauer MSV in Grad KW | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x5962 | Mengensteuerventil Ansteuerung aktiv | 0/1 | - | 0x01 | - | 1.0 | 1.0 | 0.0 |
| 0x5965 | Istwert (word) Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT | Ohm | - | unsigned int | - | 2.0 | 1.0 | 0.0 |
| 0x5966 | Istwert (word) Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT Bank2 | Ohm | - | unsigned int | - | 2.0 | 1.0 | 0.0 |
| 0x5967 | normierte Heizleistung der Lambdasonde hinter Kat | - | - | unsigned char | - | 0.01 | 1.0 | 0.0 |
| 0x5968 | normierte Heizleistung Lamdasonde hinter Kat Bank 2 | - | - | unsigned char | - | 0.01 | 1.0 | 0.0 |
| 0x5969 | Sauerstoffspeichervermögen KAT | - | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 |
| 0x596A | Sauerstoffspeichervermögen KAT Bank2 | - | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 |
| 0x596B | Transition Time O2Sensor Rich2Lean (Sensor2) Bank 1 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x596C | Transition Time O2Sensor Lean2Rich (Sensor2) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x596D | Transition Time O2Sensor Rich2Lean (Sensor2) Bank 2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x596E | Transition Time O2Sensor Lean2Rich (Sensor2) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x596F | gemessene delay time R2L (fett-mager-Sprung) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5970 | gemessene delay time L2R (mager-fett-Sprung) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5971 | gemessene delay time R2L (fett-mager-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5972 | gemessene delay time L2R (mager-fett-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5973 | Delta Sondenoffset Führungsregelung | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5974 | gemessene transition time L2R (mager-fett-Sprung) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5975 | gemessene trandition time R2L (fett-mager-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5976 | gemessene transition time L2R (mager-fett-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5977 | gemessene delay time R2L (fett-mager-Sprung) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5978 | gemessene delay time L2R (mager-fett-Sprung) | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x5979 | gemessene delay time R2L (fett-mager-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x597A | gemessene delay time L2R (mager-fett-Sprung) Bank2 | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x597B | Delta Sondenoffset Führungsregelung | - | - | signed int | - | 0.00003052 | 1.0 | 0.0 |
| 0x597C | Delta Sondenoffset Führungsregelung Bank2 | - | - | signed int | - | 0.00003052 | 1.0 | 0.0 |
| 0x597D | Abgasmasse | kg/h | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x598B | gesamte Kraftstoffadaption (Füllung+Gemisch) Bank1 | % | - | signed int | - | 0.00152588 | 1.0 | 0.0 |
| 0x598C | gesamte Kraftstoffadaption (Füllung+Gemisch) Bank2 | % | - | signed int | - | 0.00152588 | 1.0 | 0.0 |
| 0x598F | Massenstrom vom HFM 1 | kg/h | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x59BD | [0] Einlass-NW Winkelversatz Feinadaption | ° KW | - | signed long | - | 0.02197266 | 1.0 | 0.0 |
| 0x59BE | [1] Auslass-NW Winkelversatz Feinadaption | ° KW | - | signed long | - | 0.02197266 | 1.0 | 0.0 |
...
| 0x59C1 | Korrigierte Segmentdauer | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x59CA | Fehlerstatus KW-Signal | - | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 |
| 0x59CB | Triebstrangübersetzungsverhaeltnis gefiltert in der Funktionsueberwachung | - | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 |
...
| WERT | TEXT |
| --- | --- |
| 0x0001 | MisfDet_nrFltIdCat_C   Katalysatorschädigende Aussetzer |
| 0x0002 | MisfDet_nrFltIdEmi_C   Emissionsrelevante Aussetzer |
| 0x0003 | TWCD_nrFltldObdRdrB1   Katalysatordiagnose durch Bestimmung der Sauerstoffspeicherfähigkeit Bank 1  |
| 0x0004 | TWCD_nrFltldObdRdrB2   Katalysatordiagnose durch Bestimmung der Sauerstoffspeicherfähigkeit Bank 2  |
| 0x0005 | FlMA_FRAId_C   Gemischadaption Diagnose Bank 1  |
| 0x0006 | FlMA_FRA2Id_C   Gemischadaption Diagnose Bank 2  |
| 0x0007 | CEngDsT_nrFltIdObdRdr_C   OBD-Radar für Kühlmitteltemperatursensor |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| - | Bit | high | BITFIELD | - | BF_3300_BYTE_1 | - | - | - | Codierung Byte 1 |
| - | Bit | high | BITFIELD | - | BF_3300_BYTE_2 | - | - | - | Byte 2 |
| STAT_VROHW_WERT | HEX | high | unsigned char | - | - | - | - | - | VROHW |
| - | Bit | high | BITFIELD | - | BF_3300_BYTE_4 | - | - | - | Byte 4 |
| STAT_GENBUS_WERT | HEX | high | unsigned char | - | - | - | - | - | GenBus |
| STAT_CODAUSST_1_WERT | HEX | high | signed int | - | - | - | - | - | CodAusst_1 |
| - | Bit | high | BITFIELD | - | BF_3300_BYTE_8 | - | - | - | Codierung Byte 8 |
| STAT_LAENDERCODIERUNG_WERT | HEX | high | signed int | - | - | - | - | - | Laendercodierung |
| - | Bit | high | BITFIELD | - | BF_3300_BYTE_11 | - | - | - | Codierung Byte 11 |
| STAT_UNUSED_DATA | DATA | high | data[25] | - | - | 1.0 | 1.0 | 0.0 | Unused |

### RES_0X3320_D

| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_OEL_CONFIG_WERT | HEX | high | signed int | - | - | - | - | - | OEL-Config |
| - | Bit | high | BITFIELD | - | BF_3320_BYTE_3 | - | - | - | Codierung Byte 3 |
| - | Bit | high | BITFIELD | - | BF_3320_BYTE_4 | - | - | - | Codierung Byte 4 |
| STAT_BZE_DATA | DATA | high | data[8] | - | - | 1.0 | 1.0 | 0.0 | BZE |
| - | Bit | high | BITFIELD | - | BF_3320_BYTE_13 | - | - | - | Codierung Byte 13 |
| STAT_MSA_WERT | HEX | high | unsigned char | - | - | - | - | - | MSA |
| STAT_CODAUSST_2_WERT | HEX | high | signed int | - | - | - | - | - | CodAusst_2 |
| STAT_KONFIGURATION_ABGASKLAPPENSTEUERUNG_WERT | HEX | high | unsigned char | - | - | - | - | - | Konfiguration Abgasklappensteuerung |
| STAT_EKP_WERT | HEX | high | unsigned char | - | - | - | - | - | EKP |
| STAT_VSU_WERT | HEX | high | unsigned char | - | - | - | - | - | VSU |
| STAT_WMK_WERT | HEX | high | unsigned char | - | - | - | - | - | WMK |
| STAT_KGEH_WERT | HEX | high | unsigned char | - | - | - | - | - | KGEH |
| STAT_TANKKONFIGURATION_WERT | HEX | high | unsigned char | - | - | - | - | - | Tankkonfiguration |
| STAT_TRPRCD_WERT | HEX | high | unsigned char | - | - | - | - | - | TrpRcd |
| STAT_MSA_VERSION_WERT | HEX | high | unsigned char | - | - | - | - | - | MSA-Version |
| STAT_AKR_VARIANTE_WERT | HEX | high | unsigned char | - | - | - | - | - | AKR-Variante |
| STAT_MSA_STARTERVARIANTE_WERT | HEX | high | unsigned char | - | - | - | - | - | MSA-Startervariante |
| STAT_PCU500_U_I_WERT | HEX | high | unsigned char | - | - | - | - | - | PCU500_U_I |
| - | Bit | high | BITFIELD | - | BF_3320_BYTE_28 | - | - | - | Codierung Byte 28 |
| - | Bit | high | BITFIELD | - | BF_3320_BYTE_29 | - | - | - | Codierung Byte 29 |
| STAT_UNUSED_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Unused |
...
| 0x1A | SWRESET_UNSUPPORTED_CPU_E |
| 0x1B | RESET_ADCI_E |
| 0x1C | RESET_FSCSRV_SPI_E |
| 0x1D | RESET_FSCSRV_CLK_E |
| 0x1E | RESET_CANGRP_E |
| 0x1F | RESET_DMA_E |
| 0x20 | RESET_FLASH_E |
| 0x21 | SWRESET_PCP_GRP_E |
| 0xFF | undefiniert |
...
| 0x3052 | RESET_FSCSRV_SPI_ERROR_E |
| 0x3053 | RESET_FSCSRV_CLK_ERROR_E |
| 0x3054 | SWRST_CAN_MESSAGECONFIG |
| 0x3055 | RESET_DMA_ERROR_E |
| 0x3056 | SWRST_FLASHCONFIG_E |
| 0x3057 | SWRESET_PCP_ERROR_E |
| 0xFFFF | undefiniert |
...
| CODIERUNG_BSR | 0x3300 | - | Codierung BSR | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x3300_D |
| CODIERUNG_BSU | 0x3320 | - | Codierung BSU | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x3320_D |
...
| STAT_0x4206_WERT | 0x4206 | STAT_0X4206_WERT | Massenstrom über Drosselklappe | kg/h | Msdk_i | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4530_WERT | 0x4530 | STAT_0X4530_WERT | [0] Aktueller Einspritzmodus Zyl 1 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4531_WERT | 0x4531 | STAT_0X4531_WERT | [1] Aktueller Einspritzmodus Zyl 5 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4532_WERT | 0x4532 | STAT_0X4532_WERT | [2] Aktueller Einspritzmodus Zyl 3 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4533_WERT | 0x4533 | STAT_0X4533_WERT | [3] Aktueller Einspritzmodus Zyl 6 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4534_WERT | 0x4534 | STAT_0X4534_WERT | [4] Aktueller Einspritzmodus Zyl 2 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4535_WERT | 0x4535 | STAT_0X4535_WERT | [5] Aktueller Einspritzmodus Zyl 4 | - | InjMdChgA | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4536_WERT | 0x4536 | STAT_0X4536_WERT | Regeldifferenz Ladedruck | hPa | Pld_diff_xeb | - | signed int | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4438_WERT | 0x4538 | STAT_0X4438_WERT | Mittlerer Versatz der äquidistanten Flanken der Nockenwelle [0] | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4539_WERT | 0x4539 | STAT_0X4539_WERT | Mittlerer Versatz der äquidistanten Flanken der Nockenwelle [1] | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x453C_WERT | 0x453C | STAT_0X453C_WERT | Reset-Zähler der Geberradadaption | - | fofresz | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x453D_WERT | 0x453D | STAT_0X453D_WERT | Status der Fuel-On-Adaption im aktuellen Betriebsbereich | - | fonstat | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x453E_WERT | 0x453E | STAT_0X453E_WERT | [0] Adaptionswerte der Geberradadaption | - | fsof1 | - | unsigned long | - | 0.00000006 | 1.0 | -119.99999374 | - | 22;2C | - | - |
| STAT_0x453F_WERT | 0x453F | STAT_0X453F_WERT | [1]Adaptionswerte der Geberradadaption | - | fsof1 | - | unsigned long | - | 0.00000006 | 1.0 | -119.99999374 | - | 22;2C | - | - |
...
| STAT_0x4602_WERT | 0x4602 | STAT_0X4602_WERT | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Aadaption | mm | evhubi_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4615_WERT | 0x4615 | STAT_0X4615_WERT | Grenzerregerstrom EMaschine 1 | A | isgusmierrgrenz_w | - | unsigned int | - | 0.00125 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4655_WERT | 0x4655 | STAT_0X4655_WERT | Sensorspannung Positionssensor elektrisches Wastegate Bank2 | V | ukrkp2_w | - | unsigned int | - | 0.0012207 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4656_WERT | 0x4656 | STAT_0X4656_WERT | Rohwert Positionssensor elektrisches Wastegate Bank2 | mm | elwgposri2_w | - | signed int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| ISBV2 | 0x4701 | STAT_SONDENBEREITSCHAFT_VORKAT_BANK2 | Status Lambdasonde betriebsbereit vor Katalysator Bank 2 | 0/1 | B_sbbvk2 | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| IUSO2 | 0x4703 | STAT_SONDENSPANNUNG_VORKAT_BANK2_MIT_OFFSET_WERT | Spannung Lambdasonde vor Katalysator Bank 2 mit Offsetkorrektur | V | ua10mo2_w | - | unsigned int | - | 0.00048828 | 1.0 | 0.0 | - | 22;2C | - | - |
| SINT1 | 0x4704 | STAT_LAMBDA_BANK1_SOLL_WERT | Lambdasoll | - | lamsbg_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
| SINT2 | 0x4705 | STAT_LAMBDA_BANK2_SOLL_WERT | Lambdasoll Bank2 | - | lamsbg2_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4720_WERT | 0x4720 | STAT_0X4720_WERT | Abgastemperatur nach KAT aus Modell Bank2 | °C | tkatm2 | - | unsigned char | - | 5.0 | 1.0 | -50.0 | - | 22;2C | - | - |
| STAT_0x4721_WERT | 0x4721 | STAT_0X4721_WERT | Lambdasonden-Istwert Bank2 | - | lamzak2_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4722_WERT | 0x4722 | STAT_0X4722_WERT | Abgasmasse während OSC Messung | mg | TWCD_mExhAtOscCat1B1 | - | unsigned int | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4723_WERT | 0x4723 | STAT_0X4723_WERT | Abgasmasse während OSC Messung Bank2 | mg | TWCD_mExhAtOscCat1B2 | - | unsigned int | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4724_WERT | 0x4724 | STAT_0X4724_WERT | Abgasmasse während RSC Messung | mg | TWCD_mExhAtRoscCat1B1 | - | unsigned int | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4725_WERT | 0x4725 | STAT_0X4725_WERT | Abgasmasse während RSC Messung Bank2 | mg | TWCD_mExhAtRoscCat1B2 | - | unsigned int | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4728_WERT | 0x4728 | STAT_0X4728_WERT | Bedingung Sonde betriebsbereit hinter Kat | 0/1 | HEGO_bS2B1Vld | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x4729_WERT | 0x4729 | STAT_0X4729_WERT | Bedingung Sonde betriebsbereit hinter Kat Bank2 | 0/1 | HEGO_bS2B2Vld | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x472A_WERT | 0x472A | STAT_0X472A_WERT | I-Anteil Trimmregelung | - | TWCC_rICtlPriB1 | - | signed int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x472B_WERT | 0x472B | STAT_0X472B_WERT | I-Anteil Trimmregelung Bank2 | - | TWCC_rICtlPriB2 | - | signed int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4804_WERT | 0x4804 | STAT_0X4804_WERT | Motorhaubensignal | 0/1 | BasSvrAppl_stHoodOpenSigOk | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| ISMOT | 0x4820 | STAT_MOTORTASTER_WERT | Sporttaster | 0/1 | S_spt | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| STAT_0x4882_WERT | 0x4882 | STAT_0X4882_WERT | Zähler Startabbrüche oder Ausgeher nach Schlüsselstart, LambdaRegler nicht aktiv | - | SwSABMW_CntrDetdFaildStrtOnlyKeyStrt | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4A1D_WERT | 0x4A1D | STAT_0X4A1D_WERT | Spannung Bremsunterdruck | V | udsbkv_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| ISHN2 | 0x4A55 | STAT_SONDENHEIZUNG_NACHKAT_BANK2_WERT | Bedingung Sonde hinter Kat ausreichend beheizt Bank2 | 0/1 | B_hsha2 | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| ISHV2 | 0x4A57 | STAT_SONDENHEIZUNG_VORKAT_BANK2_WERT | Bedingung: Heizerstatus A liegt vor, Sonde ist ausreichend aufgeheizt Bank2 | 0/1 | B_hstlsua2 | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| IMUL2 | 0x4A86 | STAT_ADAPTION_MULTIPLIKATIV_BANK2_WERT | multiplikative Gemischkorrektur der Gemischadaption | - | fra2_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4A9E_WERT | 0x4A9E | STAT_0X4A9E_WERT | multiplikative Gemischkorrektur der Gemischadaption Bank 2 | - | frai2_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4AAC_WERT | 0x4AAC | STAT_0X4AAC_WERT | Tastverhältnis Ladedrucksteller Bank 2 | % | tvldste2_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| OPF_NORM_KREUZKORRFAKB2 | 0x5400 | STAT_OPF_NORM_KREUZKORRFAK_B2_WERT | normierter Kreuzkorrelationsfaktor des gemessenen und modellierten Differenzdruck über den OPF Bank2 | - | PFltSig_ratPCorrlnB2 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANTEIL_ASCHE_OPF_BANK2 | 0x5582 | STAT_ANTEIL_ASCHE_OPF_BANK2_WERT | Ascheeinfluss Bank 2 | - | PFltLd_ratAshB2 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANTEIL_RUSS_OPF_BANK2 | 0x5583 | STAT_ANTEIL_RUSS_OPF_BANK2_WERT | Russmasse Partikelfilter Bank 2 | g | PFltLd_mSotLoadB2 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIFFDRUCK_MITTEL_OPF_BANK2 | 0x5584 | STAT_DIFFDRUCK_MITTEL_OPF_BANK2_WERT | Erfasster Differenzdruck nach dem Partikelfilter Bank 2 | hPa | Exh_pSensPPFltDiffB2 | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| U_ROH_DRUCKSENS_ADC_OPF_BANK2 | 0x5585 | STAT_U_ROH_DRUCKSENS_ADC_OPF_BANK2_WERT | Rohspannungswert Drucksensor OPF Bank 2 | mV | Exh_uRawPPFltDiffB2 | - | signed int | - | 0.2 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIFFDRUCK_GEFI_ADAP_OPF_BANK2 | 0x5586 | STAT_DIFFDRUCK_GEFI_ADAP_OPF_BANK2_WERT | gefilterte Wert des Differenzdrucks am OPF Bank 2 | hPa | Exh_pFltPPFltDiffB2 | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| AKT_WERT_DIFFDRUCK_OFFS_OPF_BANK2 | 0x5587 | STAT_AKT_WERT_DIFFDRUCK_OFFS_OPF_BANK2_WERT | Aktueller Wert des Differenzdruckoffsets Bank 2 | hPa | Exh_pDiffOfsValActB2 | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIFFDRUCK_GEFI_OPF_BANK2 | 0x5588 | STAT_DIFFDRUCK_GEFI_OPF_BANK2_WERT | angepasste Spannungsrohwert des Differenzdrucks am Partikelfilter Bank 2 | hPa | Exh_pRawAdapPPFltDiffB2 | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| OPF_ADAPTIERTE_ASCHEMASSE | 0x558B | STAT_OPF_ADAPTIERTE_ASCHEMASSE_WERT | Adaptierte Aschemasse im OPF | - | SwSABMW_AdpnAshMGpfB1 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| OPF_ADAPTIERTE_GES_LADUNG | 0x558C | STAT_OPF_ADAPTIERTE_GES_LADUNG_WERT | Adaptierte Gesamtbeladung des OPF | - | SwSABMW_AdpnTotLoadGpfB1 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| OPF_NORM_KREUZKORRFAK | 0x558D | STAT_OPF_NORM_KREUZKORRFAK_WERT | normierter Kreuzkorrelationsfaktor des gemessenen und modellierten Differenzdruck über den OPF | - | PFltSig_ratPCorrlnB1 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| OPF_ADAPTIERTE_ASCHEMASSE_BANK2 | 0x5598 | STAT_OPF_ADAPTIERTE_ASCHEMASSE_BANK2_WERT | Adaptierte Aschemasse im Partikelfilter Bank2 | - | SwSABMW_AdpnAshMGpfB2 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| OPF_ADAPTIERTE_GES_LADUNG_BANK2 | 0x5599 | STAT_OPF_ADAPTIERTE_GES_LADUNG_BANK2_WERT | Adaptierte Gesamtbeladung des Partikelfilters Bank2 | - | SwSABMW_AdpnTotLoadGpfB1 | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| MIN_KUEHLM_TEMP_UEBE | 0x559A | STAT_MIN_KUEHLM_TEMP_UEBERSCHR_IN_FZYK | minimum freigabe Kühlmitteltemperatur wurde mindestens einmal im Fahrzyklus überschritten | 0/1 | CEngDsT_flgtRefMdlEndExcdd | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| ZHL_PLAMDIAG | 0x55C6 | STAT_ABBRUCHZAEHLER_PARAL_DIAG_LAMBD_KAT_WERT | Abbruchzähler der parallelisierten Diagnose Lambdasonden und Katalysator | - | EGSDCmn_cntrSeg1B1AbortSumParl | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANTEIL_ASCHE_OPF | 0x5773 | STAT_ANTEIL_ASCHE_OPF_WERT | Ascheeinfluss | - | PFltLd_ratAsh | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANTEIL_RUSS_OPF | 0x5774 | STAT_ANTEIL_RUSS_OPF_WERT | Russmasse im Partikelfilter | g | PFltLd_mSotLoad | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| BETR_DAUER_SEIT_L_RE | 0x5784 | STAT_BETR_DAUER_SEIT_L_REGEN_WERT | Betriebsdauer seit der letzten erfolgreichen Regeneration OPF | s | PFltRgn_tiSnceRgn | - | signed long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| ABGTEMP_KRUEM_AMOT_B1 | 0x579B | STAT_ABGTEMP_KRUEM_AMOT_BANK1_WERT | Temperatur im Partikelfilter Bank 1 | - | PFlt_tFilDevB1 | - | signed int | - | 0.1 | 1.0 | -273.13999023 | - | 22;2C | - | - |
| ABGTEMP_KRUEM_AMOT_B2 | 0x579E | STAT_ABGTEMP_KRUEM_AMOT_BANK2_WERT | Temperatur im Partikelfilter Bank 2 | - | PFlt_tFilDevB2 | - | signed int | - | 0.1 | 1.0 | -273.13999023 | - | 22;2C | - | - |
| DIFFDRUCK_MITTEL_OPF | 0x57A9 | STAT_DIFFDRUCK_MITTEL_OPF_WERT | Druckrohwert Drucksensor Ottopartikelfilter | hPa | Exh_pSensPPFltDiff | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| U_ROH_DRUCKSENS_ADC_ | 0x57C9 | STAT_U_ROH_DRUCKSENS_ADC_OPF_WERT | Rohspannungswert Drucksensor Ottopartikelfilter | mV | Exh_uRawPPFltDiff | - | signed int | - | 0.2 | 1.0 | 0.0 | - | 22;2C | - | - |
| AKT_WERT_DIFFDRUCK_OFFS_OPF | 0x57DC | STAT_AKT_WERT_DIFFDRUCK_OFFS_OPF_WERT | Aktueller Wert des Differenzdruckoffsets für die Offsetkorrektur des Differenzdrucks über den Ottopartikelfilter | hPa | Exh_pDiffOfsValActB1 | - | signed int | - | - | - | - | - | 22;2C | - | - |
...
| STAT_0x5803_WERT | 0x5803 | STAT_0X5803_WERT | Zustand Lamdaregelung Bank2 | - | flglrs2 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5808_WERT | 0x5808 | STAT_0X5808_WERT | Lamdaintegrator Bank2 | - | fr2_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5809_WERT | 0x5809 | STAT_0X5809_WERT | Lamdaadaption Summe Bank 2 | - | frann2_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5824_WERT | 0x5824 | STAT_0X5824_WERT | Fehlerstatus E-Maschiene | - | St_isgusm_diag | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5828_WERT | 0x5828 | STAT_0X5828_WERT | Tastverhältnis Lamdasondenheitzung Bank2 | % | tahrlsu2_w | - | unsigned int | - | 0.00305176 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5848_WERT | 0x5848 | STAT_0X5848_WERT | Spannung Lambdasonde von Kat Bank 2 | V | uulsuv2_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x584B_WERT | 0x584B | STAT_0X584B_WERT | Spannung Lamdasonde hinter Kat Bank2 | V | ushk2_w | - | unsigned int | - | 0.00488281 | 1.0 | -1.0 | - | 22;2C | - | - |
...
| STAT_0x5856_WERT | 0x5856 | STAT_0X5856_WERT | schneller Mittelwert Lamdaregelfaktor Bank 2 | - | frm2_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IRLV2 | 0x5861 | STAT_LAMBDASONDE_WIDERSTAND_VORKAT2_WERT | Innenwiderstand der Nernstzelle der LSU Bank2 | Ohm | rinlsu2_w | - | unsigned char | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IRUV2 | 0x5864 | STAT_LAMBDASONDE_WIDERSTAND_VORKAT2_UNTERES_BYTE_WERT | Innenwiederstand Lamdasonde hinter Kat Bank 2 Low Byte | Ohm | rinlsu_w | - | unsigned char | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5873_WERT | 0x5873 | STAT_0X5873_WERT | Sollwert Lambda-Sensor Bank2 | - | lamsons2_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x588A_WERT | 0x588A | STAT_0X588A_WERT | Lambda-Istwert Bank2 | - | lamsoni2_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x588F_WERT | 0x588F | STAT_0X588F_WERT | Keramiktemperatur der LSU, Bank 2 | °C | tkerlsu2_w | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 | - | 22;2C | - | - |
| STAT_0x5890_WERT | 0x5890 | STAT_0X5890_WERT | Temperatur Kühlerauslasssensor | °C | tka | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
...
| STAT_0x5897_WERT | 0x5897 | STAT_0X5897_WERT | Abgastemperatur nach Hauptkat aus Modell, Bank2 | °C | tanhkm2_w | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 | - | 22;2C | - | - |
...
| STAT_0x58FE_WERT | 0x58FE | STAT_0X58FE_WERT | Fehler SWT Freischaltung | - | Sia_TRes_St | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5910_WERT | 0x5910 | STAT_0X5910_WERT | Sollwert E-Pumpe Abgasturbolader | 1/min | newpsoll20 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5912_WERT | 0x5912 | STAT_0X5912_WERT | Sollwert E-Pumpe Ladeluftkühlung | 1/min | newpsoll22 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5913_WERT | 0x5913 | STAT_0X5913_WERT | Status elektrische Pumpe Abgasturbolader | - | WtrPmp_stDiagEwp20 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5915_WERT | 0x5915 | STAT_0X5915_WERT | Status elektrische Pumpe Ladeluftkühlung | - | CACPmp_stDiagEwp22 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5928_WERT | 0x5928 | STAT_0X5928_WERT | Ist Position Elektrische Wastegate Bank2 | % | SwSABMW_ratPosWge2Tst | - | unsigned char | - | 0.390625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x593B_WERT | 0x593B | STAT_0X593B_WERT | Gangsensor Fehlernachricht | - | GbxPos_numSnsrFault | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x593D_WERT | 0x593D | STAT_0X593D_WERT | Fehlerbits des Gangsensorfehlers | - | GbxPos_stSensErr | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x593E_WERT | 0x593E | STAT_0X593E_WERT | Gangsensorposition in X (Alpha) Richtung nach Offsetkorrektur | ° | GbxPos_agXPosAftOffs | - | unsigned int | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x593F_WERT | 0x593F | STAT_0X593F_WERT | Gangsensorposition in Y (Beta) Richtung nach Offsetkorrektur | ° | GbxPos_agYPosAftOffs | - | unsigned int | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5940_WERT | 0x5940 | STAT_0X5940_WERT | Ist Ganginformation des Gangsensors | - | GbxPos_numLvrPos | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5941_WERT | 0x5941 | STAT_0X5941_WERT | Gangsensorposition in X (Beta) Richtung | ° | GbxPos_agXPos | - | unsigned long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5942_WERT | 0x5942 | STAT_0X5942_WERT | Gangsensorposition in Y (Beta) Richtung | ° | GbxPos_agYPos | - | unsigned long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5943_WERT | 0x5943 | STAT_0X5943_WERT | Gespeicherter Offsetkorrekturwert für X (Alpha) | ° | GbxPos_agXPosOffsEepRd | - | signed long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5944_WERT | 0x5944 | STAT_0X5944_WERT | Gespeicherter Offsetkorrekturwert für Y (Beta) | ° | GbxPos_agYPosOffsEepRd | - | signed long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5945_WERT | 0x5945 | STAT_0X5945_WERT | Anzahl VVT Notlauf bis Tausch | - | anznlvvtaust_eep | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5946_WERT | 0x5946 | STAT_0X5946_WERT | Anzahl VVT Notlauf | - | anzvvtnlanfh_eep | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5955_WERT | 0x5955 | STAT_0X5955_WERT | Spannung hinter Zünd- Einspritzrelais | V | ubinj | - | unsigned char | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x595E_WERT | 0x595E | STAT_0X595E_WERT | Massenstrom HFM Bank 2 | kg/h | mshfm2_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x595F_WERT | 0x595F | STAT_0X595F_WERT | Peridendauer für Massenstrom aus HFM Bank 2 | µs | tpmshfm2_w | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5961_WERT | 0x5961 | STAT_0X5961_WERT | Förderdauer MSV in Grad KW | ° KW | dwmsvd_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5962_WERT | 0x5962 | STAT_0X5962_WERT | Mengensteuerventil Ansteuerung aktiv | 0/1 | B_msvact | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x5965_WERT | 0x5965 | STAT_0X5965_WERT | Istwert (word) Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT | Ohm | HEGO_resS2B1Ri | - | unsigned int | - | 2.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5966_WERT | 0x5966 | STAT_0X5966_WERT | Istwert (word) Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT Bank2 | Ohm | HEGO_resS2B2Ri | - | unsigned int | - | 2.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5967_WERT | 0x5967 | STAT_0X5967_WERT | normierte Heizleistung der Lambdasonde hinter Kat | - | HEGO_pwrS2B1Htg | - | unsigned char | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5968_WERT | 0x5968 | STAT_0X5968_WERT | normierte Heizleistung Lamdasonde hinter Kat Bank 2 | - | HEGO_pwrS2B2Htg | - | unsigned char | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5969_WERT | 0x5969 | STAT_0X5969_WERT | Sauerstoffspeichervermögen KAT | - | TWCD_rOSCAvrgPriB1 | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596A_WERT | 0x596A | STAT_0X596A_WERT | Sauerstoffspeichervermögen KAT Bank2 | - | TWCD_rOSCAvrgPriB2 | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596B_WERT | 0x596B | STAT_0X596B_WERT | Transition Time O2Sensor Rich2Lean (Sensor2) Bank 1 | s | EGSDU_tiS2B1RtlTranEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596C_WERT | 0x596C | STAT_0X596C_WERT | Transition Time O2Sensor Lean2Rich (Sensor2) | s | EGSDU_tiS2B1LtrTranEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596D_WERT | 0x596D | STAT_0X596D_WERT | Transition Time O2Sensor Rich2Lean (Sensor2) Bank 2 | s | EGSDU_tiS2B2RtlTranEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596E_WERT | 0x596E | STAT_0X596E_WERT | Transition Time O2Sensor Lean2Rich (Sensor2) | s | EGSDU_tiS2B2LtrTranEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x596F_WERT | 0x596F | STAT_0X596F_WERT | gemessene delay time R2L (fett-mager-Sprung) | s | EGSDO2_tiDlyRtlS1B1 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5970_WERT | 0x5970 | STAT_0X5970_WERT | gemessene delay time L2R (mager-fett-Sprung) | s | EGSDO2_tiDlyLtrS1B1 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5971_WERT | 0x5971 | STAT_0X5971_WERT | gemessene delay time R2L (fett-mager-Sprung) Bank2 | s | EGSDO2_tiDlyRtlS1B2 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5972_WERT | 0x5972 | STAT_0X5972_WERT | gemessene delay time L2R (mager-fett-Sprung) Bank2 | s | EGSDO2_tiDlyLtrS1B2 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5973_WERT | 0x5973 | STAT_0X5973_WERT | Delta Sondenoffset Führungsregelung | s | EGSDO2_tiTranRtlS1B1 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5974_WERT | 0x5974 | STAT_0X5974_WERT | gemessene transition time L2R (mager-fett-Sprung) | s | EGSDO2_tiTranLtrS1B1 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5975_WERT | 0x5975 | STAT_0X5975_WERT | gemessene trandition time R2L (fett-mager-Sprung) Bank2 | s | EGSDO2_tiTranRtlS1B2 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5976_WERT | 0x5976 | STAT_0X5976_WERT | gemessene transition time L2R (mager-fett-Sprung) Bank2 | s | EGSDO2_tiTranLtrS1B2 | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5977_WERT | 0x5977 | STAT_0X5977_WERT | gemessene delay time R2L (fett-mager-Sprung) | s | EGSDU_tiS2B1RtlDlyEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5978_WERT | 0x5978 | STAT_0X5978_WERT | gemessene delay time L2R (mager-fett-Sprung) | s | EGSDU_tiS2B1LtrDlyEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5979_WERT | 0x5979 | STAT_0X5979_WERT | gemessene delay time R2L (fett-mager-Sprung) Bank2 | s | EGSDU_tiS2B2RtlDlyEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x597A_WERT | 0x597A | STAT_0X597A_WERT | gemessene delay time L2R (mager-fett-Sprung) Bank2 | s | EGSDU_tiS2B2LtrDlyEvln | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x597B_WERT | 0x597B | STAT_0X597B_WERT | Delta Sondenoffset Führungsregelung | - | EGSDO2_ratLamOffsS1B1 | - | signed int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x597C_WERT | 0x597C | STAT_0X597C_WERT | Delta Sondenoffset Führungsregelung Bank2 | - | EGSDO2_ratLamOffsS1B2 | - | signed int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x597D_WERT | 0x597D | STAT_0X597D_WERT | Abgasmasse | kg/h | EGSDCmn_mfEgCat1B1Parl | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x598B_WERT | 0x598B | STAT_0X598B_WERT | gesamte Kraftstoffadaption (Füllung+Gemisch) Bank1 | % | SwSABMW_TotFlAdap1 | - | signed int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x598C_WERT | 0x598C | STAT_0X598C_WERT | gesamte Kraftstoffadaption (Füllung+Gemisch) Bank2 | % | SwSABMW_TotFlAdap2 | - | signed int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x598F_WERT | 0x598F | STAT_0X598F_WERT | Massenstrom vom HFM 1 | kg/h | mshfm1_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x59BE_WERT | 0x59BE | STAT_0X59BE_WERT | [1] Auslass-NW Winkelversatz Feinadaption | ° KW | EpmCaS_phiCaSOfsAvg | - | signed long | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x59C1_WERT | 0x59C1 | STAT_0X59C1_WERT | Korrigierte Segmentdauer | - | EpmCrS_stSigDiagSrc | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x59CA_WERT | 0x59CA | STAT_0X59CA_WERT | Fehlerstatus KW-Signal | - | MoF_rTrqPT1Flt | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x59CB_WERT | 0x59CB | STAT_0X59CB_WERT | Triebstrangübersetzungsverhaeltnis gefiltert in der Funktionsueberwachung | - | uevges_w | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
...
### T_1BYTE_FS_OPF_ERW_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Keine Service Regeneration moeglich |
| 1 | Service Regeneration kann gestartet werden |
| 5 | Service Regeneration laeuft gerade, hat aber noch keine Erlaubnis bekommen eine aktive Regeneration zu starten |
| 10 | Partikelfilter aufheizen |
| 15 | Druckabfallmessung am Filter vor Regeneration |
| 20 | Russabbrand |
| 25 | Druckabfallmessung am Filter nach Regeneration |
| 30 | Warten auf Ende Russabbrand |
| 255 | ungueltig |
| 3 | Motor Vorbereitungsphase vor Regenerationsstart. |
...
### T_1BYTE_OPF_REG_FS_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Keine Serviceregeneration angefordert |
| 1 | Serviceregeneration laeuft |
| 2 | Serviceregeneration wurde komplett durchgefuehrt |
| 3 | Serviceregeneration wurde abgebrochen |
| 4 | Serviceregeneration wurde komplett durchgefuehrt und reduzierte Russbeladung bestaetigt |
| 255 | ungueltig |
...
### T_1BYTE_TEXT_FUSI_A5_DOP

| WERT | TEXT |
| --- | --- |
| 165 | 165 |

### T_2BYTE_FS_WASSER_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Funktion noch nicht gestartet |
| 8 | Funktion wartet auf Freigabe |
| 16 | Funktion laeuft |
| 24 | Funktion wartet auf Freigabe Ansteuerung momentan nicht möglich |
| 32 | Funktion vollstaendig durchlaufen und kein Fehler erkannt |
| 48 | Funktion vollständig durchlaufen kein Fehler erkannt |
| 64 | Funktion vollständig durchlaufen Fehler erkannt |
| 72 | Funktion vollständig durchlaufen Fehler erkannt |
| 80 | Funktion vollständig durchlaufen Fehler erkannt |
| 65535 | ungueltiger Wert |

### T_2BYTE_TEXT_OPF_GRUND_HIGH_DOP

| WERT | TEXT |
| --- | --- |
| 1 | Die Service Regeneration ist nicht freigegeben durch die Applikation |
| 2 | Der Motor laeuft nicht |
| 4 | Regeneration des Partikelfilter laeuft gerade |
| 16 | Ein Gang ist eingelegt |
| 32 | Das Fahrpedal ist betaetigt |
| 64 | Die Bremse ist betaetigt |
| 128 | Das Fahrzeug bewegt sich |
| 2048 | Die Motorhaube ist nicht offen |
| 4096 | Ein Systemfehler wurde erkannt |
| 8192 | Eine hoeherpriore Lambda-Anforderung unterbricht die Regeneration |
| 16384 | Wenn die Service Regeneration zu lang dauert, wird sie unterbrochen und fuer die Dauer PFltSrv_tiIntrptRgnLockd_C gesperrt |
| 32768 | Eine Abgaskomponente ist zu heiß |
| 65535 | Ungueltig |

### T_2BYTE_TEXT_OPF_GRUND_LOW_DOP

| WERT | TEXT |
| --- | --- |
| 1024 | Immer false |
| 2048 | Der Partikelfilter ist zu heiß |
| 32768 | Eine externer Befehl zum Stoppen der Service Regeneration wurde empfangen |
| 65535 | Ungueltig |

### T_2BYTE_WASSER_AKTIV

| WERT | TEXT |
| --- | --- |
| 0 | keine Anforderung |
| 1 | Anforderung Wasserpumpe |
| 2 | Ansteuerung Rückspülventil |
| 3 | Druckaufbauprüfung |
| 4 | System entleeren |
| 5 | Druckhalteprüfung |
| 6 | Injektortest |
...
### T_B_1BYTE_LESEN_GANGSENSOR_0_1
...
### T_B_STANDARD_1BYTE_LESEN_GANGSENSOR_0_1
...
### T_GBXPOS_NUMLVRPOS_TEXT_DOP

| WERT | TEXT |
| --- | --- |
| 1 | Gang 1 Synchronisiert |
| 2 | Gang 2 Synchronisiert |
| 3 | Neutral 12 |
| 4 | Gang 3 Synchronisiert |
| 8 | Gang 4 Synchronisiert |
| 12 | Neutral 34 |
| 16 | Gang 5 Synchronisiert |
| 32 | Gang 6 Synchronisiert |
| 48 | Neutral 56 |
| 64 | Rueckwaertsgang Synchronisiert |
| 65 | Neutral Rueckwaerts |
| 129 | Gang 1 |
| 130 | Gang 2 |
| 132 | Gang 3 |
| 136 | Gang 4 |
...
### T_GBXPOS_NUMLVRPOS_TEXT_GANGSENSOR_DOP
