...
| Revision | 11.004 |
| Author | P-+-Z-ENGINEERING-GMBH EA-362 Hadersdorfer |
| ECU Comment | SGBD für MEVD172Y C-Muster zur SW 75B28D0B, 75Hxxx, 75Pxxx, 75Qxxx, 75Ixxx |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Motorelektronik MEVD17.2 / MEVD17.2.6 / MEVD17.2.G für N55 6 Zylinder MSA/Hybrid im BN2020 |  |  |
| ORIGIN | string | BMW EA-360 Markus_Lorch |  |  |
| REVISION | string | 11.004 |  |  |
| AUTHOR | string | P-+-Z-ENGINEERING-GMBH EA-362 Hadersdorfer |  |  |
| COMMENT | string | SGBD für MEVD172Y C-Muster zur SW 75B28D0B, 75Hxxx, 75Pxxx, 75Qxxx, 75Ixxx |  |  |
| PACKAGE | string | 1.76 |  |  |
...
Selektive Blockierung der Einschaltaufforderer MSA2 (Motor Start/Stopp Automatik) auslesen Die Umsetzung ist ausschliesslich fuer Entwicklung gedacht. _STATUS_MSA2_DEAK_EA (0x22 5FDD)
...
Selektive Blockierung der Einschaltverhinderer MSA2 (Motor Start/Stopp Automatik) auslesen Die Umsetzung ist ausschliesslich fuer Entwicklung gedacht. _STATUS_MSA2_DEAK_EV (0x22 5FE5)
...
Selektive Blockierung der Fahrerabschaltverhinderer MSA2 (Motor Start/Stopp Automatik) auslesen. Die Umsetzung ist ausschliesslich fuer Entwicklung gedacht. _STATUS_MSA2_DEAK_FAV (0x22 5FDF)
...
Selektieve Blockierung der Deaktivierer aufgrund FSP-Eintraegen MSA2 (Motor Start/Stopp Automatik) auslesen Die Umsetzung ist ausschliesslich fuer Entwicklung gedacht. _STATUS_MSA2_DEAK_DFSP (0x22 5FDC)
...
### STATUS_KRFTSTFFVRBRCH_MODIS_HIST

Kraftstoffverbrauchstatistiken bei unterschiedlichen Fahrerlebnismodis (Eco, Normal-Komfort, Sport, und Gesamt) ueber FASTA und TSR auslesen/uebermitteln. (FASTA,TSR). KRFTSTFFVRBRCH_MODIS_HIST (0x22 4095)
...
PT-Sensor lesen PTSENSOR (0x22 4085)
...
### STATUS_DEGRADATIONZUSTART

Betriebsstundenzaehler fuer Zustartdegradation auslesen DEGRADATIONZUSTART (0x22 4083)
...
Selektive Blockierung der Deaktivierer MSA2 (Motor Start/Stopp Automatik) auslesen Die Umsetzung ist ausschliesslich fuer Entwicklung gedacht. _STATUS_MSA2_DEAK_DEAKT (0x22 5FDB)

_No arguments._

### STATUS_ASW_NVLD3_PVENTIL

Ansteuerwert vom Tester zur Ansteuerung des NVLD3-Poppetventil auslesen ASW_NVLD3_PVENTIL (0x22 630F)

_No arguments._

### STATUS_ASG_NVLD3_PVENTIL

Ausgangsstellgroesse zur Ansteuerung des NVLD3-Poppetventil auslesen ASG_NVLD3_PVENTIL (0x22 650F)
...
Generatordaten ruecksetzen Beim Aufruf dieses Services wird das Bit BasSvrAppl_flgRstIsgStcActvd (BMW: B_isgtst_datenreset) fuer 1 Sekunde auf 1 gesetzt. GENDATENRESET (0x2E 5F71)
...
MSA2 (MotorStopAutomatik) deaktivieren Vorgeben beenden Fa-a2l-Name: B_msasw_nv, B_msasw STEUERN_ENDE_MSA2_DEAK (0x2E 5F8E)
...
Elektrische Wastegate Ansteuerung EWG (0x2F 03 6078)
...
Ansteuerung der zusaetzlichen elektrischen Wasserpumpe EWP Racetrack (ZEWP) beenden. EWP_RACETRACK (0x2F 00 60FA)
...
Ansteuerung der zusaetzlichen elektrischen Wasserpumpe EWP Racetrack (ZEWP). AWPECU_ACTV_SY > 0 && LAYER_EWP7_SY > 0 && B_ewp7_verbaut ==TRUE B_ewp7_verbaut, ansonsten wird mit neg. Resp. 0x12 (Sub Function Not Supported) geantwortet. Ansteuerungskonditionen: tmot_w < 90°C. EWP_RACETRACK (0x2F 03 60FA)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_ANST_EWP_RACET | unsigned char | Drehzahl zusaetzliche elektrischen Wasserpumpe EWP Racetrack (ZEWP). Einheit: 1/min Min: 0.0 Max: 250.0 |
| SW_TO_ANST_EWP_RACET | unsigned long | Timeout zusaetzliche elektrischen Wasserpumpe EWP Racetrack (ZEWP). Einheit: s Min: 0.0 Max: 510.0 |
...
Elektrische Wastegate Ansteuerung beenden EWG (0x2F 00 6078)
...
Kurbelgehaeuseentlueftungsheizung ansteuern. Startvoraussetzung: B_kl15 == TRUE. KGEH (0x2F 03 60AD)
...
Tankabsperrventil manuell steuern-Ende. TAV (0x2F 00 606B)
...
Diagnosemodul-Tank Leckage Heizung Ansteuerung beenden START-CONDITION: 00 DMTL_HEIZUNG (0x2F 00 60CE)
...
Kurbelgehaeuseentlueftungsheizung ansteuern beenden. KGEH (0x2F 00 60AD)
...
Diagnosemodul-Tank Leckage Pumpe Ansteuerung beenden START-CONDITION: 00 DMTL_P (0x2F 00 60CC)
...
Tankabsperrventil manuell ansteuern. Beim Ausfuehren dieses Testerjobs muss das Bit B_ftivopen gesetzt werden. TAV (0x2F 03 606B)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_TAV_STEUERN | unsigned char | Tastverhaeltniss TAV ansteuern. Min: 0.0 Max: 1.0 a2l-Name: BasSvrAppl_stCtlTankBlkVlv |
| SW_TO_TAV_STEUERN | unsigned long | Timeout TAV ansteuern. Einheit: s Min: 0.0 Max: 510.0 |
...
Diagnosemodul-Tank Leckage Ventil Ansteuerung beenden START-CONDITION: 00 DMTL_V (0x2F 00 60CD)
...
### STEUERN_NVLD3_PVENTIL

NVLD3-Poppetventil - Ansteuerung starten und beenden Ansteuerbedinungen: Kl15 ein ATS-ID: offen PIN:149 NVLD3_PVENTIL (0x2F 03 610F)

| Name | Type | Description |
| --- | --- | --- |
| SW_PVENTIL | unsigned int | Sollwert des Poppetventils Min: 0.0 Max: 1.0 |

### STEUERN_ENDE_NVLD3_PVENTIL

NVLD3-Poppetventils - Ansteuerung starten und beenden NVLD3_PVENTIL (0x2F 00 610F)
...
Diagnosefunktion elektrisches Wastegate lesen. Voraussetzung: B_ewg == true, SY_WGPS > 0 SYSTEMCHECK_EWG (0x31 03 F045)
...
Diagnosefunktion elektrisches Wastegate beenden SYSTEMCHECK_EWG (0x31 02 F045)
...
Diagnosefunktion elektrisches Wastegate starten. Voraussetzung: B_nmot == false && B_kl15 == true && B_ewg == true, SY_WGPS > 0 SYSTEMCHECK_EWG (0x31 01 F045)
...
| Name | Type | Description |
| --- | --- | --- |
| ADAV2_AUSWAHLBYTE_1 | unsigned char | ADAV2_AUSWAHLBYTE_1_BIT_7 -- > Kleinstmengenadaption BasSvrAppl_stInjCod ADAV2_AUSWAHLBYTE_1_BIT_6 --> Variante Abgasklappe loeschen (DAKRE_StRstFlpTyp), BasSvrAppl_stVarEgFlapClr ADAV2_AUSWAHLBYTE_1_BIT_5 --> Zaehler VVT Notlauf loeschen (BasSvrAppl_stRmCntVvtLimp) ADAV2_AUSWAHLBYTE_1_BIT_4 --> Neustart der Hinterachslernfunktion (B_hal_reset_adaptionen (Bit 0 von St_hal_diag_adaptionen)). ADAV2_AUSWAHLBYTE_1_BIT_3 --> Adaption elektrische Kraftstoffpumpe ADAV2_AUSWAHLBYTE_1_BIT_2 --> NOT USED ADAV2_AUSWAHLBYTE_1_BIT_1 --> Adaption Langzeit fuer Injektoralterung Bank 1 klann_lza_clrad() ADAV2_AUSWAHLBYTE_1_BIT_0 --> Adaption Nullgangsensor (Achtung: Mit diesem Bit darf die Adaption des Nullgangsensors nicht mehr geloescht werden! Bei Austausch des Nullgangsensors soll die Adaption mit dem dafuer vorgesehenen Dienst durchgefuehrt werden)(NOT USED) Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: - Bit 0x02: - Bit 0x04: - Bit 0x08: - Bit 0x10: BasSvrAppl_flgRstRrAxlAdpn Bit 0x20: BasSvrAppl_stRmCntVvtLimp Bit 0x40: BasSvrAppl_stVarEgFlapClr Bit 0x80: BasSvrAppl_stInjCod |
| ADAV2_AUSWAHLBYTE_2 | unsigned char | ADAV2_AUSWAHLBYTE_2_BIT_7 --> NOT USED ADAV2_AUSWAHLBYTE_2_BIT_6 --> Verlustmomentadaption Reset ADAV2_AUSWAHLBYTE_2_BIT_5 --> NOT USED ADAV2_AUSWAHLBYTE_2_BIT_4 --> Bereichserkennung Benzin im Oel (B_clradbo) ADAV2_AUSWAHLBYTE_2_BIT_3 --> Zaehler fuer Startabbrueche loeschen (BasSvrAppl_stRstCntrDetdFaildStrtEng) ADAV2_AUSWAHLBYTE_2_BIT_2 --> NOT USED ADAV2_AUSWAHLBYTE_2_BIT_1 --> Kraftstoffqualitaetserfassung Reset (B_clradfuel) ADAV2_AUSWAHLBYTE_2_BIT_0 --> Infospeicher Superklopffunktion loeschen (BasSvrAppl_stTstrTrg1_RC_B_SKRKO) Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: BasSvrAppl_stTstrTrg1_RC_B_SKRKO Bit 0x02: B_clradfuel Bit 0x04: - Bit 0x08: BasSvrAppl_stRstCntrDetdFaildStrtEng Bit 0x10: B_clradbbo Bit 0x20: - Bit 0x40: - Bit 0x80: - |
| ADAV2_AUSWAHLBYTE_3 | unsigned char | ADAV2_AUSWAHLBYTE_3_BIT_7 --> Zuruecksetzen der Hubkorrekturstatistik per Tester: B_vbrstatresetext ADAV2_AUSWAHLBYTE_3_BIT_6 --> Anforderung Nockenwellen Referenzadaption durch Tester (Kurbelwelle-Nockenwellenzuordnung). Der Neustart der Adaptation sollte immer nach Arbeit in der Umgebung der Nocken- oder Kurbelwelle ausgefuehrt werden. B_fanwrad ADAV2_AUSWAHLBYTE_3_BIT_5 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_4 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_3 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_2 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_1 --> NOT USED ADAV2_AUSWAHLBYTE_3_BIT_0 --> NOT USED Min: 0.0 Max: 255.0 a2l-Name: Bit 0x01: - Bit 0x02: - Bit 0x04: - Bit 0x08: - Bit 0x10: - Bit 0x20: - Bit 0x40: B_fanwrad Bit 0x80: B_vbrstatresetext |
...
Ansteuerung fuer den Abgleich des Drucksensors im Tank mit Umgebungdrucksensor in der DME. PTABGLEICH (0x31 01 F04F)

_No arguments._

### STATUS_PTABGLEICH

Drucksensor im Tank mit Umgebungdrucksensor in der DME abgleichen lesen. PTABGLEICH (0x31 03 F04F)
...
| 0x104320 | Absolutdrucksensor, Saugrohr, Arbeitsbereich: Druck zu hoch | 0 |
| 0x104321 | Absolutdrucksensor, Saugrohr, Arbeitsbereich: Druck zu niedrig | 0 |
...
| 0x104612 | Absolutdrucksensor, Saugrohr, Plausibilität: Saugrohrdruck unplausibel in Korrelation zu Abgasmassenstrom | 0 |
...
| 0x110103 | Injektor Zylinder 1, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110104 | Injektor Zylinder 1, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110105 | Injektor Zylinder 1, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x110203 | Injektor Zylinder 2, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110204 | Injektor Zylinder 2, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110205 | Injektor Zylinder 2, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x110303 | Injektor Zylinder 3, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110304 | Injektor Zylinder 3, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110305 | Injektor Zylinder 3, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x110403 | Injektor Zylinder 4, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110404 | Injektor Zylinder 4, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110405 | Injektor Zylinder 4, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x110503 | Injektor Zylinder 5, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110504 | Injektor Zylinder 5, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110505 | Injektor Zylinder 5, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x110603 | Injektor Zylinder 6, Ansteuerung: Hochspannungsseite, Kurzschluss | 0 |
| 0x110604 | Injektor Zylinder 6, Ansteuerung: Hochspannungsseite; Kurzschluss nach Plus | 0 |
| 0x110605 | Injektor Zylinder 6, Ansteuerung: Niederspannungsseite, Kurzschluss | 0 |
...
| 0x112604 | Injektor Zylinder 6, Ansteuerung: Kurzschluss Hochspannungsseite nach Niederspannungsseite | 0 |
...
| 0x114301 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 3: Gemisch zu mager | 0 |
| 0x114302 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 3: Gemisch zu fett | 0 |
| 0x114401 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 4: Gemisch zu mager | 0 |
| 0x114402 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 4: Gemisch zu fett | 0 |
...
| 0x114601 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 6: Gemisch zu mager | 0 |
| 0x114602 | Zylinderindividuelle Gemischüberwachung über Laufunruhe, Zylinder 6: Gemisch zu fett | 0 |
...
| 0x118F01 | Gemischadaption 2, Leerlauf: Gemisch zu mager | 0 |
| 0x118F02 | Gemischadaption 2, Leerlauf: Gemisch zu fett | 0 |
...
| 0x119302 | Raildrucksensor, Spannungsprüfung: untere Schwelle unterschritten | 0 |
...
| 0x11AA03 | Kraftstoffhochdrucksystem: Hochdruckpumpe, Druck zu niedrig | 0 |
| 0x11AA04 | Kraftstoffhochdruck: Druck kurzzeitig zu hoch, Drehzahl- und Lastbegrenzung | 0 |
| 0x11AA05 | Kraftstoffhochdrucksystem: Hochdruckpumpe 2, Druck zu niedrig | 0 |
...
| 0x11C303 | Mengensteuerventil 2, Ansteuerung: Leitungsunterbrechung | 0 |
...
| 0x11C405 | Mengensteuerventil, Ansteuerung, Hochspannungsseite: Kurzschluss | 0 |
| 0x11C406 | Mengensteuerventil, Ansteuerung: Kurzschluss Hochspannungsseite nach Niederspannungsseite | 0 |
| 0x11C407 | Mengensteuerventil, Ansteuerung, Niederspannungsseite: Kurzschluss | 0 |
| 0x11C408 | Mengensteuerventil 2, Ansteuerung, Hochspannungsseite: Kurzschluss | 0 |
| 0x11C409 | Mengensteuerventil 2, Ansteuerung: Kurzschluss Hochspannungsseite nach Niederspannungsseite | 0 |
| 0x11C40A | Mengensteuerventil 2, Ansteuerung, Niederspannungsseite: Kurzschluss | 0 |
...
| 0x123401 | Elektrisches Wastegate, Anschlag-Lernen, Kaltstart: Fehlfunktion | 0 |
| 0x123411 | Elektrisches Wastegate, Anschlag-Lernen: Anschlagposition (Wastegate offen) nicht gefunden | 0 |
| 0x123412 | Elektrisches Wastegate, Anschlag-Lernen: Anschlagposition (Wastegate geschlossen) nicht gefunden | 0 |
| 0x123421 | Elektrisches Wastegate, Anschlag-Lernen: Startposition (Wastegate offen) nicht gefunden | 0 |
| 0x123422 | Elektrisches Wastegate, Anschlag-Lernen: Startposition (Wastegate geschlossen) nicht gefunden | 0 |
| 0x123431 | Elektrisches Wastegate, Anschlag-Lernen: Anschlagposition (Wastegate offen) außerhalb Toleranz | 0 |
| 0x123432 | Elektrisches Wastegate, Anschlag-Lernen: Anschlagposition (Wastegate geschlossen) außerhalb Toleranz | 0 |
| 0x123433 | Elektrisches Wastegate, Anschlag-Lernen: Verstellbereich außerhalb Toleranz | 0 |
| 0x123511 | Elektrisches Wastegate, Wastegate-Klappe: schwergängig | 0 |
| 0x123512 | Elektrisches Wastegate, Wastegate-Klappe, Kaltstart: schwergängig | 0 |
| 0x123513 | Elektrisches Wastegate, Positionssensor, Versorgungsspannung, Plausibilität: Spannung unplausibel | 0 |
| 0x123516 | Elektrisches Wastegate, Ansteuerung: Leitungsunterbrechung | 0 |
| 0x123519 | Pneumatisches Wastegate 1, Ansteuerleitung: Ausgang 1, Kurzschluss nach Plus | 0 |
| 0x12351A | Pneumatisches Wastegate 2, Ansteuerleitung: Ausgang 1, Kurzschluss nach Plus | 0 |
| 0x12351B | Pneumatisches Wastegate 1, Ansteuerleitung: Ausgang 2, Kurzschluss nach Plus | 0 |
| 0x12351C | Pneumatisches Wastegate 2, Ansteuerleitung: Ausgang 2, Kurzschluss nach Plus | 0 |
| 0x12351D | Pneumatisches Wastegate 1, Ansteuerleitung: Ausgang 1, Kurzschluss nach Masse | 0 |
| 0x12351E | Pneumatisches Wastegate 2, Ansteuerleitung: Ausgang 1, Kurzschluss nach Masse | 0 |
| 0x12351F | Pneumatisches Wastegate 1, Ansteuerleitung: Ausgang 2, Kurzschluss nach Masse | 0 |
| 0x123520 | Pneumatisches Wastegate 2, Ansteuerleitung: Ausgang 2, Kurzschluss nach Masse | 0 |
| 0x123521 | Pneumatisches Wastegate 1, Ansteuerleitung: Kurzschluss | 0 |
| 0x123522 | Pneumatisches Wastegate 2, Ansteuerleitung: Kurzschluss | 0 |
| 0x123523 | Pneumatisches Wastegate 1, Ansteuerleitung: offen | 0 |
| 0x123524 | Pneumatisches Wastegate 2, Ansteuerleitung: offen | 0 |
| 0x123601 | Elektrisches Wastegate, Ansteuerung: Kurzschluss | 0 |
| 0x123602 | Elektrisches Wastegate, Endstufe: Temperatur zu hoch | 0 |
| 0x123608 | DME, interner Fehler, Elektrisches Wastegate: SPI-Kommunikation fehlerhaft | 0 |
| 0x123701 | Elektrisches Wastegate, Positionssensor, elektrisch: Kurzschluss nach Plus | 0 |
| 0x123702 | Elektrisches Wastegate, Positionssensor, elektrisch: Kurzschluss nach Masse | 0 |
...
| 0x128712 | Lambdasonde vor Katalysator 2, Heizereinkopplung: Kurzschluss Signalleitung mit Heizleitung | 0 |
...
| 0x129801 | Lambdasonde nach Katalysator, Dynamik, von Fett nach Mager: langsame Reaktion | 0 |
...
| 0x129A30 | DME, interner Fehler, Lambdasonde vor Katalysator 2: Lambdasondenbaustein, Signalkreisadaptionswerte zu hoch | 0 |
| 0x129A31 | DME, interner Fehler, Lambdasonde vor Katalysator 2: Lambdasondenbaustein, Unterspannung | 0 |
| 0x12A001 | Lambdasonde vor Katalysator 2, Dynamik: langsame Reaktion | 0 |
| 0x12A008 | Lambdasonden nach Katalysator, Montage: vertauscht | 0 |
| 0x12A009 | Lambdasonden nach Katalysator 2, Montage: vertauscht | 0 |
...
| 0x12BD71 | Lambdasonde vor Katalysator 2, elektrisch: Nernstzellenwiderstand oder Keramiktemperatur unplausibel, Leitungs- oder Heizungsfehler | 0 |
...
| 0x138101 | Abgasklappensteller, Signalleitung: Kurzschluss nach Plus | 0 |
| 0x138102 | Abgasklappensteller, Signalleitung: Kurzschluss nach Masse | 0 |
| 0x138104 | Abgasklappensteller, Signalleitung: offen | 0 |
...
| 0x138A11 | Abgasklappe, Abgasklappensteller, mechanisch: Blockade oder Schwergängigkeit | 0 |
| 0x138A12 | Abgasklappe: keine Rückmeldung | 0 |
...
| 0x150C16 | Zündung, Zylinder 6: Brenndauer außerhalb Toleranz | 0 |
...
| 0x152618 | Superklopfen Zylinder 6: dauerhafte Einspritzabschaltung | 0 |
...
| 0x160501 | Kurbelgehäuseentlüftungsheizung, Ansteuerung: Kurzschluss nach Plus | 0 |
| 0x160502 | Kurbelgehäuseentlüftungsheizung, Ansteuerung: Kurzschluss nach Masse | 0 |
| 0x160504 | Kurbelgehäuseentlüftungsheizung, Ansteuerung: Leitungsunterbrechung | 0 |
...
| 0x165011 | Zwischenwellensensor (Hochdruckpumpe), Signal: fehlt, Ersatzwert aktiv | 0 |
| 0x165012 | Zwischenwellensensor (Hochdruckpumpe), Plausibilität, Signalflanken: Anzahl unplausibel, Ersatzwert aktiv | 0 |
| 0x165013 | Zwischenwellensensor (Hochdruckpumpe), Plausibilität: Signale unplausibel, Ersatzwert nicht aktiv | 0 |
| 0x165014 | Zwischenwellensensor (Hochdruckpumpe), Plausibilität, Signalflanken: Lage unplausibel, Ersatzwert aktiv | 0 |
| 0x165015 | Zwischenwelle (Hochdruckpumpe) - Kurbelwelle, Synchronisation: Fehlfunktion | 0 |
...
| 0x191A90 | Tankabsperrventil, Ansteuerung: Kurzschluss nach Plus | 0 |
| 0x191A91 | Tankabsperrventil, Ansteuerung: Kurzschluss nach Masse | 0 |
| 0x191A92 | Tankabsperrventil, Ansteuerung: Leitungsunterbrechung | 0 |
| 0x191A93 | Tankabsperrventil: klemmt offen | 0 |
| 0x191A94 | Tankabsperrventil: klemmt geschlossen | 0 |
...
| 0x193011 | Tankfüllstandssensor, rechts, Signal: Kurzschluss nach Plus | 0 |
...
| 0x193111 | Tankfüllstandssensor, links, Signal: Kurzschluss nach Plus | 0 |
| 0x193120 | Kraftstoff-Füllstandsgeber, links, Plausibilität: Tankfüllstandssignal zu hoch | 0 |
| 0x193121 | Tankfüllstandssensor, rechts, Signal: Tankfüllstandsignal unplausibel zu hoch | 0 |
...
| 0x194008 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur zu niedrig | 0 |
| 0x194009 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur zu hoch | 0 |
| 0x194010 | Kraftstofftank-Druck-Temperatursensor, Kommunikation Temperatursignal: gestört | 0 |
| 0x194011 | Kraftstofftank-Druck-Temperatursensor, elektrisch: Kurzschluss nach Plus | 0 |
| 0x194012 | Kraftstofftank-Druck-Temperatursensor, elektrisch: Kurzschluss nach Masse | 0 |
| 0x194013 | Kraftstofftank-Druck-Temperatursensor, elektrisch: Leitungsunterbrechung | 0 |
| 0x194014 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur langfristig zu niedrig | 0 |
| 0x194015 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur langfristig zu hoch | 0 |
| 0x194016 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur kurzfristig zu niedrig | 0 |
| 0x194017 | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Temperatur kurzfristig zu hoch | 0 |
| 0x194018 | Kraftstofftank-Druck-Temperatursensor, Kompatibilität: Hardware nicht plausibel | 0 |
| 0x194019 | Kraftstofftank-Druck-Temperatursensor, Kompatibilität: Software nicht plausibel | 0 |
| 0x19401A | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Druck zu hoch gegenüber Umgebungsdruck | 0 |
| 0x19401B | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Druck zu niedrig gegenüber Umgebungsdruck | 0 |
| 0x19401C | Kraftstofftank-Druck-Temperatursensor, Drucksignal: festliegend | 0 |
| 0x19401D | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Druck zu hoch | 0 |
| 0x19401E | Kraftstofftank-Druck-Temperatursensor, Plausibilität: Druck zu niedrig | 0 |
| 0x19401F | Kraftstofftank-Druck-Temperatursensor, Arbeitsbereich: Druck zu hoch | 0 |
| 0x194020 | Kraftstofftank-Druck-Temperatursensor, Arbeitsbereich: Druck zu niedrig | 0 |
| 0x194021 | Kraftstofftank-Druck-Temperatursensor, Kommunikation: gestört | 0 |
| 0x194027 | Kraftstofftank-Druck-Temperatursensor, Arbeitsbereich: Temperatur zu hoch | 0 |
...
| 0x195001 | Differenzdrucksensor, Tankentlüftungsventil, elektrisch: Kurzschluss nach Plus | 0 |
| 0x195002 | Differenzdrucksensor, Tankentlüftungsventil, elektrisch: Kurzschluss nach Masse | 0 |
| 0x195013 | Differenzdrucksensor, Tankentlüftungsventil, Arbeitsbereich: Absolutdruck zu niedrig | 0 |
| 0x195014 | Differenzdrucksensor, Tankentlüftungsventil, Signal: festliegend | 0 |
...
| 0x1B2305 | FlexRay, Botschaft (Status Stabilisierung DSC 2, 47.1.2): fehlt | 0 |
...
| 0x1B7101 | Bremsunterdrucksensor, Plausibilität: Druckdifferenz unplausibel | 0 |
...
| 0x1BC118 | Gangsensor, Lernwerte: unplausibel oder Speichern fehlgeschlagen | 0 |
| 0x1BC119 | Gangsensor: Schalthebelpositon ungültig | 0 |
| 0x1BC120 | Gangsensor, elektrisch: Kurzschluss nach Plus | 0 |
| 0x1BC121 | Gangsensor, elektrisch: Kurzschluss nach Masse | 0 |
| 0x1BC122 | Gangsensor, Signal: ungültig | 0 |
| 0x1BC123 | Gangsensor, Signal: außerhalb Synchronization | 0 |
| 0x1BC124 | Gangsensor, Signal: fehlt | 0 |
...
| 0x1C4121 | Ölzustandssensor, Plausibilität: Signal unplausibel | 0 |
| 0x1C4122 | Ölzustandssensor, Plausibilität: Signal Fehlfunktion | 0 |
...
| 0x1F052A | DME, interner Fehler, Sicherheitsfunktion: Moment Drehzahlregler | 0 |
...
| 0x1F0538 | DME, interner Fehler, Sicherheitsfunktion: maximales Gesamtmoment überschritten | 1 |
| 0x1F0539 | DME, interner Fehler, Sicherheitsfunktion: minimales Gesamtmoment unterschritten | 1 |
| 0x1F053A | DME, interner Fehler, Sicherheitsfunktion: Trennkupplungsmoment zu Trägheitsmoment unplausibel | 0 |
...
| 0x1F0907 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 1: Übertemperatur Stufe 2 erkannt] | 0 |
| 0x1F0908 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 2: Übertemperatur Stufe 2 erkannt] | 0 |
| 0x1F0909 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 1: Überstrom erkannt] | 0 |
| 0x1F0910 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 2: Überstrom erkannt] | 0 |
| 0x1F0911 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 1: Übertemperatur Stufe 1 erkannt] | 0 |
| 0x1F0912 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 2: Übertemperatur Stufe 1 erkannt] | 0 |
| 0x1F0913 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 1: Unterspannung erkannt] | 0 |
| 0x1F0914 | DME: interner Fehler [Endstufe, Pneumatisches Wastegate 2: Unterspannung erkannt] | 0 |
...
| 0x1F1B54 | Powermanagement: Erzeugerausfall (Generator, DC/DC-Wandler) | 1 |
| 0x1F1B55 | Powermanagement: Batterie Unterspannung im Fahren | 0 |
...
| 0x1F4D11 | DME, interner Fehler, Ansteuerung Mengensteuerventil 2: Fehlfunktion | 0 |
...
| 0x1FBD08 | Fahrbereitschaft: Anforderung MSA Deaktivierung vom BDC | 0 |
| 0x1FBD10 | Notlaufmanager: Anforderung Dauergong aufgrund Getriebefehler | 0 |
...
| 0x20A910 | Motor-Kühlsystem: verschmutzt oder Luft im Kühlsystem | 0 |
| 0x20AB08 | Motor-Kühlsystem: kein Notlaufsignal an Kühlmittelpumpe | 0 |
| 0x20AD09 | Motor-Kühlsystem: Drehzahl Zusatzkühlmittelpumpe außerhalb der Toleranz | 0 |
| 0x20BA20 | Kupplungsschalter, Signal: unplausible Gangwechsel erkannt | 0 |
| 0x20D001 | Soundklappe, Ansteuerung: Kurzschluss nach Plus | 0 |
| 0x20D002 | Soundklappe, Ansteuerung: Kurzschluss nach Masse | 0 |
| 0x20D004 | Soundklappe, Ansteuerung: Leitungsunterbrechung | 0 |
...
| 0x212301 | Statusanzeige Startergenerator: Übertemperatur | 1 |
...
| 0x212701 | Startsystem, Startergenerator: MSA zeitweise deaktiviert | 1 |
| 0x212801 | Startergenerator, Sensoren, elektrisch: Fehlfunktion | 0 |
| 0x212A01 | Startergenerator: Typ nicht plausibel | 0 |
...
| 0x215F40 | Intelligenter Batteriesensor, Arbeitsbereich: Strom zu hoch | 0 |
| 0x215F41 | Intelligenter Batteriesensor, Arbeitsbereich: Strom zu niedrig | 0 |
| 0x215F42 | Intelligenter Batteriesensor, Arbeitsbereich: Temperatur zu hoch | 0 |
| 0x215F43 | Intelligenter Batteriesensor, Arbeitsbereich: Temperatur zu niedrig | 0 |
| 0x215F44 | Intelligenter Batteriesensor, Arbeitsbereich: Spannung zu hoch | 0 |
| 0x215F45 | Intelligenter Batteriesensor, Arbeitsbereich: Spannung zu niedrig | 0 |
...
| 0x21A003 | Notlaufmanager: Anforderung Verbrennungsmotor Momentreduktion Stufe 1 von Steuergerät Elektromaschine | 1 |
| 0x21A004 | Notlaufmanager: Anforderung Verbrennungsmotor Momentreduktion Stufe 2 von Steuergerät Elektromaschine | 1 |
| 0x21A005 | Notlaufmanager: Anforderung Verbrennungsmotor Momentreduktion Stufe 3 von Steuergerät Elektromaschine | 1 |
| 0x21A023 | Verbrennungsmotor: Fehlstart oder Motor ausgegangen ohne Fahrereinfluss | 0 |
| 0x21A110 | Motordrehmomentbegrenzung: infolge Notlaufanforderung vom Steuergerät Elektromaschine-Notlaufmanager | 1 |
...
| 0x21A500 | Notlaufmanager: Anforderung Bauteileschutz Trennkupplung, Abschaltung Verbrennungsmotor | 1 |
| 0x21A501 | Integrierte Anfahrkupplung: klemmt geschlossen | 1 |
| 0x21A502 | Integrierte elektrische Getriebeölpumpe: Fehlfunktion | 1 |
| 0x21A503 | Trennkupplung: klemmt geschlossen | 1 |
| 0x21A504 | Trennkupplung: klemmt offen | 1 |
| 0x21A505 | EGS: elektrischer Notlauf aktiv | 1 |
| 0x21A506 | EGS: mechanischer Notlauf aktiv | 1 |
| 0x21A507 | EGS: Reset | 1 |
| 0x21A510 | Startsystem, Elektromaschine: Zeitüberschreitung | 0 |
| 0x21A511 | Startsystem, Ritzelstarter: Zeitüberschreitung | 0 |
| 0x21A512 | Startsystem, Startergenerator: Zeitüberschreitung | 0 |
| 0x21A513 | Startaggregat Startergenerator: Sammelfehler | 0 |
| 0x21A519 | Durchfahrt tiefen Wassers erkannt | 0 |
| 0x22FE55 | Valvetronic-Stellmotor, Ansteuerung: Fehlfunktion | 0 |
| 0x22FEAE | Lambdasonde nach Katalysator: Signal festliegend auf Fett | 0 |
| 0x22FEAF | Lambdasonde nach Katalysator: Signal festliegend auf Mager | 0 |
| 0x22FF6A | MSAKUPPPLAUSnpl_C | 0 |
...
| 0x235410 | Notlaufmanager: Anforderung Leerlaufdrehzahlanhebung von Steuergerät Elektromaschine | 1 |
...
| 0xCD8B05 | FlexRay, Botschaft (Status DCDC, 125.0.2): fehlt, Sender EME | 0 |
...
| 0xCD8F10 | LIN, Kommunikation (Startergenerator): fehlt | 0 |
| 0xCD9003 | LIN, Kommunikation (Zusatzkühlmittelpumpe): fehlt | 0 |
| 0xCD9009 | LIN, Kommunikation (Kraftstofftank-Druck-Temperatursensor): fehlt | 0 |
| 0xCD9010 | LIN, Kommunikation (Motor-Kühlmittelpumpe): fehlt | 1 |
| 0xCD9011 | Kühlmittelpumpe, Kommunikation: Botschaft ungültig | 1 |
...
| 0xCD944D | FlexRay, Botschaft (Ist Drehzahl Rad, 46.0.1): Signalfehler | 1 |
...
| 0xCD9610 | FlexRay, Botschaft (Anforderung Radmoment Antriebstrang Summe FAS, 33.1.4): Signalfehler | 1 |
...
| 0xCD9730 | FlexRay, Botschaft (Daten Zusatzbatterie, 262.2.4): fehlt | 0 |
...
| 0xCD9F11 | FlexRay, Botschaft (Status Stabilisierung DSC, 47.1.2): Signalfehler | 0 |
| 0xCD9F12 | FlexRay, Botschaft (Konfiguration Schalter Fahrdynamik, 272.4.8): Signalfehler | 0 |
...
| 0xCDA310 | FlexRay, Botschaft (Daten Hybrid, 73.0.2): Aliveprüfung | 1 |
| 0xCDA311 | FlexRay, Botschaft (Daten Hybrid, 73.0.2): Prüfsumme falsch | 1 |
| 0xCDA312 | FlexRay, Botschaft (Daten Hybrid, 73.0.2): fehlt | 1 |
| 0xCDA313 | FlexRay, Botschaft (Daten Hybrid, 73.0.2): Signalfehler | 1 |
...
| 0xCDA427 | FlexRay, Botschaft (Status Optimierung Spülluft, 117.0.2): fehlt | 1 |
...
| 0xCDA432 | FlexRay, Botschaft (Daten Hybrid / Betriebsart Drehzahl Drehmoment Hybrid, 73.0.2): fehlt | 1 |
...
| 0xCDA515 | FA-CAN, Botschaft (Daten Anzeige Getriebestrang, 0x3FD): Signalfehler | 1 |
...
| 0xCDBA27 | FA-CAN, Botschaft (Ist Daten Ladeelektronik, 0x108): fehlt | 1 |
...
| 0xCDBB09 | A-CAN, Botschaft (Anforderung Drehmoment Kurbelwelle Getriebe 2, 0xA0): Signalfehler | 1 |
...
| 0xCDBB23 | Kommunikation: Signal (Drehzahl_Getriebestrang_Turbine) in A-CAN, Botschaft (Daten Getriebestrang, 0x1AF): ungültig | 1 |
| 0xCDBB24 | Kommunikation: Signal (Drehzahl_Getriebestrang_Abtrieb) in A-CAN, Botschaft (Daten Getriebestrang, 0x1AF): ungültig | 1 |
| 0xCDBB25 | Kommunikation: Signal (Status_Gangwahl_Getriebe) in A- / FA-CAN, Botschaft (Status Getriebesteuerung, 0x39A): ungültig | 1 |
...
| 0xCDBC11 | A-CAN, Botschaft (Daten Antrieb Elektrisch, 0x32F): Signalfehler | 1 |
...
| 0xCDBC24 | A-CAN, Botschaft (Status Antrieb Hybrid, 0x3A4): Signalfehler | 1 |
| 0xCDBD09 | A-CAN, Botschaft (Status Hochvoltspeicher 1, 0x1FA): fehlt | 1 |
...
| 0xCDBE23 | A-CAN, Botschaft (Möglichkeit Motorstart Motorstop. 0x3EC): Signalfehler | 1 |
...
| 0xCDC020 | A-CAN, Botschaft (Ist Daten E-Motor 1 Langzeit, 0x25B): Aliveprüfung | 1 |
| 0xCDC021 | A-CAN, Botschaft (Ist Daten E-Motor 1 Langzeit, 0x25B): Prüfsumme falsch | 1 |
| 0xCDC022 | A-CAN, Botschaft (Ist Daten E-Motor 1 Langzeit, 0x25B): fehlt | 1 |
| 0xCDC023 | A-CAN, Botschaft (Ist Daten E-Motor 1 Langzeit, 0x25B): Signalfehler | 1 |
...
| 0xCDC109 | A-CAN, Botschaft (Daten Getriebestrang, 0x1AF): Signalfehler | 1 |
| 0xCDC120 | A-CAN, Botschaft (Ist Daten E-Motor 1, 0x90): Aliveprüfung | 1 |
| 0xCDC121 | A-CAN, Botschaft (Ist Daten E-Motor 1, 0x90): Prüfsumme falsch | 1 |
| 0xCDC122 | A-CAN, Botschaft (Ist Daten E-Motor 1, 0x90): fehlt | 1 |
| 0xCDC123 | A-CAN, Botschaft (Ist Daten E-Motor 1, 0x90): Signalfehler | 1 |
...
| 0xCDC209 | A-CAN, Botschaft (Anforderung Drehmoment Kurbelwelle Getriebe, 0xB0): Signalfehler | 1 |
...
| 0xCDC311 | A-CAN, Botschaft (Messbotschaft EGS, 0x786): fehlt | 1 |
| 0xCDCC30 | Kraftstofftank-Druck-Temperatursensor, Kommunikation: gestört | 0 |
| 0xCDDB09 | FlexRay, Botschaft (Ist Drehzahl Rad, 46.0.1): Signalfehler | 1 |
| 0xCDF209 | FA-CAN, Botschaft (Daten Anzeige Getriebestrang, 0x3FD): Signalfehler | 1 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x5702 | SwSABMW_MaxmfQuoCdHFM | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5703 | B_gd_byte | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x570A | Bedingung Notlauf Wasserpumpe | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5714 | Schwelle | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5728 | Bedingung Superklopfer | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5734 | Com_stGbx | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5737 | Abweichung Drehzahl und gefilterte Drehzahl | 1/min | - | unsigned int | - | 0.25 | 1.0 | 0.0 |
| 0x5738 | Tiefpaßgefilterter Saugrohrdruck | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x573A | Solldifferenzdruck Saugrohr | hPa | - | signed int | - | 0.0390625 | 1.0 | 0.0 |
| 0x573B | Druckdifferenz zweite Einleitstelle während Test | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x573C | Differenzdruck vor Drosselklappe zwischen Start und Ende der Dynamikprüfung SSP | hPa | - | signed int | - | 0.078125 | 1.0 | 0.0 |
| 0x573D | Differenz des Referenzzählers seit letztem Clusterbeginn | s | - | unsigned int | - | 0.01 | 1.0 | 0.0 |
| 0x573E | Abweichung Luftfüllung und gefilterte Luftfüllung | % | - | unsigned int | - | 0.0234375 | 1.0 | 0.0 |
| 0x573F | Abstand zur Startfähigkeit | % | - | unsigned int | - | 0.004 | 1.0 | -100.0 |
| 0x5742 | Differenz des CAN-Uhr-Wertes seit letztem Clusterbeginn. | s | - | signed long | - | 1.0 | 1.0 | 0.0 |
| 0x5743 | Vergleichswert für CAN-Uhr-Diagnose (Low-Check) | s | - | signed long | - | 1.0 | 1.0 | 0.0 |
| 0x5744 | Vergleichswert für CAN-Uhr-Diagnose (High-Check) | s | - | signed long | - | 1.0 | 1.0 | 0.0 |
| 0x5746 | Vorsteuerwert MSV | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x5747 | [0] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x5748 | [1] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x5749 | [2] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x574A | [3] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x574B | [4] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x574C | [5] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x5762 | Rohwert Position eWG | mm | - | signed int | - | 0.00097656 | 1.0 | 0.0 |
| 0x5769 | Sollwert Hubverstellung | mm | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x576A | Rohwert Position oberer mechanischer Anschlag vom elektrisches Wastegate (WG offen) | mm | - | signed int | - | 0.00097656 | 1.0 | 0.0 |
| 0x576B | Rohwert Position unterer mechanischer Anschlag vom elektrisches Wastegate (WG geschlossen) | mm | - | signed int | - | 0.00097656 | 1.0 | 0.0 |
| 0x5775 | Korrekturfaktor Höhe | ° KW | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x5776 | Faktor adaptierte Kraftstoffqualität (0=ROZ98 / 1.0=ROZ91) | - | - | unsigned char | - | 0.00390625 | 1.0 | 0.0 |
| 0x577A | Faktor zur Aufteilung der Tankentlüftung zwischen 1. und 2. Einleitstelle | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x577B | Füllstand der linken Tankhälfte | l | - | unsigned char | - | 0.5 | 1.0 | 0.0 |
| 0x577C | Füllstand der rechten Tankhälfte | l | - | unsigned char | - | 0.5 | 1.0 | 0.0 |
| 0x577E | Gradient pssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | - | unsigned int | - | 0.15625 | 1.0 | 0.0 |
| 0x577F | Minimalwert für Gradient grssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | - | unsigned int | - | 0.15625 | 1.0 | 0.0 |
| 0x5780 | Maximalwert für Gradient grssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | - | unsigned int | - | 0.15625 | 1.0 | 0.0 |
| 0x5781 | Spannung Hinterkatsonde Lambda HEGO | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x578D | Ausgangstrom der Maschine | A | - | signed int | - | 0.125 | 1.0 | 0.0 |
| 0x578E | Grenzerregerstrom | A | - | unsigned int | - | 0.00125 | 1.0 | 0.0 |
| 0x578F | [0] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5790 | [1] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5793 | [2] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5794 | [3] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5795 | [4] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5796 | [5] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x579C | Lambdasoll Begrenzung (word) | - | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 |
| 0x57A0 | Referenzmoment für Aussetzererkennung | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
| 0x57A1 | Soll-Luftmassenstrom | kg/h | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x57A2 | Status Fahrzeug Zustand Funktionsüberwachung | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57A3 | Gesamtreflexstartzahl beim letzen Startertausch | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x57A4 | Gesamtstartzahl beim letzten Startertausch | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x57AC | Massenstromquotient für Diagnose HFM Mshfm ggü Mszyl_diag | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57AD | Luftmassenstrom HFM, korrigiert und gefiltert (für Berechnung Regeldifferenz Massenstromregler) | kg/h | - | unsigned int | - | 0.03125 | 1.0 | 0.0 |
| 0x57AE | Sollwert Drehzahl E-Lüfter Vorgabe WM | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
| 0x57B4 | Solldrehzahl elektrische Wasserpumpe zur Turbolader-Lagerstuhlkühlung | 1/min | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57B5 | Generatordrehzahl | 1/min | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57B7 | Zähler Leckdiagnose nicht durchgeführt aufgrund Umgebungsdruckänderung | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57B8 | Anzahl erkannte Feinstleck durch Diagnose | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57B9 | NVLD: EngineOff Schalterdiagnose 5 deg.C Bedingung erfüllt | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57BA | NVLD: Zähler EngineOff Schalterdiagnose ohne Fehler | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57BB | Anzahl dichtes EVAP System erkannt durch Diagnose | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57BC | NVLD: Diagnosezähler | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57BD | Ölniveau ungefiltert in [mm] | - | - | unsigned char | - | 0.29296875 | 1.0 | 0.0 |
| 0x57BF | Massenstromquotient minimum für Diagnose HFM im Coast Down | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57C1 | Druck vor Drosselklappe vom Sensor als Mittelwert | hPa | - | unsigned int | - | 0.125 | 1.0 | 0.0 |
| 0x57C2 | Summe abgesch Zylinder aufgrund Fehlern und aktiver zusätzlicher Abschaltung wegen Laufunruhe | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57C3 | Spreizung Einlass VANOS | ° KW | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x57C4 | Istbetriebsart | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57C7 | Massenstromquotient für Diagnose HFM im Coast Down, letzter NV-RAM Wert | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57CA | Saugrohrdruck gemessen mit Drucksensor am Saugrohr (DS-S) | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57CD | Ladedruck- Sollwert | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57D0 | Filterung Druckdifferenz Umgebungsdruck - Saugrohrdruck | hPa | - | signed int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57D1 | Druck an der Saugstrahlpumpe | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57D3 | Gefilterter Quotient Druck Saugstrahlpumpe Umgebungsdruck | hPa | - | signed int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57D8 | Umgebungsdruck beim Abstellen für die Leckdiagnose | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57D9 | Umgebungsdruck | hPa | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x57DA | Druck vor Drosselklappe ( Wertebereich von 0...5120hPa ) | hPa | - | unsigned int | - | 0.078125 | 1.0 | 0.0 |
| 0x57DB | Soll-Saugrohrdruck | hPa | - | unsigned int | - | 0.125 | 1.0 | 0.0 |
| 0x57E3 | Zeit seit letztem Tankvorgang | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57F0 | Betriebsstatus elektrisches Wastegate | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x57F1 | Zähler für verworfene Fehler der Tankleckdiagnose im Falle der Grenzüberschreitung der FTL | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x57F3 | Massenstromquotient maximum für Diagnose HFM im LL | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57F4 | Gesamt-Betriebsstundenzähler für Isgsdm_statistik | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x57F5 | Mittelwert der Messwerte für Massenstrom Diagnose HFM im LL | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x57F6 | Schließzeitausgabe | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x57FB | Tastverhältnis Auslaßnockenwellenregelung Ansteuerung Endstufe(word) | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
| 0x57FC | Tastverhältnis Einlaßnockenwellenregelung Ansteuerung Endstufe(word) | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
| 0x57FE | ausgegebenes Tastverhaeltnis für Tankentlueftungsventil (16 Bit) | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
...
| 0x5810 | Aktualität Minimumwarnung | 0/1 | - | 0xFF | - | - | - | - |
| 0x5811 | Motorölniveau | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5824 | Aktueller Fehlerstatus E-Maschine | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x582E | Modellierte 8HP-Getriebeöltemperatur am Wandleraustritt im Falle mech./elekr. Notprogramm | °C | - | signed int | - | 0.01 | 1.0 | 0.0 |
...
| 0x5833 | Status relatives Motorölniveau über Minimum | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5898 | phys. Wert Generatorsollspannung (Volt) für Komponententreiber Generator | V | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
...
| 0x58A4 | Anzahl erkannter VVT Lageregelungsfehlerwarnungen irreversibel | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x58A5 | Anzahl erkannter VVT Lageregelungsfehlerwarnungen reversibel | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x58BF | Bedingung Powerfail EEPROM | 0/1 | - | 0xFF | - | - | - | - |
...
| 0x58D1 | Motortemperatur beim Abstellen | °C | - | unsigned char | - | 0.75 | 1.0 | -48.0 |
...
| 0x58E5 | [0] Gefilterte Funkenbrenndauer Zylinder 1 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E6 | [1] Gefilterte Funkenbrenndauer Zylinder 2 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E7 | [2] Gefilterte Funkenbrenndauer Zylinder 3 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E8 | [3] Gefilterte Funkenbrenndauer Zylinder 4 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E9 | Versorgungsspannung elektr. Wasserpumpe | V | - | unsigned char | - | 0.1 | 1.0 | 0.0 |
| 0x58EA | Istdrehzahl elektr. Wasserpumpe | 1/min | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x58EB | überprüfte Umgebungstemperatur vom CAN-Kombi | °C | - | unsigned char | - | 0.75 | 1.0 | -48.0 |
| 0x58EC | Elektroniktemperatur elektr. Wasserpumpe | °C | - | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x58ED | Stromaufnahme elektr. Wasserpumpe | A | - | unsigned char | - | 0.5 | 1.0 | 0.0 |
...
| 0x58F8 | Zeitdauer anliegende Erregerstrombegrenzung | min | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x5902 | [4] Gefilterte Funkenbrenndauer Zylinder 5 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x5903 | [5] Gefilterte Funkenbrenndauer Zylinder 6 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
...
| 0x5916 | Relativer Ladezustand NV Batterie auslesen | % | - | unsigned char | - | 0.5 | 1.0 | 0.0 |
| 0x5917 | Status DCDC-Wandler auslesen | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5918 | Auslastung DCDC-Wandler auslesen | % | - | unsigned char | - | 0.5 | 1.0 | 0.0 |
| 0x5919 | Fehlerstatus E-Maschine | HEX | - | unsigned long | - | - | - | - |
| 0x591F | [0] Abgleich Drosselklappenmodell | - | - | signed char | - | 0.25 | 1.0 | 0.0 |
| 0x5920 | [0] Abgleich Einlassventilmodell | - | - | signed char | - | 0.25 | 1.0 | 0.0 |
| 0x5927 | Ist Position Elektrische Wastegate | % | - | unsigned char | - | 0.390625 | 1.0 | 0.0 |
...
| 0x592F | Status Synchronisationsmodul | 0-n | - | 0xFF | Epm_stSync_State_t | - | - | - |
| 0x5930 | Istwert Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT lesen | Ohm | - | unsigned int | - | 2.0 | 1.0 | 0.0 |
| 0x5932 | Innenwiderstand der Nernstzelle der LSU lesen | Ohm | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 |
| 0x5934 | Abgleich Drosselklappenmodell (Offset) lesen | kg/h | - | signed int | - | 0.03125 | 1.0 | 0.0 |
| 0x5935 | Abgleich Einlassventilmodell (Faktor) lesen | kg/h | - | signed int | - | 0.03125 | 1.0 | 0.0 |
| 0x5936 | Abgleich Drosselklappenmodell (Faktor) lesen | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5937 | Abgleich Einlassventilmodell (Faktor) lesen | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x593A | Gesamte Masse Benzin und Alkohol im Öl | g | - | unsigned int | - | 0.02133333 | 1.0 | 0.0 |
| 0x593B | Gangsensor Fehlernachricht | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x593D | Fehlerbits des Gangsensorfehlers | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x593E | Gangsensorposition in X (Alpha) Richtung nach Offsetkorrektur | ° | - | unsigned int | - | 0.05 | 1.0 | 0.0 |
| 0x593F | Gangsensorposition in Y (Beta) Richtung nach Offsetkorrektur | ° | - | unsigned int | - | 0.05 | 1.0 | 0.0 |
| 0x5940 | Ist-Ganginformation des Gangsensors | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x5941 | Gangsensorposition in X (Beta) Richtung | ° | - | unsigned long | - | 0.05 | 1.0 | 0.0 |
| 0x5942 | Gangsensorposition in Y (Beta) Richtung | ° | - | unsigned long | - | 0.05 | 1.0 | 0.0 |
| 0x5943 | Gespeicherter Offsetkorrekturwert für X (Alpha) | ° | - | signed long | - | 0.05 | 1.0 | 0.0 |
| 0x5944 | Gespeicherter Offsetkorrekturwert für Y (Beta) | ° | - | signed long | - | 0.05 | 1.0 | 0.0 |
...
| 0x5953 | Zähler für Intervalle mit kritischen ZMS-Störungen lesen | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x5954 | Zähler für Intervalle mit kritischen ZMS-Störungen über Lebenszeit lesen | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x5955 | Spannung hinter Inj/Ign-Relais | V | - | unsigned char | - | 0.1 | 1.0 | 0.0 |
| 0x5960 | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Adaption und mit Hubprädiktion) | mm | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x59BD | [0] gemittelter Verdrehwinkel der Nockenwelle | ° KW | - | signed long | - | 0.02197266 | 1.0 | 0.0 |
| 0x59BE | [1] gemittelter Verdrehwinkel der Nockenwelle | ° KW | - | signed long | - | 0.02197266 | 1.0 | 0.0 |
| 0x59BF | [0] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | - | signed int | - | 0.02197266 | 1.0 | 0.0 |
| 0x59C0 | [1] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | - | signed int | - | 0.02197266 | 1.0 | 0.0 |
| 0x59C1 | Fehlerursache Kurbelwellensignal | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x59CA | Triebstrangübersetzungsverhältnis gefiltert in der Funktionsüberwachung | - | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 |
| 0x59CB | Übersetzungsverhältnis gesamt (Word-Groesse) | - | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 |
| 0x59D4 | Ansauglufttemperatur vor Drosselklappe, gemessen | °C | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 |
| 0x59D7 | Toleranz des Referenzzählers für CAN-Uhr-Diagnose (beidseitiger Check) | s | - | signed int | - | 1.0 | 1.0 | 0.0 |
| 0x59D9 | Kraftstofftemperatur (Sensor-, Modell o. fester Ersatzwert) | °C | - | unsigned char | - | 0.75 | 1.0 | -48.0 |
| 0x59DA | Gesamtluftmassenstrom durch die DK aus gemessenem Lambda und Soll-Kraftstoffmasse Array | kg/h | - | unsigned int | - | 0.03125 | 1.0 | 0.0 |
| 0x59DD | Zeitzähler Motorbetrieb ab Startende (über gesamten SG-Zyklus) | s | - | unsigned int | - | 0.1 | 1.0 | 0.0 |
| 0x59E1 | Tastverhältnis für Ansteuerung des elektrischen Wastegate | % | - | signed int | - | 0.00305176 | 1.0 | 0.0 |
| 0x59E2 | Normwert Katdiagnose für OBD-Radar | - | - | signed int | - | 0.00015259 | 1.0 | 0.0 |
| 0x59E3 | Gesamtluftmassenstrom durch die DK aus gemessenem Lambda und Soll-Kraftstoffmasse Mittelwert | kg/h | - | unsigned int | - | 0.03125 | 1.0 | 0.0 |
| 0x59E4 | Normierter Wert der LSU-Heizleistungsdiagnose für OBD-Radar | - | - | signed int | - | 0.00015259 | 1.0 | 0.0 |
| 0x59E5 | Normierter Wert der LSU-Plausibilitätsdiagnose für OBD-Radar | - | - | signed int | - | 0.00015259 | 1.0 | 0.0 |
| 0x59E7 | Oeldruck | V | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 |
| 0x59E8 | mittlere Spannung Raildrucksensor | V | - | unsigned int | - | 0.00030518 | 1.0 | 0.0 |
| 0x59EB | Fahrzeuggeschwindigkeit an der Vorder- oder Hinterachse oder im Fahrzeugschwerpunkt | km/h | - | unsigned int | - | 0.0078125 | 1.0 | 0.0 |
| 0x59EC | Verhältnis Massenstrom TEV 100% zu ml | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x59ED | Drosselklappenwinkel bezogen auf unteren Anschlag | % DK | - | signed int | - | 0.02441406 | 1.0 | 0.0 |
| 0x59EF | Sollwert Drosselklappenwinkel, bezogen auf (unteren) Anschlag | % | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 |
| 0x59F1 | Istwert Auslaßspreizung | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x59F3 | Istwert Einlaßspreizung | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x59F5 | Sollwert Auslassspreizung variable NWS | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x59F7 | Sollwert Einlassspreizung variable NWS | ° KW | - | signed int | - | 0.1 | 1.0 | 0.0 |
| 0x59F9 | Öffnungszustand der Kühlluftklappensteuerung (KKSLKS) | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x59FA | Ist-Zündwinkel | ° KW | - | signed char | - | 0.75 | 1.0 | 0.0 |
| 0x59FC | Zündwinkel-Ausgabe | ° KW | - | signed char | - | 0.75 | 1.0 | 0.0 |
| 0x59FD | Soll-Zündwinkel aus Momenteneingriff | ° KW | - | signed char | - | 0.75 | 1.0 | 0.0 |
...
| 0xF455 | PID 55 | TEXT | High | 2 | - | 1.0 | 1.0 | 0.0 |
| 0xF456 | PID 56 | TEXT | - | 1 | - | - | - | - |
| 0xF457 | PID 57 | TEXT | High | 2 | - | 1.0 | 1.0 | 0.0 |
| 0xF458 | PID 58 | TEXT | High | 2 | - | 1.0 | 1.0 | 0.0 |
...
| SNWAP | 0x4306 | STAT_WASSERPUMPE_DREHZAHL_SOLL_WERT | Bestätigte Solldrehzahl elektr. Wasserpumpe | 1/min | Layer_nEwpDes | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4307_WERT | 0x4307 | STAT_0X4307_WERT | Statusmeldung elektr. Wasserpumpe | - | BasSvrAppl_stComPmp | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4420_WERT | 0x4420 | STAT_0X4420_WERT | Eingangstemperatur Poel_reg | °C | tpoelreg_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4424_WERT | 0x4424 | STAT_0X4424_WERT | Bedingung Ölsensorfehler | - | B_ozniverr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4425_WERT | 0x4425 | STAT_0X4425_WERT | Sumpftemperatur | °C | oztempsmpf_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4426_WERT | 0x4426 | STAT_0X4426_WERT | Ist-Betriebsart Öldruck Regelung | - | bapoelrist | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4427_WERT | 0x4427 | STAT_0X4427_WERT | Rückmeldung auf Anfrage zur Oelniveaumessung bitcodiert | - | stoelnivena | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4428_WERT | 0x4428 | STAT_0X4428_WERT | Schalter S_POELFUNC_ON | 0/1 | B_poelfuncon | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x4429_WERT | 0x4429 | STAT_0X4429_WERT | Anforderung Detailmessung Ölniveau Ausgangsgröße | 0/1 | B_onqntmssganf | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x442A_WERT | 0x442A | STAT_0X442A_WERT | Bedingung Motoröltemperatur (Oz_temp) gültig | - | B_oznivtemp | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x442B_WERT | 0x442B | STAT_0X442B_WERT | Kodierparameter Antriebsart (0=keine Kodierung, 1 = Heck, 2=Allrad, 3=Front) | - | onantriebsartcod | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x442C_WERT | 0x442C | STAT_0X442C_WERT | Rohwert Öl- Niveau | mm | Oil_niveau | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x442D_WERT | 0x442D | STAT_0X442D_WERT | Korrigiertes Niveau aus TP in MinErk | mm | SwSABMW_CorLvlMinDetc | - | unsigned int | - | 0.29296875 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x442E_WERT | 0x442E | STAT_0X442E_WERT | Niv-Mittelwert QntMssg | mm | SwSABMW_AvrgOilLvlMeas | - | unsigned int | - | 0.29296875 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x442F_WERT | 0x442F | STAT_0X442F_WERT | ABK Schnittstelle Öl- Niveau | - | SwSABMW_lenRelOilLvl | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4430_WERT | 0x4430 | STAT_0X4430_WERT | LSB Status für On_oelniveau | - | SwSABMW_stOilLvlDescrAbrt | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4431_WERT | 0x4431 | STAT_0X4431_WERT | MSB Status für On_oelniveau | - | SwSABMW_stOilLvlDescr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4434_WERT | 0x4434 | STAT_0X4434_WERT | Bedingung Niveaumessfehler vom Ölzustandssensor | - | B_oznivlerr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IAVEX | 0x4501 | STAT_VVT_EXCENTER_ADAPTION_WERT | VVT Excenterwellenadaptionswert | - | hubadmrofs_w | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4522_WERT | 0x4522 | STAT_0X4522_WERT | [0] Kraftstoffmasse homogen als Sollwert 0 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4523_WERT | 0x4523 | STAT_0X4523_WERT | [3] Kraftstoffmasse homogen als Sollwert 1 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4524_WERT | 0x4524 | STAT_0X4524_WERT | [6] Kraftstoffmasse homogen als Sollwert 2 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4525_WERT | 0x4525 | STAT_0X4525_WERT | [9] Kraftstoffmasse homogen als Sollwert 3 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4526_WERT | 0x4526 | STAT_0X4526_WERT | [12] Kraftstoffmasse homogen als Sollwert 4 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4527_WERT | 0x4527 | STAT_0X4527_WERT | [15] Kraftstoffmasse homogen als Sollwert 5 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4530_WERT | 0x4530 | STAT_0X4530_WERT | [0] Aktueller Einspritzmodus 0 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4531_WERT | 0x4531 | STAT_0X4531_WERT | [1] Aktueller Einspritzmodus 1 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4532_WERT | 0x4532 | STAT_0X4532_WERT | [2] Aktueller Einspritzmodus 2 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4533_WERT | 0x4533 | STAT_0X4533_WERT | [3] Aktueller Einspritzmodus 3 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4534_WERT | 0x4534 | STAT_0X4534_WERT | [4] Aktueller Einspritzmodus 4 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4535_WERT | 0x4535 | STAT_0X4535_WERT | [5] Aktueller Einspritzmodus 5 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4536_WERT | 0x4536 | STAT_0X4536_WERT | [0] Regeldifferenz Ladedruck - bankspezifisch Bank1 | hPa | SwSABMW_pCtlDifBnkSpc | - | signed int | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4538_WERT | 0x4538 | STAT_0X4538_WERT | [0] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle: BasSvrAppl_Sig_EpmCaS[0] | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4539_WERT | 0x4539 | STAT_0X4539_WERT | [1] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle: BasSvrAppl_Sig_EpmCaS[1] | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| REL_ZEIT_HUBAD | 0x4540 | STAT_REL_ZEIT_HUBAD_WERT | Relative Zeit der Hubadaption | - | SwSABMW_RelTiHubAdap | - | unsigned char | - | 0.00390625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4602_WERT | 0x4602 | STAT_0X4602_WERT | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Adaption und mit Hubprädiktion) | mm | evhubi_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| VGENE | 0x4605 | STAT_GENERATOR_CHIPVERSION_WERT | Chipversion E-Maschine 1 | - | isgusmchipvers | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4617_WERT | 0x4617 | STAT_0X4617_WERT | Abgenommenes Generatormoment | Nm | Isgusm_m | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x461B_WERT | 0x461B | STAT_0X461B_WERT | Drehzahlschwelle für LR-Funktion E-Maschine 1 | 1/min | tlrgensch_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4650_WERT | 0x4650 | STAT_0X4650_WERT | Getriebetemperatur | °C | tget | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
| STAT_0x4651_WERT | 0x4651 | STAT_0X4651_WERT | Tastverhältnis an Endstufe des Ladedruckstellers | % | tvldsten_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4653_WERT | 0x4653 | STAT_0X4653_WERT | Sensorspannung Positionssensor elektrisches Wastegate | V | ukrkp_w | - | unsigned int | - | 0.0012207 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4654_WERT | 0x4654 | STAT_0X4654_WERT | Rohwert Positionssensor elektrisches Wastegate | mm | elwgposri_w | - | signed int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4706_WERT | 0x4706 | STAT_0X4706_WERT | Absperrventil Tankentlüftung Saugrohreinleitung | - | B_tecpimv_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4713_WERT | 0x4713 | STAT_0X4713_WERT | Zähler Leckdiagnose nicht durchgeführt aufgrund Umgebungs- | - | nvldcdnctr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4714_WERT | 0x4714 | STAT_0X4714_WERT | NVLD: Zähler EngineOff Schalterdiagnose mit Fehler | - | nvldswer_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4715_WERT | 0x4715 | STAT_0X4715_WERT | NVLD: Zähler EngineOff Schalterdiagnose ohne Fehler | - | nvldnoer_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4716_WERT | 0x4716 | STAT_0X4716_WERT | NVLD: EngineOff Schalterdiagnose 5 deg. C Bedingung erfüllt | - | nvldevnt_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4804_WERT | 0x4804 | STAT_0X4804_WERT | Motorhaubensignal | 0/1 | Com_stHoodOpenSigOk | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| STAT_0x480C_WERT | 0x480C | STAT_0X480C_WERT | Sollwert Füllung des Momentenmanagers | % | rlsol_w | - | unsigned int | - | 0.0234375 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4811_WERT | 0x4811 | STAT_0X4811_WERT | Fahrzeuglängsbeschleunigung | m/s² | bfzglfgr | - | signed char | - | 0.21699999 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4812_WERT | 0x4812 | STAT_0X4812_WERT | Fahrzeugquerbeschleunigung | m/s² | bfzgqoz_w | - | signed int | - | 0.0015625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4882_WERT | 0x4882 | STAT_0X4882_WERT | Zähler Startabbrüche oder Ausgeher nach Schlüsselstart, Lambda-Regler nicht aktiv | - | SwSABMW_CntrDetdFaildStrtOnlyKeyStrt | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4890_WERT | 0x4890 | STAT_0X4890_WERT | Tprot-Status auslesen | - | BasUtil_stECUMode | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4891_WERT | 0x4891 | STAT_0X4891_WERT | OBD Radar Deaktivierung wegen Grenzänderungshäufigkeit | - | SysDiag_flgObdObsvrSectChgEnbl | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A02_WERT | 0x4A02 | STAT_0X4A02_WERT | ATL-Leckagediagnose läuft | 0/1 | B_atlberlek | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
| STAT_0x4A13_WERT | 0x4A13 | STAT_0X4A13_WERT | Spannung Lambdasonde (4.88mV/LSB) hinter Katalysator | V | ushk_w | - | unsigned int | - | 0.00488281 | 1.0 | -1.0 | - | 22;2C | - | - |
...
| STAT_0x4A1E_WERT | 0x4A1E | STAT_0X4A1E_WERT | Differenz zwischen Umgebungsdruck und Bremskraftverstärkerdruck von Drucksensor (Rohwert) | hPa | dpbkvur_w | - | signed int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IZWZ1 | 0x4A49 | STAT_ZUENDWINKEL_ZYL1_WERT | [0] Ausgegebener Zündwinkel 0 | ° KW | zwoutzyl_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A4A_WERT | 0x4A4A | STAT_0X4A4A_WERT | [1] Ausgegebener Zündwinkel 1 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A4C_WERT | 0x4A4C | STAT_0X4A4C_WERT | [2] Ausgegebener Zündwinkel 2 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A4D_WERT | 0x4A4D | STAT_0X4A4D_WERT | [3] Ausgegebener Zündwinkel 3 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A4E_WERT | 0x4A4E | STAT_0X4A4E_WERT | [4] Ausgegebener Zündwinkel 4 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A4F_WERT | 0x4A4F | STAT_0X4A4F_WERT | [5] Ausgegebener Zündwinkel 5 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4A81_WERT | 0x4A81 | STAT_0X4A81_WERT | Lambda-Regler-Ausgang (Word) | - | fr_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4B24_WERT | 0x4B24 | STAT_0X4B24_WERT | [4] Zähler Aussetzerkennung Zylinder 2 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4B25_WERT | 0x4B25 | STAT_0X4B25_WERT | [2] Zähler Aussetzerkennung Zylinder 3 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4B30_WERT | 0x4B30 | STAT_0X4B30_WERT | [5] Zähler Aussetzerkennung Zylinder 4 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4B31_WERT | 0x4B31 | STAT_0X4B31_WERT | [1] Zähler Aussetzerkennung Zylinder 5 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4B32_WERT | 0x4B32 | STAT_0X4B32_WERT | [3] Zähler Aussetzerkennung Zylinder 6 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5702_WERT | 0x5702 | STAT_0X5702_WERT | SwSABMW_MaxmfQuoCdHFM | - | SwSABMW_MaxmfQuoCdHFM | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5703_WERT | 0x5703 | STAT_0X5703_WERT | B_gd_byte | - | B_gd_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| BED_NOTL_WAPU | 0x570A | STAT_BED_NOTL_WAPU_WERT | Bedingung Notlauf Wasserpumpe | - | B_nlwapu_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| I_OELDRUCKREGELUNG | 0x5714 | STAT_I_OELDRUCKREGELUNG_WERT | Schwelle | - | bapoelrist | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| BED_SUPERKLOPFER | 0x5728 | STAT_BED_SUPERKLOPFER_WERT | Bedingung Superklopfer | - | B_ssk_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5734_WERT | 0x5734 | STAT_0X5734_WERT | Com_stGbx | - | Com_stGbx | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| ABW_DREHZAHL_VS_DREHZAHL_GEFILTERT | 0x5737 | STAT_ABW_DREHZAHL_VS_DREHZAHL_GEFILTERT_WERT | Abweichung Drehzahl und gefilterte Drehzahl | 1/min | dnmotdte_w | - | unsigned int | - | 0.25 | 1.0 | 0.0 | - | 22;2C | - | - |
| SAUGROHRDRUCK_TIEFPASSFILT | 0x5738 | STAT_SAUGROHRDRUCK_TIEFPASSFILT_WERT | Tiefpaßgefilterter Saugrohrdruck | hPa | dpsdte_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| SAUGROHR_SOLLDIFFERENZDRUCK | 0x573A | STAT_SAUGROHR_SOLLDIFFERENZDRUCK_WERT | Solldifferenzdruck Saugrohr | hPa | dpssol_w | - | signed int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DRUCKDIFFERENZ_ZW_EINLEITUNG_BEI_TEST | 0x573B | STAT_DRUCKDIFFERENZ_ZW_EINLEITUNG_BEI_TEST_WERT | Druckdifferenz zweite Einleitstelle während Test | hPa | dpsspdte_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DRUCKDIFFERENZ_ZAEHLER_REFERENZ_SLCB | 0x573C | STAT_DRUCKDIFFERENZ_ZAEHLER_REFERENZ_SLCB_WERT | Differenzdruck vor Drosselklappe zwischen Start und Ende der Dynamikprüfung SSP | hPa | dpvdres_w | - | signed int | - | 0.078125 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZAEHLERDIFFERENZ_SLCB | 0x573D | STAT_ZAEHLERDIFFERENZ_SLCB_WERT | Differenz des Referenzzählers seit letztem Clusterbeginn | s | dreftcan_w | - | unsigned int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
| ABW_FUELLUNG_VS_FILT_FUELLUNG | 0x573E | STAT_ABW_FUELLUNG_VS_FILT_FUELLUNG_WERT | Abweichung Luftfüllung und gefilterte Luftfüllung | % | drldte_w | - | unsigned int | - | 0.0234375 | 1.0 | 0.0 | - | 22;2C | - | - |
| ABSTAND_STARTFAEHIGKEIT | 0x573F | STAT_ABSTAND_STARTFAEHIGKEIT_WERT | Abstand zur Startfähigkeit | % | dsoc_w | - | unsigned int | - | 0.004 | 1.0 | -100.0 | - | 22;2C | - | - |
| CAN_UHR_DIFFERENZWERT_SLCB | 0x5742 | STAT_CAN_UHR_DIFFERENZWERT_SLCB_WERT | Differenz des CAN-Uhr-Wertes seit letztem Clusterbeginn. | s | dtabcan_l | - | signed long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| CAN_UHR_VERGL_WERT_DIAGNOSE_LOWCHECK | 0x5743 | STAT_CAN_UHR_VERGL_WERT_DIAGNOSE_LOWCHECK_WERT | Vergleichswert für CAN-Uhr-Diagnose (Low-Check) | s | dteoetmn_l | - | signed long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| CAN_UHR_VERGL_WERT_DIAGNOSE_HIGHCHECK | 0x5744 | STAT_CAN_UHR_VERGL_WERT_DIAGNOSE_HIGHCHECK_WERT | Vergleichswert für CAN-Uhr-Diagnose (High-Check) | s | dteoetmx_l | - | signed long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| VORSTEUERWERT_MSV | 0x5746 | STAT_VORSTEUERWERT_MSV_WERT | Vorsteuerwert MSV | ° KW | dwmsvvst_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL1 | 0x5747 | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL1_WERT | [0] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL2 | 0x5748 | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL2_WERT | [1] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL3 | 0x5749 | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL3_WERT | [2] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL4 | 0x574A | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL4_WERT | [3] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL5 | 0x574B | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL5_WERT | [4] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL6 | 0x574C | STAT_DIAG_ZUENDFEHLER_ANZAHL_EREIGN_LOG_CYL6_WERT | [5] Diagnose Zuendung: Anzahl Zuendfehler-Ereignisse (BDU) | - | dznerrbd_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| ROH_POS_EWG | 0x5762 | STAT_ROH_POS_EWG_WERT | Rohwert Position eWG | mm | elwgposri_w | - | signed int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_VVT_HUBVERSTELLUNG | 0x5769 | STAT_S_VVT_HUBVERSTELLUNG_WERT | Sollwert Hubverstellung | mm | evhubs_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ROH_POS_EWG_OFFEN | 0x576A | STAT_ROH_POS_EWG_OFFEN_WERT | Rohwert Position oberer mechanischer Anschlag vom elektrisches Wastegate (WG offen) | mm | SwSABMW_rawPosUpWge | - | signed int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| ROH_POS_EWG_GESCHLOSSEN | 0x576B | STAT_ROH_POS_EWG_GESCHLOSSEN_WERT | Rohwert Position unterer mechanischer Anschlag vom elektrisches Wastegate (WG geschlossen) | mm | SwSABMW_rawPosDwnWge | - | signed int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| KORREKTURFAKTOR_HOEHE | 0x5775 | STAT_KORREKTURFAKTOR_HOEHE_WERT | Korrekturfaktor Höhe | ° KW | SwSABMW_OutlExtn | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| FAK_KRAFTSTOFFQUALITAET_ADAPT | 0x5776 | STAT_FAK_KRAFTSTOFFQUALITAET_ADAPT_WERT | Faktor adaptierte Kraftstoffqualität (0=ROZ98 / 1.0=ROZ91) | - | foctan | - | unsigned char | - | 0.00390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| FAK_AUFT_TANKENTL_ZW_EINLEITSTELLEN | 0x577A | STAT_FAK_AUFT_TANKENTL_ZW_EINLEITSTELLEN_WERT | Faktor zur Aufteilung der Tankentlüftung zwischen 1. und 2. Einleitstelle | - | fssp_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| FUELLST_TANK_LINKS | 0x577B | STAT_FUELLST_TANK_LINKS_WERT | Füllstand der linken Tankhälfte | l | fsttankl | - | unsigned char | - | 0.5 | 1.0 | 0.0 | - | 22;2C | - | - |
| FUELLST_TANK_RECHTS | 0x577C | STAT__FUELLST_TANK_RECHTS_WERT | Füllstand der rechten Tankhälfte | l | fsttankr | - | unsigned char | - | 0.5 | 1.0 | 0.0 | - | 22;2C | - | - |
| DYNPRUEFUNG_GRADIENT_SSP_DRUCK_ROH | 0x577E | STAT_DYNPRUEFUNG_GRADIENT_SSP_DRUCK_ROH_WERT | Gradient pssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | grssparh_w | - | unsigned int | - | 0.15625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DYNPRUEFUNG_MINW_GRADIENT_SSP_DRUCK_ROH | 0x577F | STAT_DYNPRUEFUNG_MINW_GRADIENT_SSP_DRUCK_ROH_WERT | Minimalwert für Gradient grssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | grsspmn_w | - | unsigned int | - | 0.15625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DYNPRUEFUNG_MAXW_GRADIENT_SSP_DRUCK_ROH | 0x5780 | STAT_DYNPRUEFUNG_MAXW_GRADIENT_SSP_DRUCK_ROH_WERT | Maximalwert für Gradient grssparh_w in Dynamikprüfung für Saugstrahlpumpe | hPa/s | grsspmx_w | - | unsigned int | - | 0.15625 | 1.0 | 0.0 | - | 22;2C | - | - |
| SPG_LAMBDASONDE_HINTERKAT | 0x5781 | STAT_SPG_LAMBDASONDE_HINTERKAT_WERT | Spannung Hinterkatsonde Lambda HEGO | - | SwSABMW_AvgmfQuoCdHFM | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| AUSGANGSSTROM_GENERATOR | 0x578D | STAT_AUSGANGSSTROM_GENERATOR_WERT | Ausgangstrom der Maschine | A | isgusmi_w | - | signed int | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| GRENZERREGERSTROM_GENERATOR | 0x578E | STAT_GRENZERREGERSTROM_GENERATOR_WERT | Grenzerregerstrom | A | isgusmierrgrenz_w | - | unsigned int | - | 0.00125 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL1 | 0x578F | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL1_WERT | [0] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL2 | 0x5790 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL2_WERT | [1] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL3 | 0x5793 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL3_WERT | [2] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL4 | 0x5794 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL4_WERT | [3] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL5 | 0x5795 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL5_WERT | [4] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL6 | 0x5796 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL6_WERT | [5] Zyl-individuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaptionswerte) | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDASOLL_BEGRENZUNG | 0x579C | STAT_LAMBDASOLL_BEGRENZUNG_WERT | Lambdasoll Begrenzung (word) | - | lamsbg_w | - | unsigned int | - | 0.00024414 | 1.0 | 0.0 | - | 22;2C | - | - |
| REFERENZMOMENT_AUSSETZERERKENNUNG | 0x57A0 | STAT_REFERENZMOMENT_AUSSETZERERKENNUNG_WERT | Referenzmoment für Aussetzererkennung | % | midmd_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_LUFTMASSENSTROM | 0x57A1 | STAT_S_LUFTMASSENSTROM_WERT | Soll-Luftmassenstrom | kg/h | mlsol_w | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STATUS_FZG_ZUST_FUNKTUEBE | 0x57A2 | STAT_STATUS_FZG_ZUST_FUNKTUEBE_WERT | Status Fahrzeug Zustand Funktionsüberwachung | - | SwSABMW_mfQuoHFMLL | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| GES_REFLEXSTARTZAHL_LETZT_STARTERTAUSCH | 0x57A3 | STAT_GES_REFLEXSTARTZAHL_LETZT_STARTERTAUSCH_WERT | Gesamtreflexstartzahl beim letzen Startertausch | - | msastrtz_l | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| GES_STARTZAHL_LETZT_STARTERTAUSCH | 0x57A4 | STAT_GES_STARTZAHL_LETZT_STARTERTAUSCH_WERT | Gesamtstartzahl beim letzten Startertausch | - | msastrtzges_l | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| I_LUMA_NORM_DIAG | 0x57AC | STAT_I_LUMA_NORM_DIAG_WERT | Massenstromquotient für Diagnose HFM Mshfm ggü Mszyl_diag | - | SwSABMW_mfQuoHFMMshfm | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| ILMKG_MW2 | 0x57AD | STAT_LUFTMASSE_MESSWERT2_WERT | Luftmassenstrom HFM, korrigiert und gefiltert (für Berechnung Regeldifferenz Massenstromregler) | kg/h | SwSABMW_AirmfCorAndFild | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_DREH_ELUEFTER_VORG_WM | 0x57AE | STAT_S_DREH_ELUEFTER_VORG_WM_WERT | Sollwert Drehzahl E-Lüfter Vorgabe WM | % | nelueft_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_DREH_WAPUT | 0x57B4 | STAT_S_DREH_WAPUT_WERT | Solldrehzahl elektrische Wasserpumpe zur Turbolader-Lagerstuhlkühlung | 1/min | newpsoll3 | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| I_DREH_GENERATOR | 0x57B5 | STAT_I_DREH_GENERATOR_WERT | Generatordrehzahl | 1/min | ngenerat_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_ZAEHLER_DIAG_NICHT_DURCHGEF | 0x57B7 | STAT_NVLD_ZAEHLER_DIAG_NICHT_DURCHGEF_WERT | Zähler Leckdiagnose nicht durchgeführt aufgrund Umgebungsdruckänderung | - | nvldcdnctr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_ANZAHL_FEINSTLECK_ERKANNT | 0x57B8 | STAT_NVLD_ANZAHL_FEINSTLECK_ERKANNT_WERT | Anzahl erkannte Feinstleck durch Diagnose | - | nvlddiasleakctr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_ENGINEOFF_SCHDIAG_5DEGC_BED_ERF | 0x57B9 | STAT_NVLD_ENGINEOFF_SCHDIAG_5DEGC_BED_ERF_WERT | NVLD: EngineOff Schalterdiagnose 5 deg.C Bedingung erfüllt | - | nvldevnt_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_ZAEHLER_ENGINEOFF_OHNE_FEHLER | 0x57BA | STAT_NVLD_ZAEHLER_ENGINEOFF_OHNE_FEHLER_WERT | NVLD: Zähler EngineOff Schalterdiagnose ohne Fehler | - | nvldnoer_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_ANZAHL_EVAP_DICHT_ERKANNT | 0x57BB | STAT_NVLD_ANZAHL_EVAP_DICHT_ERKANNT_WERT | Anzahl dichtes EVAP System erkannt durch Diagnose | - | nvldnrdiagctr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_DIAGNOSEZAEHLER | 0x57BC | STAT_NVLD_DIAGNOSEZAEHLER_WERT | NVLD: Diagnosezähler | - | nvldswer_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| NIVE_OEL_UNFILT | 0x57BD | STAT_NIVE_OEL_UNFILT_WERT | Ölniveau ungefiltert in [mm] | - | ozniv | - | unsigned char | - | 0.29296875 | 1.0 | 0.0 | - | 22;2C | - | - |
| MIN_MF_QUO_CD_HFM | 0x57BF | STAT_MIN_MF_QUO_CD_HFM_WERT | Massenstromquotient minimum für Diagnose HFM im Coast Down | - | SwSABMW_MinmfQuoCdHFM | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| AVG_P_T_THR_SNSR | 0x57C1 | STAT_AVG_P_T_THR_SNSR_WERT | Druck vor Drosselklappe vom Sensor als Mittelwert | hPa | SwSABMW_AvgPThrFromSnsr | - | unsigned int | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| SUM_DI_CYL | 0x57C2 | STAT_SUM_DI_CYL_WERT | Summe abgesch Zylinder aufgrund Fehlern und aktiver zusätzlicher Abschaltung wegen Laufunruhe | - | SwSABMW_SumOfDiCyl | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| IN_I_EXTN | 0x57C3 | STAT_IN_I_EXTN_WERT | Spreizung Einlass VANOS | ° KW | SwSABMW_InlExtn | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| ACT_STS | 0x57C4 | STAT_ACT_STS_WERT | Istbetriebsart | - | SwSABMW_ActSts | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| MF_QUO_CD_HFM | 0x57C7 | STAT_MF_QUO_CD_HFM_WERT | Massenstromquotient für Diagnose HFM im Coast Down, letzter NV-RAM Wert | - | SwSABMW_mfQuoCdHFM | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| SENSORWERT_SAUGROHRDRUCK | 0x57CA | STAT_SENSORWERT_SAUGROHRDRUCK_WERT | Saugrohrdruck gemessen mit Drucksensor am Saugrohr (DS-S) | hPa | psdss_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_LAGEDRUCK | 0x57CD | STAT_S_LAGEDRUCK_WERT | Ladedruck- Sollwert | hPa | psolldr_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| FILTERUNG_DRUCKDIFF_UMGEBUNG_SAUGROHR | 0x57D0 | STAT_FILTERUNG_DRUCKDIFF_UMGEBUNG_SAUGROHR_WERT | Filterung Druckdifferenz Umgebungsdruck - Saugrohrdruck | hPa | psprdtef_w | - | signed int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DRUCK_SSP | 0x57D1 | STAT_DRUCK_SSP_WERT | Druck an der Saugstrahlpumpe | hPa | pssp_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| QUOTIENT_DRUCK_SSP_UMG_FILT | 0x57D3 | STAT_QUOTIENT_DRUCK_SSP_UMG_FILT_WERT | Gefilterter Quotient Druck Saugstrahlpumpe Umgebungsdruck | hPa | pssprtef_w | - | signed int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| NVLD_PU_LEAK | 0x57D8 | STAT_NVLD_PU_LEAK_WERT | Umgebungsdruck beim Abstellen für die Leckdiagnose | hPa | puleaknvld_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| UMGEBUNGSDRUCK | 0x57D9 | STAT_UMGEBUNGSDRUCK_WERT | Umgebungsdruck | hPa | pu_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| DRUCK_VOR_DROSSELKLAPPE | 0x57DA | STAT_DRUCK_VOR_DROSSELKLAPPE_WERT | Druck vor Drosselklappe ( Wertebereich von 0...5120hPa ) | hPa | pvd_w | - | unsigned int | - | 0.078125 | 1.0 | 0.0 | - | 22;2C | - | - |
| AVG_OF_PSSOL | 0x57DB | STAT_AVG_OF_PSSOL_WERT | Soll-Saugrohrdruck | hPa | SwSABMW_AvgOfPssol | - | unsigned int | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| TIME_FROM_LST_INST | 0x57E3 | STAT_TIME_FROM_LST_INST_WERT | Zeit seit letztem Tankvorgang | - | SwSABMW_TimeFromLstInst | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| BETRIEBSSTATUS_EWG | 0x57F0 | STAT_BETRIEBSSTATUS_EWG_WERT | Betriebsstatus elektrisches Wastegate | - | SwSABMW_stOpWge | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZAEHLER_TANKLECKDIAG_VERW_FEHL_GREN_FTL | 0x57F1 | STAT_ZAEHLER_TANKLECKDIAG_VERW_FEHL_GREN_FTL_WERT | Zähler für verworfene Fehler der Tankleckdiagnose im Falle der Grenzüberschreitung der FTL | - | SwSABMW_cntSmlLeakDgnsAbvThd | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| MAXMF_QUO_HFM_LL | 0x57F3 | STAT_MAXMF_QUO_HFM_LL_WERT | Massenstromquotient maximum für Diagnose HFM im LL | - | SwSABMW_MaxmfQuoHFMLL | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| GES_BETRIEBSST_ZAEHLER_ISGSDM_STAT | 0x57F4 | STAT_GES_BETRIEBSST_ZAEHLER_ISGSDM_STAT_WERT | Gesamt-Betriebsstundenzähler für Isgsdm_statistik | - | SwSABMW_totOpHrsIsgSdmStat | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| AVGMF_QUO_HFM_LL | 0x57F5 | STAT_AVGMF_QUO_HFM_LL_WERT | Mittelwert der Messwerte für Massenstrom Diagnose HFM im LL | - | SwSABMW_AvgmfQuoHFMLL | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZUEND_SCHLIESSZEIT | 0x57F6 | STAT_ZUEND_SCHLIESSZEIT_WERT | Schließzeitausgabe | ms | szout_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| TV_ANWS_AMP | 0x57FB | STAT_TV_ANWS_AMP_WERT | Tastverhältnis Auslaßnockenwellenregelung Ansteuerung Endstufe(word) | % | tanwraa_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| TV_ENWS_AMP | 0x57FC | STAT_TV_ENWS_AMP_WERT | Tastverhältnis Einlaßnockenwellenregelung Ansteuerung Endstufe(word) | % | tanwree_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| TV_TEV | 0x57FE | STAT_TV_TEV_WERT | ausgegebenes Tastverhaeltnis für Tankentlueftungsventil (16 Bit) | % | tateout_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5811_WERT | 0x5811 | STAT_0X5811_WERT | Motorölniveau | - | SwSABMW_lenRelOilLvl | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5824_WERT | 0x5824 | STAT_0X5824_WERT | Aktueller Fehlerstatus E-Maschine | - | stisgusmdiag_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x582E_WERT | 0x582E | STAT_0X582E_WERT | Modellierte 8HP-Getriebeöltemperatur am Wandleraustritt im Falle mech./elekr. Notprogramm | °C | SwSABMW_tTrsmModLimp | - | signed int | - | 0.01 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5833_WERT | 0x5833 | STAT_0X5833_WERT | Status relatives Motorölniveau über Minimum | - | SwSABMW_stOilLvlDescr | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x584A_WERT | 0x584A | STAT_0X584A_WERT | aktueller Generatorstatus | - | St_isgusm_status | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| SUGEN | 0x5898 | STAT_GENERATOR_SPANNUNG_SOLL_WERT | phys. Wert Generatorsollspannung (Volt) für Komponententreiber Generator | V | Isgusmusoll | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x58A4_WERT | 0x58A4 | STAT_0X58A4_WERT | Anzahl erkannter VVT Lageregelungsfehlerwarnungen irreversibel | - | vvt_highcurrent | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58A5_WERT | 0x58A5 | STAT_0X58A5_WERT | Anzahl erkannter VVT Lageregelungsfehlerwarnungen reversibel | - | vvt_highcurrent_rev | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x58BF_WERT | 0x58BF | STAT_0X58BF_WERT | Bedingung Powerfail EEPROM | 0/1 | B_eepwf | - | unsigned char | - | - | - | - | - | 22;2C | - | - |
...
| STAT_0x58D1_WERT | 0x58D1 | STAT_0X58D1_WERT | Motortemperatur beim Abstellen | °C | tmotab | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
...
| STAT_0x58E5_WERT | 0x58E5 | STAT_0X58E5_WERT | [0] Gefilterte Funkenbrenndauer Zylinder 1 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58E6_WERT | 0x58E6 | STAT_0X58E6_WERT | [1] Gefilterte Funkenbrenndauer Zylinder 2 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58E7_WERT | 0x58E7 | STAT_0X58E7_WERT | [2] Gefilterte Funkenbrenndauer Zylinder 3 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58E8_WERT | 0x58E8 | STAT_0X58E8_WERT | [3] Gefilterte Funkenbrenndauer Zylinder 4 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| IUWAP | 0x58E9 | STAT_WASSERPUMPE_SPANNUNG_WERT | Versorgungsspannung elektr. Wasserpumpe | V | BasSvrAppl_uSplyPmp | - | unsigned char | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x58EB_WERT | 0x58EB | STAT_0X58EB_WERT | überprüfte Umgebungstemperatur vom CAN-Kombi | °C | ctum | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
| ITWAE | 0x58EC | STAT_WASSERPUMPE_ELEKTRONIK_TEMPERATUR_WERT | Elektroniktemperatur elektr. Wasserpumpe | °C | BasSvrAppl_tPmp | - | unsigned char | - | 1.0 | 1.0 | -50.0 | - | 22;2C | - | - |
| IIWAP | 0x58ED | STAT_WASSERPUMPE_STROM_WERT | Stromaufnahme elektr. Wasserpumpe | A | BasSvrAppl_iPmp | - | unsigned char | - | 0.5 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x58F8_WERT | 0x58F8 | STAT_0X58F8_WERT | Zeitdauer anliegende Erregerstrombegrenzung | min | Isgusm_ierrgrenzz | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5902_WERT | 0x5902 | STAT_0X5902_WERT | [4] Gefilterte Funkenbrenndauer Zylinder 5 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5903_WERT | 0x5903 | STAT_0X5903_WERT | [5] Gefilterte Funkenbrenndauer Zylinder 6 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5916_WERT | 0x5916 | STAT_0X5916_WERT | Relativer Ladezustand NV Batterie auslesen | % | Layer_rChrgBattLowVltg | - | unsigned char | - | 0.5 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5917_WERT | 0x5917 | STAT_0X5917_WERT | Status DCDC-Wandler auslesen | - | Com_stDCConv_A | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5918_WERT | 0x5918 | STAT_0X5918_WERT | Auslastung DCDC-Wandler auslesen | % | Com_rActBalPCU_A | - | unsigned char | - | 0.5 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5919_WERT | 0x5919 | STAT_0X5919_WERT | Fehlerstatus E-Maschine | HEX | SwSABMW_stErrEmot | - | unsigned long | - | - | - | - | - | 22;2C | - | - |
| STAT_0x591F_WERT | 0x591F | STAT_0X591F_WERT | [0] Abgleich Drosselklappenmodell | - | SwSABMW_AdjmtThrVlvMdl | - | signed char | - | 0.25 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5920_WERT | 0x5920 | STAT_0X5920_WERT | [0] Abgleich Einlassventilmodell | - | SwSABMW_AdjmtIntkVlvMdl | - | signed char | - | 0.25 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5927_WERT | 0x5927 | STAT_0X5927_WERT | Ist Position Elektrische Wastegate | % | SwSABMW_ratPosWgeTst | - | unsigned char | - | 0.390625 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5930_WERT | 0x5930 | STAT_0X5930_WERT | Istwert Innenwiderstand Ri-Nernstzelle der Lambdasonde hinter KAT lesen | Ohm | rinh_w | - | unsigned int | - | 2.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5932_WERT | 0x5932 | STAT_0X5932_WERT | Innenwiderstand der Nernstzelle der LSU lesen | Ohm | rinlsu_w | - | unsigned int | - | 0.0390625 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5934_WERT | 0x5934 | STAT_0X5934_WERT | Abgleich Drosselklappenmodell (Offset) lesen | kg/h | SwSABMW_offsAdjThrMdl | - | signed int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5935_WERT | 0x5935 | STAT_0X5935_WERT | Abgleich Einlassventilmodell (Faktor) lesen | kg/h | SwSABMW_offsAdjIntkVlvMdl | - | signed int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5936_WERT | 0x5936 | STAT_0X5936_WERT | Abgleich Drosselklappenmodell (Faktor) lesen | - | SwSABMW_fakAdjThrMdl | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5937_WERT | 0x5937 | STAT_0X5937_WERT | Abgleich Einlassventilmodell (Faktor) lesen | - | SwSABMW_fakAdjIntkVlvMdl | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| M_BENZ_AKL_IM_OEL | 0x593A | STAT_M_BENZ_AKL_IM_OEL_WERT | Gesamte Masse Benzin und Alkohol im Öl | g | mkioel_w | - | unsigned int | - | 0.02133333 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_FEHLERN | 0x593B | STAT_GANGSENS_FEHLERN_WERT | Gangsensor Fehlernachricht | - | GbxPos_numSnsrFault | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_FEHLERB | 0x593D | STAT_GANGSENS_FEHLERB_WERT | Fehlerbits des Gangsensorfehlers | - | GbxPos_stSensErr | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_POS_XNOFF | 0x593E | STAT_GANGSENS_POS_XNOFF_WERT | Gangsensorposition in X (Alpha) Richtung nach Offsetkorrektur | ° | GbxPos_agXPosAftOffs | - | unsigned int | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_POS_YNOFF | 0x593F | STAT_GANGSENS_POS_YNOFF_WERT | Gangsensorposition in Y (Beta) Richtung nach Offsetkorrektur | ° | GbxPos_agYPosAftOffs | - | unsigned int | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_ISTGANG | 0x5940 | STAT_GANGSENS_ISTGANG_WERT | Ist-Ganginformation des Gangsensors | - | GbxPos_numLvrPos | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_POS_X | 0x5941 | STAT_GANGSENS_POS_X_WERT | Gangsensorposition in X (Beta) Richtung | ° | GbxPos_agXPos | - | unsigned long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_POS_Y | 0x5942 | STAT_GANGSENS_POS_Y_WERT | Gangsensorposition in Y (Beta) Richtung | ° | GbxPos_agYPos | - | unsigned long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_X_OFF | 0x5943 | STAT_GANGSENS_X_OFF_WERT | Gespeicherter Offsetkorrekturwert für X (Alpha) | ° | GbxPos_agXPosOffsEepRd | - | signed long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
| GANGSENS_Y_OFF | 0x5944 | STAT_GANGSENS_Y_OFF_WERT | Gespeicherter Offsetkorrekturwert für Y (Beta) | ° | GbxPos_agYPosOffsEepRd | - | signed long | - | 0.05 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5953_WERT | 0x5953 | STAT_0X5953_WERT | Zähler für Intervalle mit kritischen ZMS-Störungen lesen | - | MisfDet_CntrItvlCritDsbcDmf | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5954_WERT | 0x5954 | STAT_0X5954_WERT | Zähler für Intervalle mit kritischen ZMS-Störungen über Lebenszeit lesen | - | MisfDet_CntrItvlCritDsbcDmfLfTi | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5955_WERT | 0x5955 | STAT_0X5955_WERT | Spannung hinter Inj/Ign-Relais | V | ubinj | - | unsigned char | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| ISTWERT_HUBVER | 0x5960 | STAT_ISTWERT_HUBVER_WERT | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Adaption und mit Hubprädiktion) | mm | evhubi_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ENWS_MITTL_VERDREHWINK | 0x59BD | STAT_ENWS_MITTL_VERDREHWINK_WERT | [0] gemittelter Verdrehwinkel der Nockenwelle | ° KW | EpmCaS_phiCaSOfsAvg | - | signed long | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANWS_MITTL_VERDREHWINK | 0x59BE | STAT_ANWS_MITTL_VERDREHWINK_WERT | [1] gemittelter Verdrehwinkel der Nockenwelle | ° KW | EpmCaS_phiCaSOfsAvg | - | signed long | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| ENWS_MITTL_VERSATZ_AEQUIDIST | 0x59BF | STAT_ENWS_MITTL_VERSATZ_AEQUIDIST_WERT | [0] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANWS_MITTL_VERSATZ_AEQUIDIST | 0x59C0 | STAT_ANWS_MITTL_VERSATZ_AEQUIDIST_WERT | [1] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| SIGNAL_KURBELWELLE_FEHLERURSACHE | 0x59C1 | STAT_SIGNAL_KURBELWELLE_FEHLERURSACHE_WERT | Fehlerursache Kurbelwellensignal | - | EpmCrS_stSigDiagSrc | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| MOF_TRBSTR_UEBVERH | 0x59CA | STAT_MOF_TRBSTR_UEBVERH_WERT | Triebstrangübersetzungsverhältnis gefiltert in der Funktionsüberwachung | - | MoF_rTrqPT1Flt | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| MOF_UEBVERH_GES | 0x59CB | STAT_MOF_UEBVERH_GES_WERT | Übersetzungsverhältnis gesamt (Word-Groesse) | - | uevges_w | - | unsigned int | - | 0.00097656 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANSAUGLUFTTEMP_VOR_DK | 0x59D4 | STAT_ANSAUGLUFTTEMP_VOR_DK_WERT | Ansauglufttemperatur vor Drosselklappe, gemessen | °C | tavdkg_w | - | unsigned int | - | 0.0234375 | 1.0 | -273.1499939 | - | 22;2C | - | - |
| CAN_UHR_TOLERANZ_REFERENZZAEHLER | 0x59D7 | STAT_CAN_UHR_TOLERANZ_REFERENZZAEHLER_WERT | Toleranz des Referenzzählers für CAN-Uhr-Diagnose (beidseitiger Check) | s | teoetstl_w | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| KRAFTSTOFFTEMP | 0x59D9 | STAT_KRAFTSTOFFTEMP_WERT | Kraftstofftemperatur (Sensor-, Modell o. fester Ersatzwert) | °C | tfuelsq | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
| ARR_TOT_AIRMF_BY_DK | 0x59DA | STAT_ARR_TOT_AIRMF_BY_DK_WERT | Gesamtluftmassenstrom durch die DK aus gemessenem Lambda und Soll-Kraftstoffmasse Array | kg/h | SwSABMW_ArrTotAirmfByDK | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZEITDAUER_MOTORLAUF_AB_STARTENDE | 0x59DD | STAT_ZEITDAUER_MOTORLAUF_AB_STARTENDE_WERT | Zeitzähler Motorbetrieb ab Startende (über gesamten SG-Zyklus) | s | tnsezmot_w | - | unsigned int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| TV_EWG | 0x59E1 | STAT_TV_EWG_WERT | Tastverhältnis für Ansteuerung des elektrischen Wastegate | % | tvelwg_w | - | signed int | - | 0.00305176 | 1.0 | 0.0 | - | 22;2C | - | - |
| OBDRADAR_NORMWERT_KATDIAGNOSE | 0x59E2 | STAT_OBDRADAR_NORMWERT_KATDIAGNOSE_WERT | Normwert Katdiagnose für OBD-Radar | - | TWCD_ratObdRdrB1 | - | signed int | - | 0.00015259 | 1.0 | 0.0 | - | 22;2C | - | - |
| TOT_AIRMF_BY_DK | 0x59E3 | STAT_TOT_AIRMF_BY_DK_WERT | Gesamtluftmassenstrom durch die DK aus gemessenem Lambda und Soll-Kraftstoffmasse Mittelwert | kg/h | SwSABMW_TotAirmfByDK | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| OBDRADAR_NORMWERT_LSU_HEIZLEISTDIAG | 0x59E4 | STAT_OBDRADAR_NORMWERT_LSU_HEIZLEISTDIAG_WERT | Normierter Wert der LSU-Heizleistungsdiagnose für OBD-Radar | - | UEGO_ratNrmFltHeatrB1 | - | signed int | - | 0.00015259 | 1.0 | 0.0 | - | 22;2C | - | - |
| OBDRADAR_NORMWERT_LSU_PLAUSIDIAG | 0x59E5 | STAT_OBDRADAR_NORMWERT_LSU_PLAUSIDIAG_WERT | Normierter Wert der LSU-Plausibilitätsdiagnose für OBD-Radar | - | UEGO_ratNrmFltPlausB1 | - | signed int | - | 0.00015259 | 1.0 | 0.0 | - | 22;2C | - | - |
| OELDRUCK | 0x59E7 | STAT_OELDRUCK_WERT | Oeldruck | V | upmoel_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
| MITTLERE_SPG_RAILDRUCKSENSOR | 0x59E8 | STAT_MITTLERE_SPG_RAILDRUCKSENSOR_WERT | mittlere Spannung Raildrucksensor | V | uprm_w | - | unsigned int | - | 0.00030518 | 1.0 | 0.0 | - | 22;2C | - | - |
| FZG_GESCHWINDIGKEIT_VA_HA_FASCHWERP | 0x59EB | STAT_FZG_GESCHWINDIGKEIT_VA_HA_FASCHWERP_WERT | Fahrzeuggeschwindigkeit an der Vorder- oder Hinterachse oder im Fahrzeugschwerpunkt | km/h | vfzgv1anachse_w | - | unsigned int | - | 0.0078125 | 1.0 | 0.0 | - | 22;2C | - | - |
| QUOTIENT_MASSTROM_TEV_ZU_LUFTMASSTROM | 0x59EC | STAT_QUOTIENT_MASSTROM_TEV_ZU_LUFTMASSTROM_WERT | Verhältnis Massenstrom TEV 100% zu ml | - | vmstoml_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| WINKEL_DK_BEZ_AUF_UNTEREN_ANSCHLAG | 0x59ED | STAT_WINKEL_DK_BEZ_AUF_UNTEREN_ANSCHLAG_WERT | Drosselklappenwinkel bezogen auf unteren Anschlag | % DK | wdkba_w | - | signed int | - | 0.02441406 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_WINKEL_DK_BEZ_AUF_UNTEREN_ANSCHLAG | 0x59EF | STAT_S_WINKEL_DK_BEZ_AUF_UNTEREN_ANSCHLAG_WERT | Sollwert Drosselklappenwinkel, bezogen auf (unteren) Anschlag | % | wdks_w | - | unsigned int | - | 0.00152588 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANWS_I_AUSLASSSPREIZUNG | 0x59F1 | STAT_ANWS_I_AUSLASSSPREIZUNG_WERT | Istwert Auslaßspreizung | ° KW | wsprnwa_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| ENWS_I_EINLASSSPREIZUNG | 0x59F3 | STAT_ENWS_I_EINLASSSPREIZUNG_WERT | Istwert Einlaßspreizung | ° KW | wsprnwe_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| ANWS_S_AUSLASSSPREIZUNG | 0x59F5 | STAT_ANWS_S_AUSLASSSPREIZUNG_WERT | Sollwert Auslassspreizung variable NWS | ° KW | wsprnwsa_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| ENWS_S_AUSLASSSPREIZUNG | 0x59F7 | STAT_ENWS_S_AUSLASSSPREIZUNG_WERT | Sollwert Einlassspreizung variable NWS | ° KW | wsprnwse_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| AKKS_OEFFNUNGSZUSTAND | 0x59F9 | STAT_AKKS_OEFFNUNGSZUSTAND_WERT | Öffnungszustand der Kühlluftklappensteuerung (KKSLKS) | - | SwSABMW_stAKKS | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| I_ZUENDWINKEL | 0x59FA | STAT_I_ZUENDWINKEL_WERT | Ist-Zündwinkel | ° KW | zwist | - | signed char | - | 0.75 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZUENDWINKEL_AUSGABE | 0x59FC | STAT_ZUENDWINKEL_AUSGABE_WERT | Zündwinkel-Ausgabe | ° KW | zwout | - | signed char | - | 0.75 | 1.0 | 0.0 | - | 22;2C | - | - |
| S_ZUENDWINKEL | 0x59FD | STAT_S_ZUENDWINKEL_WERT | Soll-Zündwinkel aus Momenteneingriff | ° KW | zwsol | - | signed char | - | 0.75 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| 10 | Funktion mit Fehler beendet Fehler Verstellzeiten zu gross |
...
| WERT | TEXT |
| --- | --- |
| 1 | Tanktemperatur ausserhalb Bereich (TankEcu_tFlTnk) |
...
| 8 | Standby wegen nicht gueltigem Sensor |
