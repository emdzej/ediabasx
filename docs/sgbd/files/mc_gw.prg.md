...
| ECU Comment | Fuer die komplette Diagnose des MMI/GT ist die SGBD mmi_gt notwendig |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MOST/CAN-Gateway E65 (MC_GW) |  |  |
| ORIGIN | string | BMW TI-431 Dennert |  |  |
| REVISION | string | 1.05 |  |  |
| AUTHOR | string | BMW TI-431 Dennert, BMW EE-44 Muehlbauer, BMW TI-430 Gelfert |  |  |
| COMMENT | string | Fuer die komplette Diagnose des MMI/GT ist die SGBD mmi_gt notwendig |  |  |
| PACKAGE | string | 1.32 |  |  |
