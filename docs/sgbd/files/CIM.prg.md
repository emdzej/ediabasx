...
| ECU Comment | SGBD fuer Chassis Integrations Modul |
...
| AUTHOR | string | TEMIC L/B1/EF-N U.Strasser, BMW TI-431 Küssel, BMW TI-431 Atell |  |  |
| COMMENT | string | SGBD fuer Chassis Integrations Modul |  |  |
| PACKAGE | string | 1.32 |  |  |
