...
| ECU Comment | SGBD fuer E85 Cabrioverdeckmodul ab SW 2.3 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Cabrio-Verdeck-Modul IV E85 |  |  |
| ORIGIN | string | BMW EI-61 Kluge |  |  |
| REVISION | string | 1.03 |  |  |
| AUTHOR | string | HELBAKO E2 Spanner, BMW Drexel TI-433, Huber TI-433, Spoljarec TP-421, Dennert TI-431 |  |  |
| COMMENT | string | SGBD fuer E85 Cabrioverdeckmodul ab SW 2.3 |  |  |
| PACKAGE | string | 1.00 |  |  |
