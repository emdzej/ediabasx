...
| ECU Comment | Fuer die komplette Diagnose des MMI/GT Fond ist die SGBD mmifond notwendig |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MMI-Fond CAN Zugang (MMIFC) |  |  |
| ORIGIN | string | BMW EE-45 Schreiber |  |  |
| REVISION | string | 1.00 |  |  |
| AUTHOR | string | BMW EE-45 Schreiber, BMW TI-430 Gelfert |  |  |
| COMMENT | string | Fuer die komplette Diagnose des MMI/GT Fond ist die SGBD mmifond notwendig |  |  |
| PACKAGE | string | 1.32 |  |  |
