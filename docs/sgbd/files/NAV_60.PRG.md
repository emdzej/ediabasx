...
| ECU Comment | SGBD fuer Navigation Musterstand C0 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | NAV_60 fuer E60 |  |  |
| ORIGIN | string | Siemens VDO Automotive AG |  |  |
| REVISION | string | 0.10 |  |  |
| AUTHOR | string | Siemens VDO Automotive AG Lothar Weitzel |  |  |
| COMMENT | string | SGBD fuer Navigation Musterstand C0 |  |  |
| PACKAGE | string | 1.14 |  |  |
