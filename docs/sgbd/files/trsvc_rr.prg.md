...
| ECU Comment | TRSVC_RR 0x77 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Top, Rear, Sideview Kamera RR Serie II |  |  |
| ORIGIN | string | BMW L5-M-3 Stefan.Ruf |  |  |
| REVISION | string | 6.001 |  |  |
| AUTHOR | string | CEL R&D Sivarajah.Sivaganan, CEL R&D Rolf.Huppert, BMW EI-612 M |  |  |
| COMMENT | string | TRSVC_RR 0x77 |  |  |
| PACKAGE | string | 1.25 |  |  |
