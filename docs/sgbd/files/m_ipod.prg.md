...
| ECU Comment | iPod Interface which uses the CDC FBlocks |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MOST_CDC_IPOD_Interface |  |  |
| ORIGIN | string | BMW EI-41 Alexander Busch |  |  |
| REVISION | string | 0.006 |  |  |
| AUTHOR | string | Alpine Electronics AOGE-MN Michael Ramtke |  |  |
| COMMENT | string | iPod Interface which uses the CDC FBlocks |  |  |
| PACKAGE | string | 1.35 |  |  |
