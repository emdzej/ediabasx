...
| --- | --- | --- | --- | --- |
| ECU | string | EPS R56 (Mini) |  |  |
| ORIGIN | string | KSE KOYO EUROPE SW dept. LAURENT ANDING |  |  |
| REVISION | string | 0.044 |  |  |
| AUTHOR | string | KSE KOYO EUROPE SW LAURENT ANDING, BMW AG EF-61 Xaver Schillitz |  |  |
| COMMENT | string |  |  |  |
| PACKAGE | string | 1.23 |  |  |
