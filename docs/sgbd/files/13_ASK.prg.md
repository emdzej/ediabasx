...
| ECU Comment | Timeoutzeiten auf 1.5 sec, Spezialjob ENMT_AN_MCGW |
...
| REVISION | string | 2.5 |  |  |
| AUTHOR | string | BMW EE-41 Koenigseder, Knoebl |  |  |
| COMMENT | string | Timeoutzeiten auf 1.5 sec, Spezialjob ENMT_AN_MCGW |  |  |
| PACKAGE | string | 1.03 |  |  |
