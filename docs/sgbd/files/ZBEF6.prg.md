...
| ECU Comment | Neuanlage SGBD in SWL |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Zentrales Bedienelement Fond |  |  |
| ORIGIN | string | BMW EI-823 Andreas_Oellinger |  |  |
| REVISION | string | 1.001 |  |  |
| AUTHOR | string | PREH-GMBH EI-510 Braun |  |  |
| COMMENT | string | Neuanlage SGBD in SWL |  |  |
| PACKAGE | string | 1.70 |  |  |
