...
| ECU Comment | Zufügen funktionaler DTCs |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Frontlichtmodul links |  |  |
| ORIGIN | string | BMW EK-722 Viktor_Rack |  |  |
| REVISION | string | 2.200 |  |  |
| AUTHOR | string | LEAR-CORPORATION-GMBH EK-522 Huhn |  |  |
| COMMENT | string | Zufügen funktionaler DTCs |  |  |
| PACKAGE | string | 1.90 |  |  |
