...
| --- | --- | --- | --- | --- |
| ECU | string | SGBD zum Abgleich EWS4+6 und zum zuruecksetzsen des Lock-Zustandes in der DME, EGS, EME, EME20, AE, EMET, EMEZ, BDC (nur FGN) |  |  |
| ORIGIN | string | BMW EA-405 Ulrich_Schlachetzki |  |  |
| REVISION | string | 1.012 |  |  |
| AUTHOR | string | BMW EA-405 Ulrich_Schlachetzki |  |  |
| COMMENT | string |  |  |  |
| PACKAGE | string | 1.45 |  |  |
