...
| ECU Comment | MOST-Muster-SGBD fuer E65 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | genaue Bezeichnung des SG |  |  |
| ORIGIN | string | BMW Abteilung Name |  |  |
| REVISION | string | 0.13 |  |  |
| AUTHOR | string | Firma Abteilung Name |  |  |
| COMMENT | string | MOST-Muster-SGBD fuer E65 |  |  |
| PACKAGE | string | 1.03 |  |  |
