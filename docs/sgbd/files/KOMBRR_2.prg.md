...
| ECU Comment | SGBD fuer Kombi RR aus KOMB65_2 V0.08 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | KOMBI RR_2  |  |  |
| ORIGIN | string | Rolls-Royce-MotorCars L5-W-3 Stefan Ruf |  |  |
| REVISION | string | 2.001 |  |  |
| AUTHOR | string | Telemotive AG Bernd, Siemens (BD), Dietrich, Siemens EI-42 Neudecker, BMW UR-E-6 Ruf, BMW TI-431 Dennert |  |  |
| COMMENT | string | SGBD fuer Kombi RR aus KOMB65_2 V0.08  |  |  |
| PACKAGE | string | 1.29 |  |  |
