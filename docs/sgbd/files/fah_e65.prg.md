...
| ECU Comment | SGBD fuer Sitzsteuergeraet Hecksitz Fahrer |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Sitzsteuergeraet Hecksitz Fahrer E65 |  |  |
| ORIGIN | string | BMW EI-61 Jasny |  |  |
| REVISION | string | 1.00 |  |  |
| AUTHOR | string | TEMIC L/B2/ES Ahle |  |  |
| COMMENT | string | SGBD fuer Sitzsteuergeraet Hecksitz Fahrer |  |  |
| PACKAGE | string | 1.25 |  |  |
