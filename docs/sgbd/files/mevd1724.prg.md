...
| ECU Comment | SGBD für MEVD1724 und MEVD1729 C-Muster und Programmstand 9VS2G01B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Motorelektronik ME V17.2.4 4 Zylinder N20 |  |  |
| ORIGIN | string | BMW EA-360 Markus_Lorch |  |  |
| REVISION | string | 13.000 |  |  |
| AUTHOR | string | P-+-Z-ENGINEERING-GMBH EA-360 Berger |  |  |
| COMMENT | string | SGBD für MEVD1724 und MEVD1729 C-Muster und Programmstand 9VS2G01B |  |  |
| PACKAGE | string | 1.66 |  |  |
...
Auslesen der Betriebszustaende des Zweimassenschwungrades die in DMD zu Ausblendzeiten fuehren. BETRIEB_ZMS (0x22 4094)
...
Batterie Charge Unit (BCU) Informationen lesen SY_HYBRID_GEN3 == TRUE. BCU (0x22 409C)
...
### STEUERN_BCU_UEBERBRUECKUNG

Fuer Batterie Charge Unit (BCU), Ueberbrueckung der BCU Einheit vorgeben (Schalter geschlossen - (B_bcus2diaganf == TRUE)). SY_HYBRID_GEN3 == TRUE. BCU_UEBERBRUECKUNG (0x2F 03 6076)

| Name | Type | Description |
| --- | --- | --- |
| SW_BCU_UEBERBRUECKUNG_SCHALTER_AKT | unsigned char | Fuer BCU S2-Schalter (Ueberbrueckung) ein (TRUE) /ausschalten (FALSE) . Min: 0.0 Max: 1.0 a2l-Name: B_bcus2diag |

### STEUERN_ENDE_BCU_UEBERBRUECKUNG

Fuer Batterie Charge Unit (BCU), Ueberbrueckung der BCU Einheit vorgeben beenden (Schalter offen - (B_bcus2diaganf == FALSE)). BCU_UEBERBRUECKUNG (0x2F 00 6076)

_No arguments._

### STEUERN_BCU_USOLL

Fuer Batterie Charge Unit (BCU), Soll-Spannung vorgeben (B_bcusolldiaganf == TRUE && SY_HYBRID_GEN3 == TRUE.). BCU_USOLL (0x2F 03 6077)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_BCU_SOLL_SPANNUNG | real | Vorgabe des Spannungs-Sollwerts der BCU (14 ... 16V) . Einheit: V Min: 0.0 Max: 6553.5 a2l-Name: U_bcusolldiag |

### STEUERN_ENDE_BCU_USOLL

Fuer Batterie Charge Unit (BCU), Soll-Spannung vorgeben beenden (B_bcusolldiaganf == FALSE). BCU_USOLL (0x2F 00 6077)
...
Sekundaerluftpumpe ansteuern SLP (0x2F 03 60CB)

| Name | Type | Description |
| --- | --- | --- |
| SW_TV_SLP | string | Tastverhaeltniss Sekundaerluftpumpe Werttabelle 0/ = 0 1/ = 1 a2l-Name: B_slpet |
| SW_TO_SLP | unsigned long | Timeout Sekundaerluftpumpe Einheit: s Min: 0.0 Max: 510.0 |

### STEUERN_ENDE_SLP

Sekundaerluftpumpe Ansteuerung beenden SLP (0x2F 00 60CB)
...
### STOP_BETRIEBSART_EM1

E-Maschine 1 Betriebsart-Vorgabe ueber Tester beenden (B_akt_betriebsart_em1_steuern == FALSE setzen). + BETRIEBSART_EM1 (0x31 02 F086)

_No arguments._

### STATUS_BETRIEBSART_EM1

E-Maschine 1 Betriebsarten lesen. BETRIEBSART_EM1 (0x31 03 F086)

_No arguments._

### START_BETRIEBSART_EM1

E-Maschine 1 Betriebsarten vorgeben (B_akt_betriebsart_em1_steuern == TRUE setzen). Startvoraussetzungen: B_kl15 == TRUE. BETRIEBSART_EM1 (0x31 01 F086)

| Name | Type | Description |
| --- | --- | --- |
| BETRIEBSART_EM1 | unsigned char | E-Maschine 1 Betriebsart vorgeben. 0 = Standby 3 = DC-Spannungsregelung 5 = Drehzahlregelung mit Momentenvorsteuerng 6 = IHVBCTL - mit Momentenvorsteuerung 10 = Freilauf (A2L-NAME: Betriebsart_em1_steuern). Min: 0.0 Max: 10.0 a2l-Name: stptsen |

### STOP_BETRIEBSART_EM2

E-Maschine2/HV- Starter-Generator (Generator/EM fuer Stromerzeugung aus VM) Betriebsart-Vorgabe ueber Tester beenden (B_akt_betriebsart_em2_steuern == FALSE setzen). BETRIEBSART_EM2 (0x31 02 F087)

_No arguments._

### STATUS_BETRIEBSART_EM2

E-Maschine2/HV- Starter-Generator (Generator/EM fuer Stromerzeugung aus VM) Betriebsarten lesen. BETRIEBSART_EM2 (0x31 03 F087)

_No arguments._

### START_BETRIEBSART_EM2

E-Maschine2/HV- Starter-Generator (Generator/EM fuer Stromerzeugung aus VM) Betriebsarten vorgeben (B_akt_betriebsart_em2_steuern == TRUE setzen). Startvoraussetzungen: B_kl15 == TRUE. BETRIEBSART_EM2 (0x31 01 F087)

| Name | Type | Description |
| --- | --- | --- |
| BETRIEBSART_EM2 | unsigned char | E-Maschine 2 (Generator) - Betriebsart vorgeben. 0 = Standby 3 = DC-Spannungsregelung 5 = Drehzahlregelung mit Momentenvorsteuerng 6 = IHVBCTL - mit Momentenvorsteuerung 10 = Freilauf (A2L-NAME: Betriebsart_em2_steuern). Min: 0.0 Max: 10.0 |
...
| 0x11B120 | Ethanolsensor, elektrisch: Kurzschluss nach Plus | 0 |
| 0x11B121 | Ethanolsensor, elektrisch: Kurzschluss nach Masse | 0 |
| 0x11B122 | Ethanolsensor, Arbeitsbereich: Ethanolgehalt zu hoch | 0 |
| 0x11B123 | Ethanolsensor, Arbeitsbereich: Ethanolgehalt zu niedrig | 0 |
| 0x11B124 | Ethanolsensor, Eigendiagnose: Ethanolgehalt unplausibel | 0 |
| 0x11B125 | Ethanolsensor, Arbeitsbereich: Temperatur zu hoch | 0 |
| 0x11B126 | Ethanolsensor, Arbeitsbereich: Temperatur zu niedrig | 0 |
| 0x11B127 | Ethanolsensor, Eigendiagnose: Temperatur unplausibel | 0 |
| 0x11B128 | Ethanolsensor, Plausibilität: Ethanolgehalt unplausibel | 0 |
...
| 0x123514 | Elektrisches Wastegate: Warnschwelle Temperatur überschritten | 0 |
| 0x123515 | Elektrisches Wastegate: Temperatur zu hoch | 0 |
...
| 0x123609 | Elektrisches Wastegate, thermischer Überlastschutz: Warnschwelle überschritten | 0 |
| 0x12360B | Elektrisches Wastegate, thermischer Überlastschutz: Notlauf aktiv | 0 |
...
| 0x142003 | Zylinderausblendung auf Grund von Ladeluftkondensat | 0 |
| 0x142004 | Verbrennungsaussetzer: Volllast, Zwangshochschaltung | 0 |
| 0x142005 | Verbrennungsaussetzer: Volllast, Drehmoment reduziert | 0 |
...
| 0x160003 | Kurbelwellensensor, Signal: ungültig, Ersatzwertberechung internes Signal (Kurbelwelle Drehzhal): fehlgeschlagen | 1 |
...
| 0x195012 | Differenzdrucksensor, Tankentlüftung, Arbeitsbereich: Absolutdruck zu groß | 0 |
...
| 0x1B7101 | Bremsunterdrucksensor, Plausibilität: Differenzdruck zu niedrig | 0 |
...
| 0x1B8004 | EAC Sensor: Temperatur - Motorkühlmitteltemperatur Kühlerausgang, Vergleich, unplausibel zueinander | 0 |
| 0x1B8008 | EAC Sensor: Signaländerung, zu langsam | 0 |
| 0x1B8108 | EAC Sensor, Kodierung: falsch | 0 |
| 0x1B8201 | EAC Sensor, elektrisch: Kurzschluss nach Plus | 0 |
| 0x1B8204 | EAC Sensor, elektrisch: Kurzschluss nach Masse | 0 |
| 0x1B8208 | EAC Sensor, Arbeitsbereich: Temperatur unplausibel | 0 |
| 0x1B8302 | LIN, Kommunikation (EAC Sensor): fehlt | 0 |
| 0x1B8304 | LIN, Botschaft (EAC Sensor): Framefehler | 0 |
| 0x1B8308 | LIN, Kommunikation (EAC Sensor): Prüfsumme falsch | 0 |
...
| 0x1C3110 | Motoröl-Druck-Temperatursensor, elektrisch: Fehlfunktion | 0 |
| 0x1C3111 | Motoröl-Druck-Temperatursensor: defekt | 0 |
| 0x1C3112 | Motoröl-Druck-Temperatursensor, Plausibilität: Signal unplausibel | 0 |
| 0x1C3113 | Motoröl-Druck-Temperatursensor, Plausibilität: Signal unplausibel | 0 |
| 0x1C3114 | Motoröl-Druck-Temperatursensor, Plausibilität: Druck unplausibel | 0 |
| 0x1C3115 | Motoröl-Druck-Temperatursensor, Arbeitsbereich: Druck unplausibel | 0 |
| 0x1C3116 | Motoröl-Druck-Temperatursensor, Plausibilität: Temperatur unplausibel | 0 |
| 0x1C3117 | Motoröl-Druck-Temperatursensor, Arbeitsbereich: Temperatur unplausibel | 0 |
...
| 0x1D3702 | Powermanagement: Abbruch Notnachladen | 1 |
...
| 0x1E2000 | Motoröl, Kaltstart: Ethanolgehalt Warnschwelle 1 überschritten | 0 |
| 0x1E2001 | Motoröl, Kaltstart: Ethanolgehalt Warnschwelle 2 überschritten | 0 |
...
| 0x1F053E | DME, interner Fehler, Sicherheitsfunktion: Plausibilisierung Ethanolgehalt | 0 |
...
| 0x1F1A42 | DME, interner Fehler, Überwachung SPI-Kommunikation: Fehlfunktion an Baustein TLE6232/2 | 0 |
...
| 0x1F1B50 | Bordnetzspannung, DME-Hauptrelais: Spannung zu hoch | 0 |
...
| 0x1F4005 | Powermanagement: Relais Notstarteinrichtung dauerhaft geschlossen | 0 |
| 0x1F4006 | Powermanagement: Relais Notstarteinrichtung dauerhaft offen | 0 |
...
| 0x1FBD05 | Check-Control-Meldung (ID 807): Ladekabel abziehen | 0 |
| 0x1FBD06 | Check-Control-Meldung (ID 808): Ladekabel prüfen | 0 |
| 0x1FBD10 | Notlaufmanager: Anforderung Dauergong aufgrund Getriebefehler | 0 |
| 0x1FBE06 | Check-Control-Meldung (ID 908): Tank leer. Reduzierte Leistung | 0 |
...
| 0x20A703 | Motor-Kühlsystem: Bauteileschutz Temporäre Motorleistungsreduzierung | 0 |
...
| 0x20A820 | Motor-Kühlsystem: Kühlmitteldurchflussmenge nicht erreicht | 0 |
...
| 0x21501D | Spannung Intelligenter Batteriesensor 2, Spannung Batterieladeeinheit für Zustart: Spannungsunterschied zu groß | 0 |
...
| 0x218202 | Batterieladeeinheit für Zustart, Stromsensor, Plausibilität: Strom unplausibel | 0 |
| 0x218203 | Batterieladeeinheit für Zustart, Spannungssensor: Kurzschluss nach Plus | 0 |
| 0x218204 | Batterieladeeinheit für Zustart, Spannungssensor: Kurzschluss nach Masse | 0 |
| 0x218205 | Batterieladeeinheit für Zustart, Spannungssensor, Plausibilität: Spannung unplausibel | 0 |
| 0x218206 | Batterieladeeinheit für Zustart, Spannungssensor, Arbeitsbereich: Spannung zu hoch | 0 |
| 0x218207 | Batterieladeeinheit für Zustart, Spannungssensor, Arbeitsbereich: Spannung zu niedrig | 0 |
| 0x218208 | Batterieladeeinheit für Zustart, Temperatursensor: Kurzschluss nach Plus | 0 |
| 0x218209 | Batterieladeeinheit für Zustart, Temperatursensor, Plausibilität: Temperatur unplausibel | 0 |
| 0x21820A | Batterieladeeinheit für Zustart, Temperatursensor, Arbeitsbereich: Temperatur zu hoch | 0 |
| 0x21820B | Batterieladeeinheit für Zustart, Temperatursensor 2: Kurzschluss nach Plus | 0 |
| 0x21820C | Batterieladeeinheit für Zustart, Temperatursensor 2, Plausibilität: unplausibel | 0 |
| 0x21820D | Batterieladeeinheit für Zustart, Temperatursensor 2, Arbeitsbereich: Temperatur zu hoch | 0 |
| 0x21820E | Batterieladeeinheit für Zustart, Spannungssensor 2: Kurzschluss nach Plus | 0 |
| 0x21820F | Batterieladeeinheit für Zustart, Spannungssensor 2: Kurzschluss nach Masse | 0 |
| 0x218210 | Batterieladeeinheit für Zustart, Spannungssensor 2, Plausibilität: Spannung unplausibel | 0 |
| 0x218211 | Batterieladeeinheit für Zustart, Spannungssensor 2, Arbeitsbereich: Spannung zu hoch | 0 |
| 0x218212 | Batterieladeeinheit für Zustart, Spannungssensor 2, Arbeitsbereich: Spannung zu niedrig | 0 |
| 0x218214 | Batterieladeeinheit für Zustart: Interner Fehler | 0 |
| 0x218215 | Batterieladeeinheit für Zustart: Ladebetriebsunterbrechung aufgrund Übertemperatur/Überspannug/Unterspannung | 0 |
| 0x218216 | Batterieladeeinheit für Zustart, Ansteuerleitung: Kurzschluss nach Plus | 0 |
| 0x218217 | Batterieladeeinheit für Zustart, Sekundäre Batterie: defekt | 0 |
...
| 0x21A002 | Notlaufmanager: Anforderung Fahrbereitschaft Aufheben von Steuergerät Elektromaschine | 1 |
...
| 0x21A009 | Notlaufmanager: Anforderung Aktivierung Leerlaufregelung Verbrennungsmotor von Steuergerät Elektromaschine | 1 |
| 0x21A00A | Notlaufmanager: Anforderung Nullstromregelung von Steuergerät Elektromaschine | 1 |
| 0x21A00F | Notlaufmanager: Anforderung Verbrennungsmotor Abschaltverhinderer von Steuergerät Elektromaschine | 1 |
| 0x21A010 | Notlaufmanager: Anforderung Standby Elektromaschine von Steuergerät Elektromaschine | 1 |
| 0x21A011 | Notlaufmanager: Anforderung Deaktivierung Starteinrichtung Elektromaschine von Steuergerät Elektromaschine | 1 |
| 0x21A012 | Notlaufmanager: Getriebefehler während Hybridbetrieb von EGS erkannt | 1 |
| 0x21A013 | Notlaufmanager: Getriebefehler während E-Fahren von EGS erkannt | 1 |
| 0x21A014 | Notlaufmanager: mechanischer Notlauf Drehzahl zu niedrig | 1 |
| 0x21A015 | Notlaufmanager: elektischer Notlauf Drehzahlschwelle 2 unterschritten | 1 |
| 0x21A016 | Notlaufmanager: elektischer Notlauf Drehzahlschwelle 1 unterschritten | 1 |
| 0x21A017 | Notlaufmanager: Anforderung EGS Zwangshochschaltung Stufe 2 von Steuergerät Elektromaschine | 1 |
| 0x21A018 | Notlaufmanager: Anforderung EGS Zwangshochschaltung Stufe 3 von Steuergerät Elektromaschine | 1 |
| 0x21A01C | Notlaufmanager: Anforderung EGS Zwangshochschaltung Stufe 1 von Steuergerät Elektromaschine | 1 |
| 0x21A01D | Notlaufmanager: Getriebe Hybridablaufsteuerung fehlerhaft | 1 |
| 0x21A01E | Notlaufmanager: AE Ausfall erkannt | 1 |
| 0x21A01F | Notlaufmanager: Verbrennungsmotor nicht erkannt nach Startversuch | 1 |
| 0x21A020 | Notlaufmanager: EGS Ausfall erkannt | 1 |
| 0x21A021 | Notlaufmanager: Übertemperatur Hochvoltbatterie Schwelle 2 | 0 |
| 0x21A022 | Notlaufmanager: Übertemperatur Hochvoltbatterie Schwelle 1 | 0 |
| 0x21A023 | Verbrennungsmotor: Fehlstart oder Motor ausgegangen ohne Fahrereinfluss | 0 |
| 0x21A024 | Notlaufmanager: Getriebe Beschränkung auf Gang 1 | 1 |
| 0x21A110 | Motordrehmomentbegrenzung: infolge Notlaufanforderung vom Steuergerät Elektromaschine-Notlaufmanager | 1 |
| 0x21A111 | Motordrehzahlbegrenzung, Stufe 1: infolge Notlaufanforderung vom Steuergerät Elektromaschine-Notlaufmanager | 1 |
| 0x21A112 | Motordrehzahlbegrenzung, Stufe 2: infolge Notlaufanforderung vom Steuergerät Elektromaschine-Notlaufmanager | 1 |
| 0x21A113 | Motordrehzahlbegrenzung, Stufe 3: infolge Notlaufanforderung vom Steuergerät Elektromaschine-Notlaufmanager | 1 |
| 0x21A114 | Notlaufmanager: Freilauf und Deaktivierung Startsystem Elektromaschine | 1 |
| 0x21A117 | Notlaufmanager: Anforderung Verbrennungsmotor Einschaltaufforderer von Steuergerät Elektromaschine | 1 |
| 0x21A118 | Notlaufmanager: Anforderung Deaktivierung MSA von Steuergerät Elektromaschine | 1 |
| 0x21A119 | Notlaufmanager: Anforderung Deaktivierung MSA mit Check-Control-Meldung von Steuergerät Elektromaschine | 1 |
| 0x21A11A | Notlaufmanager: Anforderung Deaktivierung MSA mit Verbrennungsmotor Einschaltaufforderer von Steuergerät Elektromaschine | 1 |
| 0x21A11B | Notlaufmanager: Anforderung Deaktivierung MSA mit Verbrennungsmotor Einschaltaufforderer und Check-Control-Meldung von Steuergerät Elektromaschine | 1 |
| 0x21A11C | Notlaufmanager: Anforderung Verbrennungsmotor Einschaltverhinderer von Steuergerät Elektromaschine | 1 |
| 0x21A11D | Notlaufmanager: Anforderung Verbrennungsmotor MSA Abschaltaufforderer von Steuergerät Elektromaschine | 1 |
| 0x21A11F | Notlaufmanager: Anforderung Deaktivierung Anzeige verbrennungsmotorischen Reichweite von Steuergerät Elektromaschine | 1 |
| 0x21A120 | Notlaufmanager: Anforderung eines Verbrennungsmotorzustarts auf Grund von Automantikgetriebeanforderung | 1 |
| 0x21A121 | Notlaufmanager: Anforderung Neutralschaltung von EGS | 1 |
| 0x21A122 | Notlaufmanager: Anforderung Deaktivierung Zustarteinrichtung von Steuergerät Elektromaschine | 1 |
...
| 0x21A514 | Startsystem, Zahnriemenstarter, zweiter Start: Zeitüberschreitung | 0 |
| 0x21A515 | Startsystem, Zahnriemenstarter: Zeitüberschreitung | 0 |
| 0x21A519 | Durchfahrt tiefen Wassers erkannt | 0 |
| 0x21B000 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Schaltkreis - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B001 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Schaltkreis - niedrig | 1 |
| 0x21B002 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Schaltkreis - hoch | 1 |
| 0x21B003 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler - Druck unplausibel | 1 |
| 0x21B004 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Bereichs- oder Leistungsproblem - Druck zu hoch | 1 |
| 0x21B005 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Bereichs- oder Leistungsproblem - Druck zu niedrig | 1 |
| 0x21B006 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Temperatur unplausibel | 1 |
| 0x21B007 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Bereichs- oder Leistungsproblem - Untertemperatur | 1 |
| 0x21B008 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Bereichs- oder Leistungsproblem - Übertemperatur | 1 |
| 0x21B009 | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler - Drucksignal festliegend | 1 |
| 0x21B00A | DOBD-TFM-Kraftstofftank Drucksensor/Temperaturfühler Temperatur unplausibel | 1 |
| 0x21B00B | DOBD-TFM-Tankentlüftungssystem Tankfunktionsmodul Zeitgeber - Fehlfunktion | 1 |
| 0x21B00C | DOBD-TFM-Tankentlüftungssystem - sehr kleines Leck entdeckt | 1 |
| 0x21B00D | DOBD-TFM-Tankabsperrventil Steuerkreis - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B00E | DOBD-TFM-Tankabsperrventil Steuerkreis - niedrig | 1 |
| 0x21B00F | DOBD-TFM-Tankabsperrventil Steuerkreis - hoch | 1 |
| 0x21B010 | DOBD-TFM-Tankabsperrventil - klemmt offen | 1 |
| 0x21B011 | DOBD-TFM-Tankabsperrventil - klemmt geschlossen | 1 |
| 0x21B012 | DOBD-TFM-Tankabsperrventil Steuerkreis - niedrig | 1 |
| 0x21B013 | DOBD-TFM-Atmosphären Isolationsventil Steuerkreis - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B014 | DOBD-TFM-Atmosphären Isolationsventil Steuerkreis - niedrig | 1 |
| 0x21B015 | DOBD-TFM-Atmosphären Isolationsventil Steuerkreis - hoch | 1 |
| 0x21B016 | DOBD-TFM-Atmosphären Isolationsventil - klemmt offen | 1 |
| 0x21B017 | DOBD-TFM-Atmosphären Isolationsventil - klemmt geschlossen | 1 |
| 0x21B018 | DOBD-TFM-Atmosphären Isolationsventil Steuerkreis - niedrig | 1 |
| 0x21B019 | DOBD-TFM-Tankklappe Positionssensor/-schalter Schaltkreis - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B01A | DOBD-TFM-Tankklappe Positionssensor/-schalter Schaltkreis - niedrig | 1 |
| 0x21B01B | DOBD-TFM-Tankklappe Positionssensor/-schalter Schaltkreis - hoch | 1 |
| 0x21B01C | DOBD-TFM-Tankklappe - klemmt offen | 1 |
| 0x21B01D | DOBD-TFM-Tankklappe - klemmt geschlossen | 1 |
| 0x21B01E | DOBD-TFM-Tankklappe Positionssensor/-schalter Schaltkreis - hoch | 1 |
| 0x21B01F | DOBD-TFM-Tankklappe Öffnungsanforderungssensor/-schalter Schaltkreis - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B020 | DOBD-TFM-Tankklappe Öffnungsanforderungssensor/-schalter Schaltkreis - niedrig | 1 |
| 0x21B021 | DOBD-TFM-Tankklappe Öffnungsanforderungssensor/-schalter Schaltkreis - hoch | 1 |
| 0x21B022 | DOBD-TFM-Tankklappe Öffnungsanforderungssensor/-schalter - Leistungsproblem oder klemmt offen | 1 |
| 0x21B023 | DOBD-TFM-Tankklappe Öffnungsanforderungssensor/-schalter - klemmt geschlossen | 1 |
| 0x21B024 | DOBD-TFM-Tankklappe Verriegelungsteuerung - Fehlfunktion oder Leitungsunterbrechung | 1 |
| 0x21B025 | DOBD-TFM-Tankklappe Verriegelungsteuerung Schaltkreis - niedrig | 1 |
| 0x21B026 | DOBD-TFM-Tankklappe Verriegelungsteuerung Schaltkreis - hoch | 1 |
| 0x21B029 | DOBD-TFM-Tankklappe Verriegelungsteuerung Schaltkreis - niedrig | 1 |
| 0x21B02A | Aktive Kühlluftklappensteuerung (AKKS), Treiber: Fehlfunktion | 1 |
| 0x21B02B | Aktive Kühlluftklappensteuerung (AKKS), Treiber, elektrisch: Leitungsunterbrechung | 1 |
| 0x21B02C | Aktive Kühlluftklappensteuerung (AKKS), Treiber, elektrisch: Kurzschluss nach Plus | 1 |
| 0x21B02D | Aktive Kühlluftklappensteuerung (AKKS), Treiber, elektrisch: Kurzschluss nach Masse | 1 |
| 0x21B02E | Aktive Kühlluftklappensteuerung (AKKS), Versorgungsspannung: außerhalb OBD Diagnosebereich | 1 |
| 0x21B02F | Aktive Kühlluftklappensteuerung (AKKS): Ausfallsicherung aktiv | 1 |
| 0x21B030 | Aktive Kühlluftklappensteuerung (AKKS), Ausfallsicherung: Fehlfunktion | 1 |
| 0x21B031 | Automatische Kühlluftklappensteuerung (AKKS), Haltemagnet, Ausfallsicherung: Fehlfunktion | 1 |
| 0x21B032 | Aktive Kühlluftklappensteuerung (AKKS), Mikroprozessor, Temperatursignal: fehlt | 1 |
| 0x21B033 | Aktive Kühlluftklappensteuerung (AKKS), Mikroprozessor, Plausibilität: Temperatur unplausibel | 1 |
| 0x21B034 | Aktive Kühlluftklappensteuerung (AKKS), Mikroprozessor, Plausibilität: Temperatur außerhalb gültigem Bereich | 1 |
| 0x21B035 | Aktive Kühlluftklappensteuerung (AKKS), Mikroprozessor, Arbeitsbereich: Temperatur zu hoch | 1 |
| 0x21B036 | Aktive Kühlluftklappensteuerung (AKKS), Mikroprozessor, Arbeitsbereich: Temperatur zu niedrig | 1 |
| 0x21B038 | Aktive Kühlluftklappensteuerung (AKKS), Motor, Arbeitsbereich: Temperatur zu hoch | 1 |
| 0x21B03A | Aktive Kühlluftklappensteuerung (AKKS), Motor: Warnschwelle Temperatur überschritten | 1 |
| 0x21B03B | Aktive Kühlluftklappensteuerung (AKKS), Versorgungsspannung, Plausibilität: Spannung unplausibel | 1 |
| 0x21B03C | Aktive Kühlluftklappensteuerung (AKKS), Versorgungsspannung, Arbeitsbereich: Spannung zu hoch | 1 |
| 0x21B03D | Aktive Kühlluftklappensteuerung (AKKS), Positionssensor: Fehlfunktion | 1 |
| 0x21B03E | Aktive Kühlluftklappensteuerung (AKKS), Positionssensor, elektrisch: Leitungsunterbrechung | 1 |
| 0x21B03F | Aktive Kühlluftklappensteuerung (AKKS), Positionssensor, elektrisch: Kurzschluss nach Plus | 1 |
| 0x21B040 | Aktive Kühlluftklappensteuerung (AKKS), Positionssensor, elektrisch: Kurzschluss nach Masse | 1 |
| 0x21B041 | Aktive Kühlluftklappensteuerung (AKKS), Versorgungsspannung, Arbeitsbereich: Spannung zu niedrig | 1 |
...
| 0x234A05 | A-CAN, Botschaft (Modus Spannungsgesteuert, 0x432): fehlt | 0 |
...
| 0xCD8B05 | FlexRay, Botschaft (Status DCDC, 125.0.2): fehlt | 1 |
...
| 0xCD8F04 | LIN, Kommunikation (Ladeeinheit für Zustarteinrichtung): fehlt | 0 |
...
| 0xCD9462 | FlexRay, Botschaft (Vorgabe Drehmoment Betriebsstrategie, 94.1.2): fehlt | 1 |
| 0xCD9463 | FlexRay, Botschaft (Status E-Motor Traktion, 238.1.2): fehlt | 1 |
| 0xCD9464 | FlexRay, Botschaft (Status Betriebsart E-Motor Traktion, 94.0.2): fehlt | 1 |
| 0xCD9465 | FlexRay, Botschaft (Längsbeschleunigung Schwerpunkt, 55.0.2): Signalfehler | 1 |
...
| 0xCD9730 | FlexRay, Botschaft (Daten Zusatzbatterie, 262.2.4): fehlt | 1 |
...
| 0xCD9A10 | FlexRay, Botschaft (Status Kontakt Handbremse, 243.1.2): fehlt | 1 |
...
| 0xCD9C12 | A-CAN, Botschaft (Vorgabe Drehmoment Traktion Langzeit, 0x13E): fehlt | 1 |
...
| 0xCD9F10 | FlexRay, Botschaft (Status Daten E-Motor 1, 238.0.2): fehlt | 1 |
| 0xCD9F11 | FlexRay, Botschaft (Status Stabilisierung DSC, 47.1.2): Signalfehler | 0 |
| 0xCD9F12 | FlexRay, Botschaft (Konfiguration Schalter Fahrdynamik, 272.4.8): Signalfehler | 1 |
...
| 0xCDA437 | FlexRay, Botschaft (Bedienung Taster Elektrisches Fahrzeug, 137.0.2): fehlt | 1 |
...
| 0xCDA498 | FlexRay, Botschaft (Status E-Motor Traktion, 238.1.2): Signalfehler | 1 |
| 0xCDA509 | FA-CAN, Botschaft (Steuerung Crash, 0x19B): fehlt | 1 |
...
| 0xCDA516 | FA-CAN,  Signal (ST_CT_BON, ZV und Klappenzustand, 0x2FC), Ersatzwert: ungültig | 1 |
| 0xCDA518 | FA-CAN, Botschaft (Status Gurt Kontakt Sitzbelegung, 0x297): Prüfsumme falsch | 1 |
| 0xCDA520 | FA-CAN, Botschaft (Status Drucktank, 0x2E7): fehlt | 1 |
| 0xCDA521 | FlexRay,Botschaft (Vorgabe Drehmoment Betriebsstrategie Traktion, 94.1.2): fehlt | 1 |
...
| 0xCDA56F | A-CAN, Signal (TAR_RPM_ENG_CRSH_GRB, Anforderung Drehmoment Kurbelwelle Getriebe, 0xB0): ungültig, Ersatzwertberechung internes Signal (Solldrehzahl Verbrennungsmotor): fehlgeschlagen | 1 |
| 0xCDA643 | FA-CAN, Botschaft (Status Drucktank, 0x2E7): Prüfsumme falsch | 1 |
| 0xCDA644 | FA-CAN, Botschaft (Status Drucktank, 0x2E7): Aliveprüfung | 1 |
| 0xCDA665 | A- / FA-CAN, Signal (ST_GRSEL_GRB, Status Getriebesteuergerät, 0x39A): ungültig, Ersatzwertberechung internes Signal (Ist Fahrstufe): fehlgeschlagen | 1 |
| 0xCDA666 | A- / FA-CAN, Signal (ST_GRSEL_GRB, Status Getriebesteuergerät, 0x39A): ungültig, Ersatzwertberechung internes Signal (Gang Getriebe 1): fehlgeschlagen | 1 |
| 0xCDA667 | A- / FA-CAN, Signal (ST_GRSEL_GRB, Status Getriebesteuergerät, 0x39A): ungültig, Ersatzwertberechung internes Signal (Gesamtübersetzung Hybridachse, Elektromaschine bis Rad): fehlgeschlagen | 1 |
| 0xCDA668 | A- / FA-CAN,  Signal (ST_GRSEL_GRB, Status Getriebesteuergerät, 0x39A): ungültig, Ersatzwertberechung internes Signal (Übersetzung Getriebe verbrennungsmotorische Achse): fehlgeschlagen | 1 |
| 0xCDA669 | A- / FA-CAN,  Signal (ST_GRSEL_GRB, Status Getriebesteuergerät, 0x39A): ungültig, Ersatzwertberechung internes Signal (Getriebeübersetzung, Verbrennungsmotor bis Rad): fehlgeschlagen | 1 |
| 0xCDA66D | FA-CAN, Botschaft (Status Diagnose OBD 6 Antriebsstrang, 0x3CD): fehlt | 1 |
| 0xCDA66F | A-CAN, Signal (REIN_GRDT, Daten Getriebestrang, 0x1AF): ungültig, Ersatzwertberechung internes Signal (Gesamtübersetzung Hinterachse): fehlgeschlagen | 1 |
| 0xCDA670 | A-CAN, Signal (VRFD_TORQ_AVL_MOT_1, Abgesichert Ist Daten Kurzzeit E-Motor 1, 0xCD): ungültig, Vorgabe konstanter Ersatzwert (Ist Moment Antriebselektromaschine) | 1 |
| 0xCDA672 | Kommunikation, Signale: ungültig, Ersatzwertberechung internes Signal (Drehzahl Antriebselektromaschine): fehlgeschlagen | 1 |
| 0xCDA677 | FA-CAN, Signal (ST_PENG_GRB, Status Getriebestrang, 0x1AC): ungültig, Vorgabe konstanter Ersatzwert (Kraftschluss Getriebe Verbrennungsmotorische Achse) | 1 |
| 0xCDA679 | Kommunikation, Signale: ungültig, Ersatzwertberechung internes Signal (Fahrzeuggeschwindigkeit):fehlgeschlagen | 1 |
| 0xCDA67B | A-CAN, Signal (PCN_TORQ_MAX_MOT_1_STAT_OSTR, 0x13E): ungültig, Vorgabe Ersatzwert (kurzzeitige maximale Momentengrenze Antriebsstrategie Elektromaschine verbrennungsmotorischer angetriebenen Achse) | 1 |
| 0xCDA67C | A-CAN, Signal (PCN_TORQ_MIN_MOT_1_STAT_OSTR, 0x13E), ungültig, Vorgabe Ersatzwert (kurzzeitige minimale Momentengrenze Antriebsstrategie Elektromaschine verbrennungsmotorischer angetriebenen Achse) | 1 |
...
| 0xCDA682 | FA-CAN, Botschaft (Status Diagnose OBD 6 Antriebsstrang, 0x3CD): Aliveprüfung | 1 |
...
| 0xCDBA25 | FA-CAN, Botschaft (Diagnose OBD Motorsteuerung Elektrisch, 0x3E8): fehlt, Sender EME | 1 |
...
| 0xCDBB13 | FA-CAN, Botschaft (Soll Daten Getriebe E-Motor 1, 0x91): Aliveprüfung | 1 |
| 0xCDBB14 | FA-CAN, Botschaft (Soll Daten Getriebe E-Motor 1, 0x91): Prüfsumme falsch | 1 |
| 0xCDBB15 | FA-CAN, Botschaft (Soll Daten Getriebe E-Motor 1, 0x91): fehlt | 1 |
...
| 0xCDBD0A | A-CAN, Botschaft (Steuerung Teilnetze, 0x19E): fehlt | 1 |
...
| 0xCDC203 | A-CAN, Botschaft (Status Hochvoltspeicher 2, 0x112): fehlt | 1 |
...
| 0xCDDB09 | FlexRay, Botschaft (Ist Drehzahl Rad, 46.0.1): Signalfehler | 0 |
...
| 0x5711 | Bedingung ZMS stört Laufunruhe kritisch bzgl. katschädigender Schwelle | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x578F | [0] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaption | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5790 | [1] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5793 | [2] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5794 | [3] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
...
| 0x57AD | Luftmassenstrom HFM, korrigiert und gefiltert (fr Berechnung Regeldifferenz Massenstromregler) | kg/h | - | unsigned int | - | 0.03125 | 1.0 | 0.0 |
...
| 0x580A | Temperaturwert RIS-Sensor LIN  | °C | - | unsigned int | - | 0.09375 | 1.0 | 5.0 |
...
| 0x5883 | [0]Spannung Klopfwert Zylinder 1 | V | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 |
| 0x5884 | Grenzerregerstrom E-Maschine 1 | A | - | unsigned char | - | 0.125 | 1.0 | 0.0 |
| 0x5885 | [1]Spannung Klopfwert Zylinder 3 | V | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 |
| 0x5887 | Auslastungsgrad Generator 1 | - | - | unsigned int | - | 0.005 | 1.0 | 0.0 |
| 0x5888 | [2]Spannung Klopfwert Zylinder 4 | V | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 |
...
| 0x5894 | [3]Spannung Klopfwerte Zylinder 2 | V | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 |
...
| 0x589B | Bedingung unzulössig hoher Motorstrom bei Kurzschluss erkannt | 0/1 | - | 0xFF | - | 1.0 | 1.0 | 0.0 |
...
| 0x58B2 | [1]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 3 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58B3 | [2]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 4 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58B4 | [3]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 2 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
...
| 0x58E6 | [1] Gefilterte Funkenbrenndauer Zylinder 3 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E7 | [2] Gefilterte Funkenbrenndauer Zylinder 4 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x58E8 | [3] Gefilterte Funkenbrenndauer Zylinder 2 | ms | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
...
| 0x590F | Status Fehlerspeichereintrag ohne kritische ZMS Störung | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0x5919 | Fehlerstatus E-Maschine | HEX | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x591F | Abgleich Drosselklappenmodell (Offset) LOW Byte | - | - | signed char | - | 0.25 | 1.0 | 0.0 |
| 0x5920 | Abgleich Einlassventilmodell (Offset) LOW Byte | - | - | signed char | - | 0.25 | 1.0 | 0.0 |
...
| 0x5938 | Ethanolgehalt, Rohwert vom Sensor | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5939 | Ethanolgehalt am Einspritzventil | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
...
| 0x5948 | Korrekturfaktor Kraftstoffmischung für Einspritzzeit | - | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 |
| 0x5953 | Intervalle mit kritischen ZMS-Stoerungen | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x5954 | Intervalle mit kritischen ZMS-Stoerungen ueber Lebenszeit | - | - | unsigned long | - | 1.0 | 1.0 | 0.0 |
| 0x5955 | Spannung hinter Zünd- Einspritzrelais | V | - | unsigned char | - | 0.1 | 1.0 | 0.0 |
| 0x5960 | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Aadaption und mit Hubprädiktion) | mm | - | unsigned int | - | 0.001 | 1.0 | 0.0 |
| 0x5989 | Ladeendegrund für das zyklische Nachladen | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x598E | Status der Nachladeanforderung | - | - | unsigned char | - | 1.0 | 1.0 | 0.0 |
...
| 0xCD8B05 | FlexRay, Botschaft (Status DCDC, 125.0.2): fehlt | 0 |
...
| 0xCD9437 | FlexRay, Botschaft (Anforderung Radmoment Antriebstrang Summe Stabilisierung / Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4) bei Unterspannung: Kommunikationsfehler | 1 |
| 0xCD944D | FlexRay, Botschaft (Ist Drehzahl Rad, 46.0.1): Signalfehler | 1 |
| 0xCD9462 | FlexRay, Botschaft (Vorgabe Drehmoment Betriebsstrategie, 94.1.2): fehlt | 0 |
| 0xCD9463 | FlexRay, Botschaft (Status E-Motor Traktion, 238.1.2): fehlt | 0 |
| 0xCD9464 | FlexRay, Botschaft (Status Betriebsart E-Motor Traktion, 94.0.2): fehlt | 0 |
| 0xCD9465 | FlexRay, Botschaft (Längsbeschleunigung Schwerpunkt, 55.0.2): Signalfehler | 1 |
| 0xCD9502 | FlexRay, Botschaft (Anforderung Radmoment Antriebstrang Summe Stabilisierung / Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4): Aliveprüfung | 1 |
| 0xCD9504 | FlexRay, Botschaft (Anforderung Radmoment Antriebstrang Summe Stabilisierung / Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4): fehlt | 1 |
| 0xCD9508 | FlexRay, Botschaft (Anforderung Radmoment Antriebstrang Summe Stabilisierung / Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4): Prüfsumme falsch | 1 |
...
| 0xCD9B04 | FlexRay, Botschaft (Ist Drehzahl Rad, 46.1.2): fehlt | 1 |
| 0xCD9B08 | FlexRay, Botschaft (Ist Drehzahl Rad, 46.1.2): Prüfsumme falsch | 1 |
| 0xCD9C12 | A-CAN, Botschaft (Vorgabe Drehmoment Traktion Langzeit, 0x13E): fehlt | 0 |
| 0xCD9D02 | FlexRay, Botschaft (Längsbeschleunigung Schwerpunkt, 55.0.2): Aliveprüfung | 1 |
| 0xCD9D04 | FlexRay, Botschaft (Längsbeschleunigung Schwerpunkt, 55.0.2): fehlt | 1 |
| 0xCD9D08 | FlexRay, Botschaft (Längsbeschleunigung Schwerpunkt, 55.0.2): Prüfsumme falsch | 1 |
| 0xCD9E02 | FlexRay, Botschaft (Querbeschleunigung Schwerpunkt, 55.0.2): Aliveprüfung | 1 |
...
| 0xCD9F04 | FlexRay, Botschaft (Status Stabilisierung DSC, 47.1.2): fehlt | 1 |
| 0xCD9F08 | FlexRay, Botschaft (Status Stabilisierung DSC, 47.1.2): Prüfsumme falsch | 1 |
| 0xCD9F10 | FlexRay, Botschaft (Status Daten E-Motor 1, 238.0.2): fehlt | 0 |
| 0xCD9F11 | FlexRay, Botschaft (Status Stabilisierung DSC, 47.1.2): Signalfehler | 1 |
...
| 0xCDA432 | FlexRay, Botschaft (Daten Hybrid / Betriebsart Drehzahl Drehmoment Hybrid, 73.0.2): fehlt | 1 |
| 0xCDA435 | FlexRay, Botschaft (Masse/Gewicht Fahrzeug, 108.1.2): fehlt | 1 |
| 0xCDA437 | FlexRay, Botschaft (Bedienung Taster Elektrisches Fahrzeug, 137.0.2): fehlt | 0 |
| 0xCDA451 | FlexRay, Botschaft (Ist Lenkmoment Fahrer Stellglied, 49.0.2): fehlt | 1 |
| 0xCDA452 | FlexRay, Botschaft (Ist Kraft Zahnstange, 49.0.2): fehlt | 1 |
| 0xCDA491 | FlexRay, Botschaft (Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4): Aliveprüfung | 1 |
| 0xCDA492 | FlexRay, Botschaft (Soll Verteilung Längsmoment Vorderachse Hinterachse, 43.1.4): Prüfsumme falsch | 1 |
...
| 0xCDA516 | FA-CAN,  Signal (ST_CT_BON, ZV und Klappenzustand, 0x2FC), Ersatzwert: ungültig | 1 |
| 0xCDA518 | FA-CAN, Botschaft (Status Gurt Kontakt Sitzbelegung, 0x297): Prüfsumme falsch | 1 |
| 0xCDA520 | FA-CAN, Botschaft (Status Drucktank, 0x2E7): fehlt | 0 |
| 0xCDA521 | FlexRay,Botschaft (Vorgabe Drehmoment Betriebsstrategie Traktion, 94.1.2): fehlt | 0 |
| 0xCDA524 | FA-CAN, Botschaft (Status Elektrische Kraftstoffpumpe, 0x335): fehlt | 1 |
| 0xCDA525 | FA-CAN, Botschaft (Status Elektrische Kraftstoffpumpe, 0x335): Signalfehler | 1 |
| 0xCDA56F | A-CAN, Signal (TAR_RPM_ENG_CRSH_GRB, Anforderung Drehmoment Kurbelwelle Getriebe, 0xB0): ungültig, Ersatzwertberechung internes Signal (Solldrehzahl Verbrennungsmotor): fehlgeschlagen | 1 |
| 0xCDA643 | FA-CAN, Botschaft (Status Drucktank, 0x2E7): Prüfsumme falsch | 1 |
...
| 0x00 | ERROR |
| 0x01 | ERROR_DIAGSG |
| 0x02 | ERROR_FALSCHE_LÄNGE_ODER_AUSWERTUNG |
| 0x03 | Fehler Laenge Argument Ungueltig |
| 0x1001 | Fehler Argument in Tabelle nicht vorhanden |
| 0x1002 | Fehler Argument nicht vorhanden |
| 0x1003 | Fehler |
| 0x1004 | Fehler Resultwert ausserhalb gueltigem Bereich |
| 0x1005 | Fehler |
| 0x1006 | Fehler Rueckgabe Job fehlerhaft |
| 0x1007 | Fehler Rueckgabe Service fehlerhaft |
| 0x1008 | Fehler physikalischer Wert ausserhalb gueltigem Bereich |
| 0x1009 | Fehler |
| 0x100A | Fehler Unterlauf Fehler |
| 0x100B | Fehler Joblaenge falsch |
| 0x100C | Fehler |
| 0x100E | Fehler Argument Wert im negativ Bereich |
...
| 0x3014 | RESET_SWRESET_MOCMEM_CPL |
| 0x3015 | RESET_SWRESET_MOCMEM_RAM |
| 0x3016 | RESET_SWRESET_MOCMEM_ROM |
| 0x3017 | RESET_SWRESET_MOCPCP |
| 0x3018 | RESET_SWRESET_MOCRAM_WRI |
| 0x3019 | RESET_SWRESET_MOCRAM_CPL |
| 0x301A | RESET_SWRESET_MOCRAM_RAMTAB |
| 0x301B | RESET_SWRESET_MOCRAM_RSTPTRRAM |
| 0x301C | RESET_SWRESET_MOCRAM_STACKRAM |
| 0x301D | RESET_SWRESET_MOCRAM_CSARAM |
| 0x301E | RESET_SWRESET_MOCRAM_XRAM |
| 0x301F | RESET_SWRESET_MOCRAM_IRAM |
| 0x3020 | RESET_SWRESET_MOCRAM_EXRAM |
| 0x3021 | RESET_SWRESET_MOCRAM_PROTRAM |
| 0x3022 | RESET_SWRESET_MOCRAM_EEPCPL |
| 0x3023 | RESET_SWRESET_MOCRAM_REPEXOK |
| 0x3024 | RESET_SWRESET_MOCROM |
| 0x3025 | RESET_SWRESET_MOCROM_CPL |
| 0x3026 | RESET_SWRESET_MOCROM_INDEX |
| 0x3027 | RESET_SWRESET_MOCROM_WD |
| 0x3028 | RESET_SWRESET_SOPTEST_FAILED |
| 0x3029 | RESET_SWRESET_CPLCHK_FAILED |
| 0x302A | RESET_SWRESET_MOCSOP_MSC_ERROR |
| 0x302B | RESET_SWRESET_MOCSOP_SPI_ERROR |
| 0x302C | RESET_SWRESET_MOCSOP_OS_TIMEOUT_ERROR |
| 0x302D | RESET_SWRESET_MOCSOP_TIRESPTIME_ERROR |
| 0x302E | SWRESET_MOFAIR_ADJ_PREICO |
| 0x302F | SWRESET_MOFRKTI_PREICO |
| 0x3030 | SWRESET_MOFGKC_PREICO |
| 0x3031 | SWRESET_MOFRLC_PREICO |
| 0x3032 | SWRESET_MOFMODC_PREICO |
| 0x3033 | SWRESET_MOFAPP_PREICO |
| 0x3034 | SWRESET_MOFESPD_PREICO |
| 0x3035 | SWRESET_MOFZWC_PREICO |
| 0x3036 | RESET_SWRESET_MOFICO_CHK_SYEGAS_FAILED |
| 0x3037 | SWRESET_MOFTRQCMP_PREICO |
| 0x3038 | SWRESET_MOFTRQRAT_PREICO |
| 0x3039 | SWRESET_MOFTX_PREICO |
...
| STAT_0x4206_WERT | 0x4206 | STAT_0X4206_WERT | Massenstrom über Drosselklappe Bank 1 | kg/h | Msdk_i | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
| ITKUM | 0x4300 | STAT_KUEHLMITTELTEMPERATUR_WERT | Motor-Temperatur | °C | tmot | - | unsigned char | - | 0.75 | 1.0 | -48.0 | - | 22;2C | - | - |
| SNWAP | 0x4306 | STAT_WASSERPUMPE_DREHZAHL_SOLL_WERT | Bestätigte Solldrehzahl elektr. Wasserpumpe (Achtung nur bei BSD!) | 1/min | Layer_nEwpDes | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IAVEX | 0x4501 | STAT_VVT_EXCENTER_ADAPTION_WERT | Excenterwellenadaption | - | hubadmrofs_w | - | signed int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4522_WERT | 0x4522 | STAT_0X4522_WERT | [0]Sollkraftstoffmassen Zylinder 1 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4523_WERT | 0x4523 | STAT_0X4523_WERT | [1]Sollkraftstoffmassen Zylinder 3 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4524_WERT | 0x4524 | STAT_0X4524_WERT | [2]Sollkraftstoffmassen Zylinder 4 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4525_WERT | 0x4525 | STAT_0X4525_WERT | [3]Sollkraftstoffmassen Zylinder 2 | mg/stroke | mkhs_w | - | unsigned int | - | 0.02119478 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4530_WERT | 0x4530 | STAT_0X4530_WERT | [0]Aktueller Einspritzmodus Zylinder 1 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4531_WERT | 0x4531 | STAT_0X4531_WERT | [1]Aktueller Einspritzmodus Zylinder 3 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4532_WERT | 0x4532 | STAT_0X4532_WERT | [2]Aktueller Einspritzmodus Zylinder 4 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4533_WERT | 0x4533 | STAT_0X4533_WERT | [3]Aktueller Einspritzmodus Zylinder 2 | - | esprmodi | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4538_WERT | 0x4538 | STAT_0X4538_WERT | [0] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4539_WERT | 0x4539 | STAT_0X4539_WERT | [1] Mittlerer Versatz der äquidistanten Flanken der Nockenwelle | ° KW | EpmCaS_phiDiffAvrg | - | signed int | - | 0.02197266 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4602_WERT | 0x4602 | STAT_0X4602_WERT | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Aadaption und mit Hubprädiktion) | mm | Hubev_ist | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4603_WERT | 0x4603 | STAT_0X4603_WERT | Sollwert Einlassventilhub gefiltert | mm | Hubev_soll | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4615_WERT | 0x4615 | STAT_0X4615_WERT | Grenzerregerstrom | A | isgusmierrgrenz_w | - | unsigned int | - | 0.00125 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x471B_WERT | 0x471B | STAT_0X471B_WERT | NVLD: Zähler Leckdiagnose nicht durchgeführt auf Grund Tankfüllstand über Schwelle | - | SwSABMW_cntSmlLeakDgnsAbvThd | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4804_WERT | 0x4804 | STAT_0X4804_WERT | Motorhaubensignal in Ordnung | - | BasSvrAppl_stHoodOpenSigOk | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4882_WERT | 0x4882 | STAT_0X4882_WERT | Zähler Startabbrüche oder Ausgeher nach Schlüsselstart, LR inaktiv | - | SwSABMW_CntrDetdFaildStrtOnlyKeyStrt | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| FEOCNTR | 0x4897 | STAT_FEOCNTR_WERT | Verbrennungsmotorbetrieb Zündzykluszähler für Infotyp $12 | - | - | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A00_WERT | 0x4A00 | STAT_0X4A00_WERT | Mittelwert Strecke zwischen kritischen ZMS Störungen | km | MisfDet_MeanDstBtwCritDsbcDmf | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4A01_WERT | 0x4A01 | STAT_0X4A01_WERT | Mittelwert Zeitintervall zwischen kritischen ZMS Störungen | min | MisfDet_MeanTiBtwCritDsbcDmf | - | unsigned int | - | 10.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| ILUZ1 | 0x4A30 | STAT_LAUFUNRUHE_ZYL1_WERT | [0]Laufunruhe Zylinder 1 | 1/s² | lutskzyl_w | - | signed int | - | 0.00710545 | 1.0 | 0.0 | - | 22;2C | - | - |
| ILUZ4 | 0x4A32 | STAT_LAUFUNRUHE_ZYL4_WERT | [2]Laufunruhe Zylinder 4 | 1/s² | lutskzyl_w | - | signed int | - | 0.00710545 | 1.0 | 0.0 | - | 22;2C | - | - |
| ILUZ3 | 0x4A34 | STAT_LAUFUNRUHE_ZYL3_WERT | [1]Laufunruhe Zylinder 3 | 1/s² | lutskzyl_w | - | signed int | - | 0.00710545 | 1.0 | 0.0 | - | 22;2C | - | - |
| ILUZ2 | 0x4A35 | STAT_LAUFUNRUHE_ZYL2_WERT | [3]Laufunruhe Zylinder 2 | 1/s² | lutskzyl_w | - | signed int | - | 0.00710545 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IUKZ4 | 0x4A39 | STAT_KLOPFWERT_ZYL4_SPANNUNG_WERT | [2]normierter Referenzpegel Klopfregelung Zylinder 4 | V | rkrnv6_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
| IUKZ3 | 0x4A3B | STAT_KLOPFWERT_ZYL3_SPANNUNG_WERT | [1]normierter Referenzpegel Klopfregelung Zylinder 3 | V | rkrnv6_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
| IUKZ2 | 0x4A3C | STAT_KLOPFWERT_ZYL2_SPANNUNG_WERT | [3]normierter Referenzpegel Klopfregelung Zylinder 2 | V | rkrnv6_w | - | unsigned int | - | 0.00488281 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZWZ1 | 0x4A49 | STAT_ZUENDWINKEL_ZYL1_WERT | [0]Zuendwinkel Zylinder 1 | ° KW | zwoutzyl_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZWZ3 | 0x4A4A | STAT_ZUENDWINKEL_ZYL3_WERT | [1]Zuendwinkel Zylinder 3 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZWZ4 | 0x4A4C | STAT_ZUENDWINKEL_ZYL4_WERT | [2]Zuendwinkel Zylinder 4 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZWZ2 | 0x4A4D | STAT_ZUENDWINKEL_ZYL2_WERT | [3]Zuendwinkel Zylinder 2 | ° KW | zwoutzyln_w | - | signed int | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x4B31_WERT | 0x4B31 | STAT_0X4B31_WERT | [1]Zaehler Aussetzerkennung Zylinder 3 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x4B32_WERT | 0x4B32 | STAT_0X4B32_WERT | [3]Zaehler Aussetzerkennung Zylinder 2 | - | fzabgzyl_w | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| BED_NOTL_WAPU | 0x570A | STAT_BED_NOTL_WAPU_WERT | Bedingung Notlauf Wasserpumpe | - | B_nlwapu_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| BED_ZMS_DIST_KRIT_KAT | 0x5711 | STAT_BED_ZMS_DIST_KRIT_KAT_WERT | Bedingung ZMS stört Laufunruhe kritisch bzgl. katschädigender Schwelle | - | B_zmsdisturbcrit_byte | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL1 | 0x578F | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL1_WERT | [0] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag (ungefilterte Adaption | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL2 | 0x5790 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL2_WERT | [1] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL3 | 0x5793 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL3_WERT | [2] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL4 | 0x5794 | STAT_LAMBDAABWEICHUNG_ADAP_ROH_LOG_CYL4_WERT | [3] Zylinderindividuelle Lambdaabweichung für fzg_w am Komponentenanschlag | - | lamafimaryraw_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| ILMKG_MW2 | 0x57AD | STAT_LUFTMASSE_MESSWERT2_WERT | Luftmassenstrom HFM, korrigiert und gefiltert (fr Berechnung Regeldifferenz Massenstromregler) | kg/h | SwSABMW_AirmfCorAndFild | - | unsigned int | - | 0.03125 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x580A_WERT | 0x580A | STAT_0X580A_WERT | Temperaturwert RIS-Sensor LIN  | °C | RISECU_tSens | - | unsigned int | - | 0.09375 | 1.0 | 5.0 | - | 22;2C | - | - |
...
| STAT_0x5883_WERT | 0x5883 | STAT_0X5883_WERT | [0]Spannung Klopfwert Zylinder 1 | V | rkr_w | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5884_WERT | 0x5884 | STAT_0X5884_WERT | Grenzerregerstrom E-Maschine 1 | A | ierrfgrenz | - | unsigned char | - | 0.125 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5885_WERT | 0x5885 | STAT_0X5885_WERT | [1]Spannung Klopfwert Zylinder 3 | V | rkr_w | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 | - | 22;2C | - | - |
| IGENA | 0x5887 | STAT_0X5887_WERT | Auslastungsgrad Generator 1 | - | isgusmdf_w | - | unsigned int | - | 0.005 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5888_WERT | 0x5888 | STAT_0X5888_WERT | [2]Spannung Klopfwert Zylinder 4 | V | rkr_w | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5894_WERT | 0x5894 | STAT_0X5894_WERT | [3]Spannung Klopfwerte Zylinder 2 | V | rkr_w | - | unsigned int | - | 0.00007629 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| IZFZ3 | 0x58B2 | STAT_FUNKENBRENNDAUER_ZYL3_WERT | [1]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 3 | ms | dztbd_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZFZ4 | 0x58B3 | STAT_FUNKENBRENNDAUER_ZYL4_WERT | [2]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 4 | ms | dztbd_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| IZFZ2 | 0x58B4 | STAT_FUNKENBRENNDAUER_ZYL2_WERT | [3]Diagnose Zuendung: Brenndauer des Zuendfunkens aus dem HW-nahen SW-RAM, Zylinder 2 | ms | dztbd_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x58E6_WERT | 0x58E6 | STAT_0X58E6_WERT | [1] Gefilterte Funkenbrenndauer Zylinder 3 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58E7_WERT | 0x58E7 | STAT_0X58E7_WERT | [2] Gefilterte Funkenbrenndauer Zylinder 4 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x58E8_WERT | 0x58E8 | STAT_0X58E8_WERT | [3] Gefilterte Funkenbrenndauer Zylinder 2 | ms | dztbd_fil | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x590F_WERT | 0x590F | STAT_0X590F_WERT | Status Fehlerspeichereintrag ohne kritische ZMS Störung | - | MisfDet_stMisfWoCritDsbcDmf | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x591F_WERT | 0x591F | STAT_0X591F_WERT | Abgleich Drosselklappenmodell (Offset) LOW Byte | - | SwSABMW_AdjmtThrVlvMdl | - | signed char | - | 0.25 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5920_WERT | 0x5920 | STAT_0X5920_WERT | Abgleich Einlassventilmodell (Offset) LOW Byte | - | SwSABMW_AdjmtIntkVlvMdl | - | signed char | - | 0.25 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5938_WERT | 0x5938 | STAT_0X5938_WERT | Ethanolgehalt, Rohwert vom Sensor | - | fethr_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5939_WERT | 0x5939 | STAT_0X5939_WERT | Ethanolgehalt am Einspritzventil | - | fethev_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x593A_WERT | 0x593A | STAT_0X593A_WERT | gesamte Masse Benzin und Alkohol im Öl | g | mkioel_w | - | unsigned int | - | 0.02133333 | 1.0 | 0.0 | - | 22;2C | - | - |
...
| STAT_0x5948_WERT | 0x5948 | STAT_0X5948_WERT | Korrekturfaktor Kraftstoffmischung für Einspritzzeit | - | ffueli_w | - | unsigned int | - | 0.00003052 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5953_WERT | 0x5953 | STAT_0X5953_WERT | Intervalle mit kritischen ZMS-Stoerungen | - | MisfDet_CntrItvlCritDsbcDmf | - | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5954_WERT | 0x5954 | STAT_0X5954_WERT | Intervalle mit kritischen ZMS-Stoerungen ueber Lebenszeit | - | MisfDet_CntrItvlCritDsbcDmfLfTi | - | unsigned long | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5955_WERT | 0x5955 | STAT_0X5955_WERT | Spannung hinter Zünd- Einspritzrelais | V | ubinj | - | unsigned char | - | 0.1 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x5960_WERT | 0x5960 | STAT_0X5960_WERT | Einlassventilhub (aus Exzenterwinkel gerechnet, mit Hub-Aadaption und mit Hubprädiktion) | mm | evhubi_w | - | unsigned int | - | 0.001 | 1.0 | 0.0 | - | 22;2C | - | - |
| ZYKL_NACHLADEN_LADE | 0x5989 | STAT_ZYKL_NACHLADEN_LADEENDEGRUND_WERT | Ladeendegrund für das zyklische Nachladen | - | SwSABMW_LstPntForCyclRech | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
| STAT_0x598E_WERT | 0x598E | STAT_0X598E_WERT | Status der Nachladeanforderung | - | Com_FX_StChgngHvPwmg | - | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22;2C | - | - |
...
### T_1BYTE_TEXT_BCU_DATEN_DOP

| WERT | TEXT |
| --- | --- |
| 0 | KEIN_BNE_WANDLER_VERBAUT |
| 4 | BCU_MIT_150W_VERBAUT |
| 5 | PCU (POWER CONTROL UNIT) VERBAUT |
| 15 | SIGNAL UNGUELTIG |
| 255 | Undefined |

### T_1BYTE_TEXT_BCU_ERR_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Fehler Status Ausfall BCU: Kein Fehler |
| 1 | Fehler Status Ausfall BCU: Fehler aktiv |
| 2 | Fehler Status Ausfall BCU: Diagnose noch nicht durchgefuehrt |
| 3 | Fehler Status Ausfall BCU: Signal ungueltig |
| 255 | Undefined |

### T_1BYTE_TEXT_ST_BCU_BIT01_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Status Notstartschalter: Offen |
| 1 | Status Notstartschalter: Geschlossen |
| 3 | Status Notstartschalter: Signal ungueltig |
| 2 | Nicht definiert |

### T_1BYTE_TEXT_ST_BCU_BIT23_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Zustand Fremdladeerkennung: keine Fremdladung |
| 1 | Zustand Fremdladeerkennung: Fremdladung erkannt |
| 3 | Zustand Fremdladeerkennung: Signal ungueltig |
| 2 | Nicht definiert |

### T_1BYTE_TEXT_ST_BCU_BIT47_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Diagnose Steuerpin Relais: OK |
| 1 | Diagnose Steuerpin Relais: Leitung offen |
| 2 | Diagnose Steuerpin Relais: Leitung Kurzschluss Masse |
| 3 | Diagnose Steuerpin Relais: Leitung Kurzschluss U_Batt |
| 15 | Diagnose Steuerpin Relais:Signal ungueltig |
| 4 | nicht definiert |
| 5 | nicht definiert |
| 6 | nicht definiert |
| 7 | nicht definiert |
...
### T_1BYTE_TEXT_ST_BCU_CMD_DOP

| WERT | TEXT |
| --- | --- |
| 0 | Sollvorgabe Position Schalter 2: Aus |
| 1 | Sollvorgabe Position Schalter 2: Ein |
| 3 | Sollvorgabe Position Schalter 2: Signal ungueltig |
| 255 | Undefined |
...
| 255 | Ungueltiger Wert; Zustand nicht Definiert |
