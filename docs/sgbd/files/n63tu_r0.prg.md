...
| ECU Comment | SGBD für MEVD1728 / H  C-Muster und Programmstand  8AC2F20B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Motorelektronik ME VD17.2   8 Zylinder N63 TÜ Master |  |  |
| ORIGIN | string | BMW EA-360 Markus_Lorch |  |  |
| REVISION | string | 12.002 |  |  |
| AUTHOR | string | P-+-Z-ENGINEERING-GMBH EA-360 Berger |  |  |
| COMMENT | string | SGBD für MEVD1728 / H  C-Muster und Programmstand  8AC2F20B |  |  |
| PACKAGE | string | 1.70 |  |  |
...
Ansteuern Diagnosefunktion vertauschte Lambdasonden SYSTEMCHECK_L_SONDE (0x31 01 F0DF)
...
Testerjob zum Loeschen des Pannendatenspeichers. Beim Ausfuehren dieses Jobs soll folgendes Label gesetzt werden: GlbDa_bTRReqIniFlsh_u8 = TRUE. TRIPRCRDRESET (0x2E 5F78)
...
| WERT | TEXT | BEDEUTUNG |
| --- | --- | --- |
| 0x00 | Allgemeiner Fertigungs- und Energiesparmode | Hier deaktivierte Funktionen gemaeß FeTra-Liste festhalten |
| 0x01 | Spezieller Energiesparmode | - |
| 0x02 | ECOS-Mode | - |
| 0x03 | MOST-Mode | - |
| 0x04 | Rollenmode | - |
| 0x06 | Rollenmode | Fertigung mit Ausschalten von Katheizen |
...
| 0xCD8B02 | FlexRay, Botschaft (Diagnose OBD 1, 263.3.4): Aliveprüfung | 1 |
...
| 0xCD9711 | FlexRay, Botschaft (Steuerung Diagnose OBD Fahrdynamik, 247.0.2): fehlt | 1 |
...
| 0xCDA519 | FA-CAN, Botschaft (Status Energie Spannung Strom, 0x399): fehlt | 1 |
