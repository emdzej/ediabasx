...
| ECU Comment | SGBD fuer Kombi PL2 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | KOMBI PL2 E8x und E9x |  |  |
| ORIGIN | string | BMW EI-42 Cogiel |  |  |
| REVISION | string | 2.109 |  |  |
| AUTHOR | string | Eurospace EI-42 Kugelmann, Eurospace EI-42 Kuppe |  |  |
| COMMENT | string | SGBD fuer Kombi PL2 |  |  |
| PACKAGE | string | 1.29 |  |  |
