...
| ECU Comment | Fuer die komplette Diagnose des CHAMP ist auch die SGBD CHAMPGW notwendig. |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | CHAMP MMI / Tuner / ASK  |  |  |
| ORIGIN | string | BMW EI-44 Bubb |  |  |
| REVISION | string | 1.000 |  |  |
| AUTHOR | string | BMW EI-44 Hr.Bubb |  |  |
| COMMENT | string | Fuer die komplette Diagnose des CHAMP ist auch die SGBD CHAMPGW notwendig.  |  |  |
| PACKAGE | string | 1.29 |  |  |
