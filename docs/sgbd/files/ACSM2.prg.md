...
| ECU Comment | Airbag Steuergeraet fuer CAN-Bus Anwendungen E70 und E93 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | ACSM / Advanced Crash and Safety Management (Airbag Steuergeraet) E70 und E93 |  |  |
| ORIGIN | string | BMW EI-62 Scherer |  |  |
| REVISION | string | 1.002 |  |  |
| AUTHOR | string | BERATA ENGINEERINGCONSULTING Schieferstein |  |  |
| COMMENT | string | Airbag Steuergeraet fuer CAN-Bus Anwendungen E70 und E93 |  |  |
| PACKAGE | string | 1.31 |  |  |
