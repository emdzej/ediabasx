...
| --- | --- | --- | --- | --- |
| ECU | string | AMP-HIFILR02 HiFi-Verstaerker L6-F07 |  |  |
| ORIGIN | string | BMW EI-41 Michael_Baumgartner |  |  |
| REVISION | string | 0.401 |  |  |
| AUTHOR | string | Lear_Corporation DCS Klaus_Bach |  |  |
| COMMENT | string |  |  |  |
| PACKAGE | string | 1.05 |  |  |
