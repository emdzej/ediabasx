...
| ECU Comment | Auszug aus flash.prg nur zur Gateway Steuerung im INIT Job |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Spezial SGBD nur für CIP zur Gateway Steuerung  |  |  |
| ORIGIN | string | BMW VS-42 A.Baer |  |  |
| REVISION | string | 0.10 |  |  |
| AUTHOR | string | BMW VS-40 M.Rowedder |  |  |
| COMMENT | string | Auszug aus flash.prg nur zur Gateway Steuerung im INIT Job |  |  |
| PACKAGE | string | 1.21 |  |  |
