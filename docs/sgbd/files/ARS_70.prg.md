...
| ECU Comment | Stand zur Integrationsstufe E070-06-10-450 und Anpassungen |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Aktive Rollstabilisierung E70 |  |  |
| ORIGIN | string | BMW EF-63 Bernhard Schmidt |  |  |
| REVISION | string | 4.000 |  |  |
| AUTHOR | string | ContiTemic PC-FES Anders, BMW TI-432 Helmich |  |  |
| COMMENT | string | Stand zur Integrationsstufe E070-06-10-450 und Anpassungen |  |  |
| PACKAGE | string | 1.31 |  |  |
