...
| ECU Comment | SG Adresse wird über Job SWT_PARAMETER_SETZEN in globaler Variable abgelegt |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Spezial SGBD nur für SWT UDS SG's |  |  |
| ORIGIN | string | BMW TI-431 Seitz,Weber |  |  |
| REVISION | string | 0.910 |  |  |
| AUTHOR | string | BMW TI-431 Seitz(js), BMW TI-431 Weber(fw), ALTEN UX-EA-8 Ulbri |  |  |
| COMMENT | string | SG Adresse wird über Job SWT_PARAMETER_SETZEN in globaler Variable abgelegt |  |  |
| PACKAGE | string | 1.70 |  |  |
