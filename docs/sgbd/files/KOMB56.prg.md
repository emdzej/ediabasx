...
| ECU Comment | SGBD für Kombi PL3 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | KOMBI PL3 R56 |  |  |
| ORIGIN | string | BMW EI-42 Rottenkolber |  |  |
| REVISION | string | 3.001 |  |  |
| AUTHOR | string | NSEU System-Engineering Tenev, BMW EI-42 Kuppe |  |  |
| COMMENT | string | SGBD für Kombi PL3 |  |  |
| PACKAGE | string | 1.29 |  |  |
