...
| ECU Comment | SGBD für MSD85 C-Muster mit SW 9T8E800S |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MSD85 Hybrid fuer N63 mit EWS4 oder CAS in Fahrzeugen der Baureihe L6 |  |  |
| ORIGIN | string | BMW EA-360 Lorch |  |  |
| REVISION | string | 4.000 |  |  |
| AUTHOR | string | P&Z EA-360 Berger |  |  |
| COMMENT | string | SGBD für MSD85 C-Muster mit SW 9T8E800S |  |  |
| PACKAGE | string | 1.47 |  |  |
