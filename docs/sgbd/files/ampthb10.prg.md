...
| --- | --- | --- | --- | --- |
| ECU | string | Top Amp mit ASD-Verwendung |  |  |
| ORIGIN | string | BMW EI-41 JoannisToptsis |  |  |
| REVISION | string | 2.000 |  |  |
| AUTHOR | string | HarmanBecker CoC_AMP ChristianKnott, HarmanBecker CoC_AMP Chris |  |  |
| COMMENT | string | - |  |  |
| PACKAGE | string | 1.49 |  |  |
