...
| --- | --- | --- | --- | --- |
| ECU | string | Speicher Management Elektronik Hybrid Gen. 1.5 |  |  |
| ORIGIN | string | BMW EA-411 Markus_Fuchs |  |  |
| REVISION | string | 2.003 |  |  |
| AUTHOR | string | CAS DHS-F Jörg_Scheiner, CAS DHS-F Sven_Kasner |  |  |
| COMMENT | string | **I-500** |  |  |
| PACKAGE | string | 1.15 |  |  |
