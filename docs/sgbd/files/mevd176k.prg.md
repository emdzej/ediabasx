...
| ECU Comment | SGBD für MEVD1726 KWP zur Software 79S2EF0B, 79828F0B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MEVD176K mit KWP Protokoll  |  |  |
| ORIGIN | string | BMW EA-740 Lorch |  |  |
| REVISION | string | 5.070 |  |  |
| AUTHOR | string | P&Z EA-740 Berger, P&Z EA-740 Hadersdorfer |  |  |
| COMMENT | string | SGBD für MEVD1726 KWP zur Software 79S2EF0B, 79828F0B |  |  |
| PACKAGE | string | 1.66 |  |  |
