...
| ECU Comment | Initial Revision |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Rear Seat Entertainment |  |  |
| ORIGIN | string | BMW EE-43 Lamberty,Hans |  |  |
| REVISION | string | 2.000 |  |  |
| AUTHOR | string | Lear DCS_09261500347 Lesch,Jörg, Lear DCS_09261500384 Hümmer,Marc |  |  |
| COMMENT | string | Initial Revision |  |  |
| PACKAGE | string | 1.30 |  |  |
