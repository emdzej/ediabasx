...
| ECU Comment | Kennfeldprogrammierung EGS DS2/Flash GD SMG 2 |
...
| --- | --- | --- | --- | --- |
| ECU | string | GDSMG2 |  |  |
| ORIGIN | string | BMW AG, Softing GmbH |  |  |
| REVISION | string | 0.4 |  |  |
| AUTHOR | string | BMW AG, TI-433, Softing GmbH, N. Leipold |  |  |
| COMMENT | string | Kennfeldprogrammierung EGS DS2/Flash GD SMG 2 |  |  |
