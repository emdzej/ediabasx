...
| ECU Comment | Integrationsstufe E89x-06-03-410 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Längsdynamikmanager |  |  |
| ORIGIN | string | BMW EE-21 Wanner/Zeng |  |  |
| REVISION | string | 2.002 |  |  |
| AUTHOR | string | ContiTemic Fahrwerk Beierlein, Bertrandt EE-21 Schröder, ContiTemic Fahrwerk Strasser, ContiTemic Fahrwerk Düring, Bertrandt EF-62 Koufou |  |  |
| COMMENT | string | Integrationsstufe E89x-06-03-410 |  |  |
| PACKAGE | string | 1.28 |  |  |
