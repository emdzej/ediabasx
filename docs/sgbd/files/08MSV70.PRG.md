...
| ECU Comment | Freigabestand |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Spezial SGBD nur fuer Programmierung MSV 70 |  |  |
| ORIGIN | string | BMW EA-41 Krimmer |  |  |
| REVISION | string | 0.08 |  |  |
| AUTHOR | string | BMW EA-41 Krimmer |  |  |
| COMMENT | string | Freigabestand |  |  |
| PACKAGE | string | 1.10 |  |  |
