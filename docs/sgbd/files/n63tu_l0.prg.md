...
| ECU Comment | SGBD für MEVD1728 /H C-Muster und Programmstand 8AC2F50B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Motorelektronik ME VD17.2   8 Zylinder N63 TÜ Slave |  |  |
| ORIGIN | string | BMW EA-360 Markus_Lorch |  |  |
| REVISION | string | 12.002 |  |  |
| AUTHOR | string | P-+-Z-ENGINEERING-GMBH EA-360 Berger |  |  |
| COMMENT | string | SGBD für MEVD1728 /H C-Muster und Programmstand 8AC2F50B |  |  |
| PACKAGE | string | 1.70 |  |  |
