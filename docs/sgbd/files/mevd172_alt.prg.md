...
| ECU Comment | SGBD für MEVD172 C-Muster zur SW 7572650B |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | MEVD172 für N55 mit UDS-Protokoll |  |  |
| ORIGIN | string | BMW EA-413 Ortner |  |  |
| REVISION | string | 3.003 |  |  |
| AUTHOR | string | P&Z EA-413 Berger, P&Z EA-413 Lorch, P&Z EA-413 Hadersdorfer |  |  |
| COMMENT | string | SGBD für MEVD172 C-Muster zur SW 7572650B |  |  |
| PACKAGE | string | 1.12 |  |  |
