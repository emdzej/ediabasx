...
| --- | --- | --- | --- | --- |
| ECU | string | Elektromechanische Aktive Rollstabilisierung hinten |  |  |
| ORIGIN | string | BMW EF-422 HenryThasler |  |  |
| REVISION | string | 4.006 |  |  |
| AUTHOR | string | ContiTemic ChassisElectronics DautM, ContiTemic ChassisElectron |  |  |
| COMMENT | string | - |  |  |
| PACKAGE | string | 1.57 |  |  |
