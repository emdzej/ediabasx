...
| ECU Comment | Reifen-Druck-Kontrolle LowCost |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Reifen Druck Control Low Cost BN2000 |  |  |
| ORIGIN | string | BMW EF-442 Julian_Strang |  |  |
| REVISION | string | 2.001 |  |  |
| AUTHOR | string | Vector_Informatik_GmbH PES Heiko_Meyer, Huf_Electronics_Bretten |  |  |
| COMMENT | string | Reifen-Druck-Kontrolle LowCost |  |  |
| PACKAGE | string | 1.64 |  |  |
