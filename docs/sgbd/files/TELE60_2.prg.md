...
| ECU Comment | Erstellt von Motorola auf Basis der TelE60 SGBD |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Everest TCU  |  |  |
| ORIGIN | string | BMW_Group EI-43 Dr. Gengenbach |  |  |
| REVISION | string | 5.013 |  |  |
| AUTHOR | string | Motorola Inc. ? M.Manns, BMW Group EI-43 W.Siegl, BMW Group EI-43 J.P.Doyen, BMW Group EI-43 J.Andrieu, BMW Group EI-43 T.Kiefer |  |  |
| COMMENT | string | Erstellt von Motorola auf Basis der TelE60 SGBD |  |  |
| PACKAGE | string | 1.31 |  |  |
