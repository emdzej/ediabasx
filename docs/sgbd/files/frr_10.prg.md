...
| --- | --- | --- | --- | --- |
| ECU | string | ACC Full Range Radar |  |  |
| ORIGIN | string | BMW EF-622 Dietmar_Maier |  |  |
| REVISION | string | 5.100 |  |  |
| AUTHOR | string | BMW EF-620 Stefan_Jurthe, Continental ED-DAS Gergely_Ungvary, C |  |  |
| COMMENT | string |  |  |  |
| PACKAGE | string | 1.40 |  |  |
