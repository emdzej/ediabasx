...
| ECU Comment | Muster für PL2 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Dummydatei Tobias |  |  |
| ORIGIN | string | ESG Ti-430 HansPeter Gase |  |  |
| REVISION | string | 2.043 |  |  |
| AUTHOR | string | BMW TI-430 Huber, ESG TM-E Müller, BMW TI-430 Gramer |  |  |
| COMMENT | string | Muster für PL2 |  |  |
| PACKAGE | string | 1.22 |  |  |
