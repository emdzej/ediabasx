...
| ECU Comment | SGBD for Night Vision Camera: NVC E65 |

## Info

| Name | Type | Value | Unit | Comment |
| --- | --- | --- | --- | --- |
| ECU | string | Night Vision Camera NVC |  |  |
| ORIGIN | string | BMW EI-42 Thomas Mangold |  |  |
| REVISION | string | 2.002 |  |  |
| AUTHOR | string | BMW EI-42 Thomas Mangold, BMW EI-42 Walid Abumari |  |  |
| COMMENT | string | SGBD for Night Vision Camera: NVC E65 |  |  |
| PACKAGE | string | 1.29 |  |  |
